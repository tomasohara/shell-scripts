...
simple-alias-fn count-it 'alias-perl count_it.perl'
...
simple-alias-fn extract-matches 'alias-perl extract_matches.perl'
...
# example xterm title: '$ ipython [/home/tomohara/bin]'
function ipython() { 
    local ipython
