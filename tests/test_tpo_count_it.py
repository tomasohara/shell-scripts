...
class TestIt(TestWrapper):
    ...
    def test_count_extensions(self):
        ...
        input_string   = (
            'acl.sh add_arrows.sh add_frequencies.perl adhoc-rainbow-test.sh ai-cat-guesser.perl all_script_alias.sh alt-randomize-lines.perl'
    ...
    def test_parenthesis_check_digits(self):
        ...
        input_string = (
            'specified by section 6 of the GNU manner specified by section 6 of the GNU GPL'
    ...
    def test_parenthesis_check_words(self):
        ...
        input_string = (
            'A suitable mechanism is one that (a) uses at run time a copy'
