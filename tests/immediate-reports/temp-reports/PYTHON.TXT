...
function test9-assert1-expected () {
	echo -e 'PYTHONPATH:/home/aveey/python'
}
...
@test "test14" {
	...
	actual=$(test14-assert7-actual)
	expected=$(test14-assert7-expected)
	echo "========== actual =========="
	echo "$actual" | hexview.perl
	echo "========= expected ========="
	echo "$expected" | hexview.perl
...
function test14-assert7-actual () {
	linebr
}
function test14-assert7-expected () {
...
@test "test25" {
	...
	actual=$(test25-assert2-actual)
	expected=$(test25-assert2-expected)
	echo "========== actual =========="
	echo "$actual" | hexview.perl
	echo "========= expected ========="
	echo "$expected" | hexview.perl
...
function test25-assert2-actual () {
	ls
}
function test25-assert2-expected () {
