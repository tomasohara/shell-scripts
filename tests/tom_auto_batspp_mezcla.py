...
# BUG TO BE FIXED : THE ROLES OF --txt AND --kcov IS SWITCHED

## TODO: avoid all-caps in docstrings (except for acronyms, abbreviations, etc.)
"""
...
## TEMP:
# debug.trace(2, "Warning: creating msy alias for system")
...
def auto_batspp(NO_OPTION, TXT_OPTION, KCOV_OPTION):
    ...
    def output_generation():
        ...
        def not_no_option():
            ...
            def text_report_func(FILE, BATSPP_2_TXT):
                TXT_MESSAGE = f"REPORT PATH: ./{TXT_STORE}/{BATSPP_2_TXT}"
