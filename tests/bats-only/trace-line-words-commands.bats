...
@test "test-1" {
	testfolder="/tmp/batspp-55684/test-1"
...
@test "test-3" {
	testfolder="/tmp/batspp-55684/test-3"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-4" {
	testfolder="/tmp/batspp-55684/test-4"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-5" {
	testfolder="/tmp/batspp-55684/test-5"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-6" {
	testfolder="/tmp/batspp-55684/test-6"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-7" {
	testfolder="/tmp/batspp-55684/test-7"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-8" {
	testfolder="/tmp/batspp-55684/test-8"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-9" {
	testfolder="/tmp/batspp-55684/test-9"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-10" {
	testfolder="/tmp/batspp-55684/test-10"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-11" {
	testfolder="/tmp/batspp-55684/test-11"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-12" {
	testfolder="/tmp/batspp-55684/test-12"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-13" {
	testfolder="/tmp/batspp-55684/test-13"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-14" {
	testfolder="/tmp/batspp-55684/test-14"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-15" {
	testfolder="/tmp/batspp-55684/test-15"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-16" {
	testfolder="/tmp/batspp-55684/test-16"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-17" {
	testfolder="/tmp/batspp-55684/test-17"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-18" {
	testfolder="/tmp/batspp-55684/test-18"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
