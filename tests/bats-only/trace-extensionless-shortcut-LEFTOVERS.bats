...
@test "test12" {
	...
	rename-etc
	linebr
	actual=$(test12-assert6-actual)
	expected=$(test12-assert6-expected)
	echo "========== actual =========="
	echo "$actual" | hexview.perl
	echo "========= expected ========="
	echo "$expected" | hexview.perl
...
function test12-assert6-actual () {
	ls
}
function test12-assert6-expected () {
	echo -e 'renaming "abc(1).111" to "abc1.111"renaming "abc(2).111" to "abc2.111"renaming "xyz(3).111" to "xyz3.111"renaming "xyz(4).111" to "xyz4.111"--------------------------------------------------------------------------------renaming "&*abcdefg.xyz" to "abcdefg.xyz"renaming "*abc.xyz" to "abc.xyz"--------------------------------------------------------------------------------WARNING: Ignoring -quick mode as files specifiedbash: rename-quotes: command not foundbash: move: command not found--------------------------------------------------------------------------------abc1.111  abc2.111  abcdefg.xyz  abc.xyz  duplicates  xyz3.111\txyz4.111'
}
...
@test "test14" {
	...
	linebr
	actual=$(test14-assert34-actual)
	expected=$(test14-assert34-expected)
	echo "========== actual =========="
	echo "$actual" | hexview.perl
	echo "========= expected ========="
	echo "$expected" | hexview.perl
...
function test14-assert34-actual () {
	ls
}
function test14-assert34-expected () {
	echo -e "bash: e: command not foundabc1.xyz  abc2.xyz  abc3.xyz  abc4.xyz\tabc5.xyz.19Aug22  abc6.xyz.19Aug22--------------------------------------------------------------------------------'abc1.xyz' -> 'abc1.xyz.07Oct22''abc2.xyz' -> 'abc2.xyz.07Oct22''abc3.xyz' -> 'abc3.xyz.07Oct22''abc4.xyz' -> 'abc4.xyz.07Oct22'--------------------------------------------------------------------------------abc1.xyz\t  abc2.xyz.07Oct22  abc4.xyz\t      abc6.xyz.19Aug22abc1.xyz.07Oct22  abc3.xyz\t    abc4.xyz.07Oct22abc2.xyz\t  abc3.xyz.07Oct22  abc5.xyz.19Aug22"
}
...
@test "test20" {
	...
	actual=$(test20-assert5-actual)
	expected=$(test20-assert5-expected)
	echo "========== actual =========="
	echo "$actual" | hexview.perl
	echo "========= expected ========="
	echo "$expected" | hexview.perl
...
function test20-assert5-actual () {
	echo $MY_USERNAME
}
function test20-assert5-expected () {
	echo -e 'aveey-temp--------------------------------------------------------------------------------'
}
