...
@test "test-1" {
	testfolder="/tmp/batspp-66562/test-1"
...
@test "test-3" {
	testfolder="/tmp/batspp-66562/test-3"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-4" {
	testfolder="/tmp/batspp-66562/test-4"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-5" {
	testfolder="/tmp/batspp-66562/test-5"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-6" {
	testfolder="/tmp/batspp-66562/test-6"
	mkdir --parents "$testfolder"
	cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
