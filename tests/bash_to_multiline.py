...
class MultilineParser:
    ...
    def parse_line(self, line):
        ...
        for pattern in self.single_line_func_patterns:
            ...
            if func_match:
                _, name, body = func_match.groups()  # Ignore indent variable
                func = BashFunction(
                    name, 
                    f"{{ {body} }}", 
                    is_alias=False, 
        ...
        for pattern in self.alias_patterns:
            ...
            if alias_match:
                ...
                name = groups[1]
                command = groups[2]
                # Note: We're ignoring indent and comment variables as they're unused
...
class BashToMultilineScript(Main):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.preserve_aliases = False
        self.verbose = False
        self.function_keyword = True
        self.remove_empty_blocks = True
    ...
    def setup(self):
        ...
        # Initialize parser
        self.parser = MultilineParser(use_function_keyword=self.function_keyword)
