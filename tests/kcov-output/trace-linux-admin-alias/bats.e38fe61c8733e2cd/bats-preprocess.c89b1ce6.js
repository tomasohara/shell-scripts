...
{"lineNum":"    5","line":"  local name=\"$1\"","class":"lineCov","hits":"60","order":"147","possible_hits":"0",},
{"lineNum":"    6","line":"  local result=\'test_\'","class":"lineCov","hits":"60","order":"148","possible_hits":"0",},
{"lineNum":"    7","line":"  local hex_code","class":"lineCov","hits":"60","order":"149","possible_hits":"0",},
{"lineNum":"    8","line":""},
{"lineNum":"    9","line":"  if [[ ! \"$name\" =~ [^[:alnum:]\\ _-] ]]; then","class":"lineCov","hits":"60","order":"150","possible_hits":"0",},
{"lineNum":"   10","line":"    name=\"${name//_/-5f}\"","class":"lineCov","hits":"60","order":"151","possible_hits":"0",},
{"lineNum":"   11","line":"    name=\"${name//-/-2d}\"","class":"lineCov","hits":"60","order":"152","possible_hits":"0",},
{"lineNum":"   12","line":"    name=\"${name// /_}\"","class":"lineCov","hits":"60","order":"153","possible_hits":"0",},
{"lineNum":"   13","line":"    result+=\"$name\"","class":"lineCov","hits":"60","order":"154","possible_hits":"0",},
...
{"lineNum":"   29","line":"  fi"},
{"lineNum":"   30","line":""},
{"lineNum":"   31","line":"  printf -v \"$2\" \'%s\' \"$result\"","class":"lineCov","hits":"60","order":"155","possible_hits":"0",},
{"lineNum":"   32","line":"}"},
{"lineNum":"   33","line":""},
...
{"lineNum":"   78","line":"{"},
{"lineNum":"   79","line":"  while IFS= read -r line; do","class":"lineCov","hits":"1958","order":"135","possible_hits":"0",},
...
{"lineNum":"   82","line":"    if [[ \"$line\" =~ $BATS_TEST_PATTERN ]] || [[ \"$line\" =~ $BATS_TEST_PATTERN_COMMENT ]]; then","class":"lineCov","hits":"1892","order":"138","possible_hits":"0",},
{"lineNum":"   83","line":"      name=\"${BASH_REMATCH[1]#[\\\'\\\"]}\"","class":"lineCov","hits":"60","order":"143","possible_hits":"0",},
{"lineNum":"   84","line":"      name=\"${name%[\\\'\\\"]}\"","class":"lineCov","hits":"60","order":"144","possible_hits":"0",},
{"lineNum":"   85","line":"      body=\"${BASH_REMATCH[2]:-}\"","class":"lineCov","hits":"60","order":"145","possible_hits":"0",},
{"lineNum":"   86","line":"      bats_encode_test_name \"$name\" \'encoded_name\'","class":"lineCov","hits":"60","order":"146","possible_hits":"0",},
{"lineNum":"   87","line":"      printf \'%s() { bats_test_begin \"%s\"; %s\\n\' \"${encoded_name:?}\" \"$name\" \"$body\" || :","class":"lineCov","hits":"60","order":"156","possible_hits":"0",},
{"lineNum":"   88","line":""},
...
{"lineNum":"   92","line":"      if [[ -z \"$BATS_TEST_FILTER\" || \"$name\" =~ $BATS_TEST_FILTER ]]; then","class":"lineCov","hits":"60","order":"171","possible_hits":"0",},
{"lineNum":"   93","line":"        IFS=,","class":"lineCov","hits":"60","order":"172","possible_hits":"0",},
{"lineNum":"   94","line":"        tests+=(\"--tags \'${tags[*]-}\' $encoded_name\")","class":"lineCov","hits":"60","order":"173","possible_hits":"0",},
{"lineNum":"   95","line":"      fi"},
...
{"lineNum":"   99","line":"      if [[ \"$line\" =~ $BATS_COMMENT_COMMAND_PATTERN ]]; then","class":"lineCov","hits":"916","order":"139","possible_hits":"0",},
...
{"lineNum":"  109","line":"      fi"},
{"lineNum":"  110","line":"      printf \'%s\\n\' \"$line\"","class":"lineCov","hits":"915","order":"140","possible_hits":"0",},
{"lineNum":"  111","line":"    fi"},
{"lineNum":"  112","line":"  done"},
{"lineNum":"  113","line":"} <<<\"$(<\"$test_file\")\"$\'\\n\'","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"for test_name in \"${tests[@]}\"; do","class":"lineCov","hits":"60","order":"174","possible_hits":"0",},
{"lineNum":"  116","line":"  printf \'bats_test_function %s\\n\' \"$test_name\"","class":"lineCov","hits":"60","order":"175","possible_hits":"0",},
{"lineNum":"  117","line":"done"},
{"lineNum":"  118","line":""},
{"lineNum":"  119","line":"exit $exit_code","class":"lineCov","hits":"4","order":"176","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2022-09-26 10:27:28", "instrumented" : 71, "covered" : 35,};
var merged_data = [];
