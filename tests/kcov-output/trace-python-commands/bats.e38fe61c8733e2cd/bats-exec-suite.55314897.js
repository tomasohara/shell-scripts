...
{"lineNum":"  113","line":"  local line test_line tags","class":"lineCov","hits":"2","order":"119","possible_hits":"0",},
{"lineNum":"  114","line":"  all_tests=()"},
{"lineNum":"  115","line":"  for filename in \"$@\"; do","class":"lineCov","hits":"6","order":"120","possible_hits":"0",},
{"lineNum":"  116","line":"    if [[ ! -f \"$filename\" ]]; then","class":"lineCov","hits":"2","order":"121","possible_hits":"0",},
...
{"lineNum":"  122","line":"    while read -r line; do","class":"lineCov","hits":"1550","order":"123","possible_hits":"0",},
{"lineNum":"  123","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"1548","order":"172","possible_hits":"0",},
{"lineNum":"  124","line":"        continue","class":"lineCov","hits":"1466","order":"173","possible_hits":"0",},
{"lineNum":"  125","line":"      fi"},
{"lineNum":"  126","line":"      line=\"${line%$\'\\r\'}\"","class":"lineCov","hits":"82","order":"176","possible_hits":"0",},
{"lineNum":"  127","line":"      line=\"${line#* }\"","class":"lineCov","hits":"82","order":"177","possible_hits":"0",},
{"lineNum":"  128","line":"      TAG_REGEX=\"--tags \'(.*)\' (.*)\"","class":"lineCov","hits":"82","order":"178","possible_hits":"0",},
{"lineNum":"  129","line":"      if [[ \"$line\" =~ $TAG_REGEX ]]; then","class":"lineCov","hits":"82","order":"179","possible_hits":"0",},
{"lineNum":"  130","line":"        IFS=, read -ra tags <<<\"${BASH_REMATCH[1]}\" || true","class":"lineCov","hits":"164","order":"180","possible_hits":"0",},
{"lineNum":"  131","line":"        line=\"${BASH_REMATCH[2]}\"","class":"lineCov","hits":"82","order":"181","possible_hits":"0",},
{"lineNum":"  132","line":"      else"},
{"lineNum":"  133","line":"        tags=()"},
{"lineNum":"  134","line":"      fi"},
{"lineNum":"  135","line":"      if [[ ${#filter_tags_list[@]} -gt 0 ]]; then","class":"lineCov","hits":"82","order":"182","possible_hits":"0",},
...
{"lineNum":"  163","line":"        fi"},
{"lineNum":"  164","line":"      fi"},
{"lineNum":"  165","line":"      test_line=$(printf \"%s\\t%s\" \"$filename\" \"$line\")","class":"lineCov","hits":"164","order":"184","possible_hits":"0",},
{"lineNum":"  166","line":"      all_tests+=(\"$test_line\")","class":"lineCov","hits":"82","order":"185","possible_hits":"0",},
{"lineNum":"  167","line":"      printf \"%s\\n\" \"$test_line\" >>\"$TESTS_LIST_FILE\"","class":"lineCov","hits":"82","order":"186","possible_hits":"0",},
{"lineNum":"  168","line":"      # avoid unbound variable errors on empty array expansion with old bash versions"},
{"lineNum":"  169","line":"      if [[ ${#test_names[@]} -gt 0 && \" ${test_names[*]} \" == *\" $line \"* ]]; then","class":"lineCov","hits":"162","order":"187","possible_hits":"0",},
...
{"lineNum":"  172","line":"      fi"},
{"lineNum":"  173","line":"      test_names+=(\"$line\")","class":"lineCov","hits":"82","order":"188","possible_hits":"0",},
...
{"lineNum":"  182","line":"}"},
{"lineNum":"  183","line":""},
{"lineNum":"  184","line":"TEST_ROOT=${1-}","class":"lineCov","hits":"2","order":"111","possible_hits":"0",},
{"lineNum":"  185","line":"TEST_ROOT=${TEST_ROOT%/*}","class":"lineCov","hits":"2","order":"112","possible_hits":"0",},
{"lineNum":"  186","line":"BATS_RUN_LOGS_DIRECTORY=\"$TEST_ROOT/.bats/run-logs\"","class":"lineCov","hits":"2","order":"113","possible_hits":"0",},
{"lineNum":"  187","line":"if [[ ! -d \"$BATS_RUN_LOGS_DIRECTORY\" ]]; then","class":"lineCov","hits":"2","order":"114","possible_hits":"0",},
{"lineNum":"  188","line":"  if [[ -n \"$filter_status\" ]]; then","class":"lineCov","hits":"2","order":"115","possible_hits":"0",},
...
{"lineNum":"  192","line":"    BATS_RUN_LOGS_DIRECTORY=","class":"lineCov","hits":"2","order":"116","possible_hits":"0",},
{"lineNum":"  193","line":"  fi"},
{"lineNum":"  194","line":"  # discard via sink instead of having a conditional later"},
{"lineNum":"  195","line":"  export BATS_RUNLOG_FILE=\'/dev/null\'","class":"lineCov","hits":"4","order":"117","possible_hits":"0",},
...
{"lineNum":"  200","line":"fi"},
{"lineNum":"  201","line":""},
{"lineNum":"  202","line":"bats_gather_tests \"$@\"","class":"lineCov","hits":"2","order":"118","possible_hits":"0",},
{"lineNum":"  203","line":""},
...
{"lineNum":"  312","line":"if ! mkdir \"$BATS_SUITE_TMPDIR\"; then","class":"lineCov","hits":"2","order":"200","possible_hits":"0",},
...
var header = { "command" : "bats", "date" : "2022-09-26 10:26:29", "instrumented" : 229, "covered" : 85,};
var merged_data = [];
