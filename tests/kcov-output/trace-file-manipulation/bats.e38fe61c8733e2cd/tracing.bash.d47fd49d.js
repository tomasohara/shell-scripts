...
{"lineNum":"    4","line":"source \"$BATS_ROOT/lib/bats-core/common.bash\"","class":"lineCov","hits":"288","order":"208","possible_hits":"0",},
{"lineNum":"    5","line":""},
{"lineNum":"    6","line":"bats_capture_stack_trace() {"},
{"lineNum":"    7","line":"\tlocal test_file","class":"lineCov","hits":"1774","order":"318","possible_hits":"0",},
{"lineNum":"    8","line":"\tlocal funcname","class":"lineCov","hits":"1774","order":"319","possible_hits":"0",},
{"lineNum":"    9","line":"\tlocal i","class":"lineCov","hits":"1774","order":"320","possible_hits":"0",},
{"lineNum":"   10","line":""},
{"lineNum":"   11","line":"\tBATS_DEBUG_LAST_STACK_TRACE=()"},
{"lineNum":"   12","line":""},
{"lineNum":"   13","line":"\tfor ((i = 2; i != ${#FUNCNAME[@]}; ++i)); do","class":"lineCov","hits":"3834","order":"321","possible_hits":"0",},
...
{"lineNum":"   16","line":"\t\ttest_file=\"${BASH_SOURCE[$i]:-$BATS_TEST_SOURCE}\"","class":"lineCov","hits":"1917","order":"322","possible_hits":"0",},
{"lineNum":"   17","line":"\t\tfuncname=\"${FUNCNAME[$i]}\"","class":"lineCov","hits":"1917","order":"323","possible_hits":"0",},
{"lineNum":"   18","line":"\t\tBATS_DEBUG_LAST_STACK_TRACE+=(\"${BASH_LINENO[$((i-1))]} $funcname $test_file\")","class":"lineCov","hits":"1917","order":"324","possible_hits":"0",},
{"lineNum":"   19","line":"\t\tcase \"$funcname\" in","class":"lineCov","hits":"1917","order":"325","possible_hits":"0",},
{"lineNum":"   20","line":"\t\t\"${BATS_TEST_NAME-}\" | setup | teardown | setup_file | teardown_file | setup_suite | teardown_suite)"},
{"lineNum":"   21","line":"\t\t\tbreak","class":"lineCov","hits":"1590","order":"424","possible_hits":"0",},
{"lineNum":"   22","line":"\t\t\t;;"},
{"lineNum":"   23","line":"\t\tesac"},
{"lineNum":"   24","line":"\t\tif [[ \"${BASH_SOURCE[$i + 1]:-}\" == *\"bats-exec-file\" ]] && [[ \"$funcname\" == \'source\' ]]; then","class":"lineCov","hits":"511","order":"326","possible_hits":"0",},
{"lineNum":"   25","line":"\t\t\tbreak","class":"lineCov","hits":"184","order":"327","possible_hits":"0",},
{"lineNum":"   26","line":"\t\tfi"},
{"lineNum":"   27","line":"\tdone"},
{"lineNum":"   28","line":"}"},
{"lineNum":"   29","line":""},
{"lineNum":"   30","line":"bats_get_failure_stack_trace() {"},
{"lineNum":"   31","line":"\tlocal stack_trace_var","class":"lineCov","hits":"74","order":"488","possible_hits":"0",},
{"lineNum":"   32","line":"\t# See bats_debug_trap for details."},
{"lineNum":"   33","line":"\tif [[ -n \"${BATS_DEBUG_LAST_STACK_TRACE_IS_VALID:-}\" ]]; then","class":"lineCov","hits":"74","order":"489","possible_hits":"0",},
{"lineNum":"   34","line":"\t\tstack_trace_var=BATS_DEBUG_LAST_STACK_TRACE","class":"lineCov","hits":"72","order":"490","possible_hits":"0",},
{"lineNum":"   35","line":"\telse"},
{"lineNum":"   36","line":"\t\tstack_trace_var=BATS_DEBUG_LASTLAST_STACK_TRACE","class":"lineCov","hits":"2","possible_hits":"0",},
{"lineNum":"   37","line":"\tfi"},
...
{"lineNum":"   47","line":"\tlocal frame","class":"lineCov","hits":"74","order":"492","possible_hits":"0",},
{"lineNum":"   48","line":"\tlocal index=1","class":"lineCov","hits":"74","order":"493","possible_hits":"0",},
{"lineNum":"   49","line":"\tlocal count=\"${#@}\"","class":"lineCov","hits":"74","order":"494","possible_hits":"0",},
{"lineNum":"   50","line":"\tlocal filename","class":"lineCov","hits":"74","order":"495","possible_hits":"0",},
{"lineNum":"   51","line":"\tlocal lineno","class":"lineCov","hits":"74","order":"496","possible_hits":"0",},
{"lineNum":"   52","line":""},
{"lineNum":"   53","line":"\tfor frame in \"$@\"; do","class":"lineCov","hits":"74","order":"497","possible_hits":"0",},
{"lineNum":"   54","line":"\t\tbats_frame_filename \"$frame\" \'filename\'","class":"lineCov","hits":"74","order":"498","possible_hits":"0",},
{"lineNum":"   55","line":"\t\tbats_trim_filename \"$filename\" \'filename\'","class":"lineCov","hits":"74","order":"504","possible_hits":"0",},
{"lineNum":"   56","line":"\t\tbats_frame_lineno \"$frame\" \'lineno\'","class":"lineCov","hits":"74","order":"506","possible_hits":"0",},
{"lineNum":"   57","line":""},
{"lineNum":"   58","line":"\t\tprintf \'%s\' \"${BATS_STACK_TRACE_PREFIX-# }\"","class":"lineCov","hits":"74","order":"508","possible_hits":"0",},
{"lineNum":"   59","line":"\t\tif [[ $index -eq 1 ]]; then","class":"lineCov","hits":"74","order":"509","possible_hits":"0",},
{"lineNum":"   60","line":"\t\t\tprintf \'(\'","class":"lineCov","hits":"74","order":"510","possible_hits":"0",},
{"lineNum":"   61","line":"\t\telse"},
{"lineNum":"   62","line":"\t\t\tprintf \' \'","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"   63","line":"\t\tfi"},
{"lineNum":"   64","line":""},
{"lineNum":"   65","line":"\t\tlocal fn","class":"lineCov","hits":"74","order":"511","possible_hits":"0",},
{"lineNum":"   66","line":"\t\tbats_frame_function \"$frame\" \'fn\'","class":"lineCov","hits":"74","order":"512","possible_hits":"0",},
{"lineNum":"   67","line":"\t\tif [[ \"$fn\" != \"${BATS_TEST_NAME-}\" ]] &&","class":"lineCov","hits":"74","order":"515","possible_hits":"0",},
...
{"lineNum":"   74","line":"\t\tfi"},
{"lineNum":"   75","line":""},
{"lineNum":"   76","line":"\t\tif [[ $index -eq $count ]]; then","class":"lineCov","hits":"74","order":"516","possible_hits":"0",},
{"lineNum":"   77","line":"\t\t\tprintf \'in test file %s, line %d)\\n\' \"$filename\" \"$lineno\"","class":"lineCov","hits":"74","order":"517","possible_hits":"0",},
...
{"lineNum":"   87","line":"\tlocal stack_trace=(\"${@}\")","class":"lineCov","hits":"148","order":"519","possible_hits":"0",},
{"lineNum":"   88","line":"\tif [[ ${#stack_trace[@]} -eq 0 ]]; then","class":"lineCov","hits":"74","order":"520","possible_hits":"0",},
{"lineNum":"   89","line":"\t\treturn 0","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"   90","line":"\tfi"},
{"lineNum":"   91","line":"\tlocal frame=\"${stack_trace[${#stack_trace[@]} - 1]}\"","class":"lineCov","hits":"74","order":"521","possible_hits":"0",},
{"lineNum":"   92","line":"\tlocal filename","class":"lineCov","hits":"74","order":"522","possible_hits":"0",},
{"lineNum":"   93","line":"\tlocal lineno","class":"lineCov","hits":"74","order":"523","possible_hits":"0",},
{"lineNum":"   94","line":"\tlocal failed_line","class":"lineCov","hits":"74","order":"524","possible_hits":"0",},
{"lineNum":"   95","line":"\tlocal failed_command","class":"lineCov","hits":"74","order":"525","possible_hits":"0",},
{"lineNum":"   96","line":""},
{"lineNum":"   97","line":"\tbats_frame_filename \"$frame\" \'filename\'","class":"lineCov","hits":"74","order":"526","possible_hits":"0",},
{"lineNum":"   98","line":"\tbats_frame_lineno \"$frame\" \'lineno\'","class":"lineCov","hits":"74","order":"527","possible_hits":"0",},
{"lineNum":"   99","line":"\tbats_extract_line \"$filename\" \"$lineno\" \'failed_line\'","class":"lineCov","hits":"74","order":"528","possible_hits":"0",},
{"lineNum":"  100","line":"\tbats_strip_string \"$failed_line\" \'failed_command\'","class":"lineCov","hits":"74","order":"535","possible_hits":"0",},
{"lineNum":"  101","line":"\tlocal quoted_failed_command","class":"lineCov","hits":"74","order":"538","possible_hits":"0",},
{"lineNum":"  102","line":"\tbats_quote_code quoted_failed_command \"$failed_command\"","class":"lineCov","hits":"74","order":"539","possible_hits":"0",},
{"lineNum":"  103","line":"\tprintf \'#   %s \' \"${quoted_failed_command}\"","class":"lineCov","hits":"74","order":"541","possible_hits":"0",},
{"lineNum":"  104","line":""},
{"lineNum":"  105","line":"\tif [[ \"${BATS_TIMED_OUT-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"74","order":"542","possible_hits":"0",},
...
{"lineNum":"  109","line":"\tfi"},
{"lineNum":"  110","line":""},
{"lineNum":"  111","line":"\tif [[ \"$BATS_ERROR_STATUS\" -eq 1 ]]; then","class":"lineCov","hits":"74","order":"543","possible_hits":"0",},
{"lineNum":"  112","line":"\t\tprintf \'failed%s\\n\' \"$BATS_ERROR_SUFFIX\"","class":"lineCov","hits":"18","order":"578","possible_hits":"0",},
{"lineNum":"  113","line":"\telse"},
{"lineNum":"  114","line":"\t\tprintf \'failed with status %d%s\\n\' \"$BATS_ERROR_STATUS\" \"$BATS_ERROR_SUFFIX\"","class":"lineCov","hits":"56","order":"544","possible_hits":"0",},
{"lineNum":"  115","line":"\tfi"},
{"lineNum":"  116","line":"}"},
{"lineNum":"  117","line":""},
{"lineNum":"  118","line":"bats_frame_lineno() {"},
{"lineNum":"  119","line":"\tprintf -v \"$2\" \'%s\' \"${1%% *}\"","class":"lineCov","hits":"148","order":"507","possible_hits":"0",},
{"lineNum":"  120","line":"}"},
{"lineNum":"  121","line":""},
{"lineNum":"  122","line":"bats_frame_function() {"},
{"lineNum":"  123","line":"\tlocal __bff_function=\"${1#* }\"","class":"lineCov","hits":"74","order":"513","possible_hits":"0",},
{"lineNum":"  124","line":"\tprintf -v \"$2\" \'%s\' \"${__bff_function%% *}\"","class":"lineCov","hits":"74","order":"514","possible_hits":"0",},
{"lineNum":"  125","line":"}"},
{"lineNum":"  126","line":""},
{"lineNum":"  127","line":"bats_frame_filename() {"},
{"lineNum":"  128","line":"\tlocal __bff_filename=\"${1#* }\"","class":"lineCov","hits":"148","order":"499","possible_hits":"0",},
{"lineNum":"  129","line":"\t__bff_filename=\"${__bff_filename#* }\"","class":"lineCov","hits":"148","order":"500","possible_hits":"0",},
{"lineNum":"  130","line":""},
{"lineNum":"  131","line":"\tif [[ \"$__bff_filename\" == \"${BATS_TEST_SOURCE-}\" ]]; then","class":"lineCov","hits":"148","order":"501","possible_hits":"0",},
{"lineNum":"  132","line":"\t\t__bff_filename=\"$BATS_TEST_FILENAME\"","class":"lineCov","hits":"148","order":"502","possible_hits":"0",},
{"lineNum":"  133","line":"\tfi"},
{"lineNum":"  134","line":"\tprintf -v \"$2\" \'%s\' \"$__bff_filename\"","class":"lineCov","hits":"148","order":"503","possible_hits":"0",},
{"lineNum":"  135","line":"}"},
{"lineNum":"  136","line":""},
{"lineNum":"  137","line":"bats_extract_line() {"},
{"lineNum":"  138","line":"\tlocal __bats_extract_line_line","class":"lineCov","hits":"74","order":"529","possible_hits":"0",},
{"lineNum":"  139","line":"\tlocal __bats_extract_line_index=0","class":"lineCov","hits":"74","order":"530","possible_hits":"0",},
{"lineNum":"  140","line":""},
{"lineNum":"  141","line":"\twhile IFS= read -r __bats_extract_line_line; do","class":"lineCov","hits":"25456","order":"531","possible_hits":"0",},
{"lineNum":"  142","line":"\t\tif [[ \"$((++__bats_extract_line_index))\" -eq \"$2\" ]]; then","class":"lineCov","hits":"12728","order":"532","possible_hits":"0",},
{"lineNum":"  143","line":"\t\t\tprintf -v \"$3\" \'%s\' \"${__bats_extract_line_line%$\'\\r\'}\"","class":"lineCov","hits":"74","order":"533","possible_hits":"0",},
{"lineNum":"  144","line":"\t\t\tbreak","class":"lineCov","hits":"74","order":"534","possible_hits":"0",},
{"lineNum":"  145","line":"\t\tfi"},
{"lineNum":"  146","line":"\tdone <\"$1\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  147","line":"}"},
{"lineNum":"  148","line":""},
{"lineNum":"  149","line":"bats_strip_string() {"},
{"lineNum":"  150","line":"\t[[ \"$1\" =~ ^[[:space:]]*(.*)[[:space:]]*$ ]]","class":"lineCov","hits":"74","order":"536","possible_hits":"0",},
{"lineNum":"  151","line":"\tprintf -v \"$2\" \'%s\' \"${BASH_REMATCH[1]}\"","class":"lineCov","hits":"74","order":"537","possible_hits":"0",},
{"lineNum":"  152","line":"}"},
{"lineNum":"  153","line":""},
{"lineNum":"  154","line":"bats_trim_filename() {"},
{"lineNum":"  155","line":"\tprintf -v \"$2\" \'%s\' \"${1#\"$BATS_CWD\"/}\"","class":"lineCov","hits":"74","order":"505","possible_hits":"0",},
{"lineNum":"  156","line":"}"},
{"lineNum":"  157","line":""},
...
{"lineNum":"  161","line":"\tlocal output_var=\"$1\" path=\"$2\"","class":"lineCov","hits":"10617","order":"228","possible_hits":"0",},
{"lineNum":"  162","line":"\tif [[ \"$output_var\" != NORMALIZED_INPUT ]]; then","class":"lineCov","hits":"10617","order":"229","possible_hits":"0",},
{"lineNum":"  163","line":"\t\tlocal NORMALIZED_INPUT","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  164","line":"\tfi"},
{"lineNum":"  165","line":"\tif [[ $path == ?:* ]]; then","class":"lineCov","hits":"10617","order":"230","possible_hits":"0",},
{"lineNum":"  166","line":"\t\tNORMALIZED_INPUT=\"$(cd \"$path\" || exit 1; pwd)\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  167","line":"\telse"},
{"lineNum":"  168","line":"\t\tNORMALIZED_INPUT=\"$path\"","class":"lineCov","hits":"10617","order":"231","possible_hits":"0",},
{"lineNum":"  169","line":"\tfi"},
{"lineNum":"  170","line":"\tprintf -v \"$output_var\" \"%s\" \"$NORMALIZED_INPUT\"","class":"lineCov","hits":"10617","order":"232","possible_hits":"0",},
{"lineNum":"  171","line":"}"},
{"lineNum":"  172","line":""},
{"lineNum":"  173","line":"bats_emit_trace() {"},
{"lineNum":"  174","line":"\tif [[ $BATS_TRACE_LEVEL -gt 0 ]]; then","class":"lineCov","hits":"1774","order":"329","possible_hits":"0",},
...
{"lineNum":"  248","line":"\tlocal NORMALIZED_INPUT","class":"lineCov","hits":"10617","order":"226","possible_hits":"0",},
{"lineNum":"  249","line":"\tbats_normalize_windows_dir_path NORMALIZED_INPUT \"${1%/*}\"","class":"lineCov","hits":"10617","order":"227","possible_hits":"0",},
{"lineNum":"  250","line":"\tlocal file_excluded=\'\' path","class":"lineCov","hits":"10617","order":"233","possible_hits":"0",},
{"lineNum":"  251","line":"\tfor path in \"${BATS_DEBUG_EXCLUDE_PATHS[@]}\"; do","class":"lineCov","hits":"20599","order":"234","possible_hits":"0",},
{"lineNum":"  252","line":"\t\tif [[ \"$NORMALIZED_INPUT\" == \"$path\"* ]]; then","class":"lineCov","hits":"20599","order":"235","possible_hits":"0",},
{"lineNum":"  253","line":"\t\t\tfile_excluded=1","class":"lineCov","hits":"8834","order":"236","possible_hits":"0",},
{"lineNum":"  254","line":"\t\t\tbreak","class":"lineCov","hits":"8834","order":"237","possible_hits":"0",},
{"lineNum":"  255","line":"\t\tfi"},
...
{"lineNum":"  262","line":"\t\t\t\"${BATS_TIMED_OUT-NOTSET}\" == NOTSET ]]; then","class":"lineCov","hits":"14179","order":"238","possible_hits":"0",},
...
{"lineNum":"  265","line":"\t\t)"},
{"lineNum":"  266","line":""},
{"lineNum":"  267","line":"\t\tBATS_DEBUG_LAST_LINENO=(${BASH_LINENO[@]+\"${BASH_LINENO[@]}\"})","class":"lineCov","hits":"1781","order":"315","possible_hits":"0",},
{"lineNum":"  268","line":"\t\tBATS_DEBUG_LAST_SOURCE=(${BASH_SOURCE[@]+\"${BASH_SOURCE[@]}\"})","class":"lineCov","hits":"1781","order":"316","possible_hits":"0",},
{"lineNum":"  269","line":"\t\tbats_capture_stack_trace","class":"lineCov","hits":"1788","order":"317","possible_hits":"0",},
{"lineNum":"  270","line":"\t\tbats_emit_trace","class":"lineCov","hits":"1774","order":"328","possible_hits":"0",},
{"lineNum":"  271","line":"\tfi"},
{"lineNum":"  272","line":"}"},
{"lineNum":"  273","line":""},
...
{"lineNum":"  285","line":"\tlocal status=\"$?\"","class":"lineCov","hits":"384","order":"435","possible_hits":"0",},
{"lineNum":"  286","line":"\tif [[ -z \"${BATS_TEST_COMPLETED:-}\" ]]; then","class":"lineCov","hits":"384","order":"436","possible_hits":"0",},
{"lineNum":"  287","line":"\t\tBATS_ERROR_STATUS=\"${BATS_ERROR_STATUS:-$status}\"","class":"lineCov","hits":"268","order":"478","possible_hits":"0",},
{"lineNum":"  288","line":"\t\tif [[ \"$BATS_ERROR_STATUS\" -eq 0 ]]; then","class":"lineCov","hits":"268","order":"479","possible_hits":"0",},
{"lineNum":"  289","line":"\t\t\tBATS_ERROR_STATUS=1","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  290","line":"\t\tfi"},
{"lineNum":"  291","line":"\t\ttrap - DEBUG","class":"lineCov","hits":"267","order":"480","possible_hits":"0",},
{"lineNum":"  292","line":"\tfi"},
{"lineNum":"  293","line":"}"},
{"lineNum":"  294","line":""},
{"lineNum":"  295","line":"bats_add_debug_exclude_path() { # <path>"},
{"lineNum":"  296","line":"\tif [[ -z \"$1\" ]]; then # don\'t exclude everything","class":"lineCov","hits":"444","order":"213","possible_hits":"0",},
...
{"lineNum":"  299","line":"\tfi"},
{"lineNum":"  300","line":"\tif [[ \"$OSTYPE\" == cygwin || \"$OSTYPE\" == msys ]]; then","class":"lineCov","hits":"888","order":"214","possible_hits":"0",},
...
{"lineNum":"  305","line":"\t\tBATS_DEBUG_EXCLUDE_PATHS+=(\"$1\")","class":"lineCov","hits":"444","order":"215","possible_hits":"0",},
{"lineNum":"  306","line":"\tfi"},
{"lineNum":"  307","line":"}"},
{"lineNum":"  308","line":""},
...
{"lineNum":"  328","line":"\tBATS_DEBUG_LAST_STACK_TRACE_IS_VALID=","class":"lineCov","hits":"148","order":"210","possible_hits":"0",},
{"lineNum":"  329","line":"\tBATS_ERROR_SUFFIX=","class":"lineCov","hits":"148","order":"211","possible_hits":"0",},
{"lineNum":"  330","line":"\tBATS_DEBUG_EXCLUDE_PATHS=()"},
{"lineNum":"  331","line":"\t# exclude some paths by default"},
{"lineNum":"  332","line":"\tbats_add_debug_exclude_path \"$BATS_ROOT/lib/\"","class":"lineCov","hits":"148","order":"212","possible_hits":"0",},
{"lineNum":"  333","line":"\tbats_add_debug_exclude_path \"$BATS_ROOT/libexec/\"","class":"lineCov","hits":"148","order":"216","possible_hits":"0",},
{"lineNum":"  334","line":""},
{"lineNum":"  335","line":""},
{"lineNum":"  336","line":"\texec 4<&1 # used for tracing","class":"lineCov","hits":"148","order":"217","possible_hits":"0",},
{"lineNum":"  337","line":"\tif [[ \"${BATS_TRACE_LEVEL:-0}\" -gt 0 ]]; then","class":"lineCov","hits":"148","order":"218","possible_hits":"0",},
...
{"lineNum":"  347","line":"\tfi"},
{"lineNum":"  348","line":""},
{"lineNum":"  349","line":"\tlocal exclude_paths path","class":"lineCov","hits":"148","order":"219","possible_hits":"0",},
{"lineNum":"  350","line":"\t# exclude user defined libraries"},
{"lineNum":"  351","line":"\tIFS=\':\' read -r exclude_paths <<< \"${BATS_DEBUG_EXCLUDE_PATHS:-}\"","class":"lineCov","hits":"296","order":"220","possible_hits":"0",},
{"lineNum":"  352","line":"\tfor path in \"${exclude_paths[@]}\"; do","class":"lineCov","hits":"148","order":"221","possible_hits":"0",},
{"lineNum":"  353","line":"\t\tif [[ -n \"$path\" ]]; then","class":"lineCov","hits":"148","order":"222","possible_hits":"0",},
{"lineNum":"  354","line":"\t\t\tbats_add_debug_exclude_path \"$path\"","class":"lineCov","hits":"148","order":"223","possible_hits":"0",},
{"lineNum":"  355","line":"\t\tfi"},
{"lineNum":"  356","line":"\tdone"},
{"lineNum":"  357","line":""},
{"lineNum":"  358","line":"\t# turn on traps after setting excludes to avoid tracing the exclude setup"},
{"lineNum":"  359","line":"\ttrap \'bats_debug_trap \"$BASH_SOURCE\"\' DEBUG","class":"lineCov","hits":"148","order":"224","possible_hits":"0",},
{"lineNum":"  360","line":"  \ttrap \'bats_error_trap\' ERR","class":"lineCov","hits":"296","order":"225","possible_hits":"0",},
{"lineNum":"  361","line":"}"},
{"lineNum":"  362","line":""},
{"lineNum":"  363","line":"bats_error_trap() {"},
{"lineNum":"  364","line":"  bats_check_status_from_trap","class":"lineCov","hits":"193","order":"477","possible_hits":"0",},
{"lineNum":"  365","line":""},
...
{"lineNum":"  370","line":"\t && -z \"$BATS_DEBUG_LAST_STACK_TRACE_IS_VALID\" ]]; then","class":"lineCov","hits":"274","order":"481","possible_hits":"0",},
...
{"lineNum":"  373","line":"    )"},
{"lineNum":"  374","line":"  fi"},
{"lineNum":"  375","line":"  BATS_DEBUG_LAST_STACK_TRACE_IS_VALID=1","class":"lineCov","hits":"108","order":"482","possible_hits":"0",},
{"lineNum":"  376","line":"}"},
{"lineNum":"  377","line":""},
{"lineNum":"  378","line":"bats_interrupt_trap() {"},
{"lineNum":"  379","line":"  # mark the interruption, to handle during exit"},
{"lineNum":"  380","line":"  BATS_INTERRUPTED=true","class":"lineCov","hits":"3","possible_hits":"0",},
{"lineNum":"  381","line":"  BATS_ERROR_STATUS=130","class":"lineCov","hits":"3","possible_hits":"0",},
...
{"lineNum":"  384","line":"  exit $BATS_ERROR_STATUS","class":"lineCov","hits":"3","possible_hits":"0",},
{"lineNum":"  385","line":"}"},
{"lineNum":"  386","line":""},
...
var header = { "command" : "bats", "date" : "2022-10-20 21:41:18", "instrumented" : 165, "covered" : 113,};
var merged_data = [];
