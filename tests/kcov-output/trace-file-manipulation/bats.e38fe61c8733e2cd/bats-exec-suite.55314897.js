...
{"lineNum":"    2","line":"set -e","class":"lineCov","hits":"4","order":"90","possible_hits":"0",},
{"lineNum":"    3","line":""},
{"lineNum":"    4","line":"count_only_flag=\'\'","class":"lineCov","hits":"4","order":"91","possible_hits":"0",},
{"lineNum":"    5","line":"filter=\'\'","class":"lineCov","hits":"4","order":"92","possible_hits":"0",},
{"lineNum":"    6","line":"num_jobs=${BATS_NUMBER_OF_PARALLEL_JOBS:-1}","class":"lineCov","hits":"4","order":"93","possible_hits":"0",},
{"lineNum":"    7","line":"bats_no_parallelize_across_files=${BATS_NO_PARALLELIZE_ACROSS_FILES-}","class":"lineCov","hits":"4","order":"94","possible_hits":"0",},
{"lineNum":"    8","line":"bats_no_parallelize_within_files=","class":"lineCov","hits":"4","order":"95","possible_hits":"0",},
{"lineNum":"    9","line":"filter_status=\'\'","class":"lineCov","hits":"4","order":"96","possible_hits":"0",},
{"lineNum":"   10","line":"filter_tags_list=()"},
{"lineNum":"   11","line":"flags=(\'--dummy-flag\') # add a dummy flag to prevent unset variable errors on empty array expansion in old bash versions","class":"lineCov","hits":"4","order":"97","possible_hits":"0",},
{"lineNum":"   12","line":"setup_suite_file=\'\'","class":"lineCov","hits":"4","order":"98","possible_hits":"0",},
{"lineNum":"   13","line":"BATS_TRACE_LEVEL=\"${BATS_TRACE_LEVEL:-0}\"","class":"lineCov","hits":"4","order":"99","possible_hits":"0",},
{"lineNum":"   14","line":"BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS=","class":"lineCov","hits":"4","order":"100","possible_hits":"0",},
{"lineNum":"   15","line":""},
...
{"lineNum":"   22","line":"source \"$BATS_ROOT/lib/bats-core/common.bash\"","class":"lineCov","hits":"4","order":"101","possible_hits":"0",},
{"lineNum":"   23","line":""},
{"lineNum":"   24","line":"while [[ \"$#\" -ne 0 ]]; do","class":"lineCov","hits":"8","order":"102","possible_hits":"0",},
...
{"lineNum":"   40","line":"    ;;"},
{"lineNum":"   41","line":"  -x)"},
{"lineNum":"   42","line":"    flags+=(\'-x\')","class":"lineCov","hits":"8","order":"103","possible_hits":"0",},
{"lineNum":"   43","line":"    ;;"},
...
{"lineNum":"   91","line":"    ;;"},
{"lineNum":"   92","line":"  *)"},
{"lineNum":"   93","line":"    break","class":"lineCov","hits":"4","order":"105","possible_hits":"0",},
{"lineNum":"   94","line":"    ;;"},
{"lineNum":"   95","line":"  esac"},
{"lineNum":"   96","line":"  shift","class":"lineCov","hits":"4","order":"104","possible_hits":"0",},
{"lineNum":"   97","line":"done"},
{"lineNum":"   98","line":""},
{"lineNum":"   99","line":"if [[ \"$num_jobs\" != 1 ]]; then","class":"lineCov","hits":"4","order":"106","possible_hits":"0",},
...
{"lineNum":"  110","line":"TESTS_LIST_FILE=\"${BATS_RUN_TMPDIR}/test_list_file.txt\"","class":"lineCov","hits":"4","order":"107","possible_hits":"0",},
{"lineNum":"  111","line":""},
...
{"lineNum":"  122","line":"    while read -r line; do","class":"lineCov","hits":"1480","order":"125","possible_hits":"0",},
{"lineNum":"  123","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"1476","order":"160","possible_hits":"0",},
{"lineNum":"  124","line":"        continue","class":"lineCov","hits":"1392","order":"165","possible_hits":"0",},
{"lineNum":"  125","line":"      fi"},
{"lineNum":"  126","line":"      line=\"${line%$\'\\r\'}\"","class":"lineCov","hits":"84","order":"176","possible_hits":"0",},
{"lineNum":"  127","line":"      line=\"${line#* }\"","class":"lineCov","hits":"84","order":"177","possible_hits":"0",},
{"lineNum":"  128","line":"      TAG_REGEX=\"--tags \'(.*)\' (.*)\"","class":"lineCov","hits":"84","order":"178","possible_hits":"0",},
{"lineNum":"  129","line":"      if [[ \"$line\" =~ $TAG_REGEX ]]; then","class":"lineCov","hits":"84","order":"179","possible_hits":"0",},
{"lineNum":"  130","line":"        IFS=, read -ra tags <<<\"${BASH_REMATCH[1]}\" || true","class":"lineCov","hits":"168","order":"180","possible_hits":"0",},
{"lineNum":"  131","line":"        line=\"${BASH_REMATCH[2]}\"","class":"lineCov","hits":"84","order":"181","possible_hits":"0",},
{"lineNum":"  132","line":"      else"},
{"lineNum":"  133","line":"        tags=()"},
{"lineNum":"  134","line":"      fi"},
{"lineNum":"  135","line":"      if [[ ${#filter_tags_list[@]} -gt 0 ]]; then","class":"lineCov","hits":"84","order":"182","possible_hits":"0",},
...
{"lineNum":"  163","line":"        fi"},
{"lineNum":"  164","line":"      fi"},
{"lineNum":"  165","line":"      test_line=$(printf \"%s\\t%s\" \"$filename\" \"$line\")","class":"lineCov","hits":"168","order":"184","possible_hits":"0",},
{"lineNum":"  166","line":"      all_tests+=(\"$test_line\")","class":"lineCov","hits":"84","order":"185","possible_hits":"0",},
{"lineNum":"  167","line":"      printf \"%s\\n\" \"$test_line\" >>\"$TESTS_LIST_FILE\"","class":"lineCov","hits":"84","order":"186","possible_hits":"0",},
{"lineNum":"  168","line":"      # avoid unbound variable errors on empty array expansion with old bash versions"},
{"lineNum":"  169","line":"      if [[ ${#test_names[@]} -gt 0 && \" ${test_names[*]} \" == *\" $line \"* ]]; then","class":"lineCov","hits":"164","order":"187","possible_hits":"0",},
...
{"lineNum":"  172","line":"      fi"},
{"lineNum":"  173","line":"      test_names+=(\"$line\")","class":"lineCov","hits":"84","order":"188","possible_hits":"0",},
...
{"lineNum":"  180","line":""},
{"lineNum":"  181","line":"  test_count=\"${#all_tests[@]}\"","class":"lineCov","hits":"4","order":"190","possible_hits":"0",},
{"lineNum":"  182","line":"}"},
{"lineNum":"  183","line":""},
...
{"lineNum":"  203","line":""},
{"lineNum":"  204","line":"if [[ -n \"$filter_status\" ]]; then","class":"lineCov","hits":"4","order":"191","possible_hits":"0",},
...
{"lineNum":"  283","line":"fi"},
{"lineNum":"  284","line":""},
{"lineNum":"  285","line":"if [[ -n \"$count_only_flag\" ]]; then","class":"lineCov","hits":"4","order":"192","possible_hits":"0",},
...
{"lineNum":"  288","line":"fi"},
{"lineNum":"  289","line":""},
{"lineNum":"  290","line":"if [[ -n \"$bats_no_parallelize_across_files\" ]] && [[ ! \"$num_jobs\" -gt 1 ]]; then","class":"lineCov","hits":"4","order":"193","possible_hits":"0",},
...
{"lineNum":"  293","line":"fi"},
{"lineNum":"  294","line":""},
{"lineNum":"  295","line":"if [[ -n \"$bats_no_parallelize_within_files\" ]] && [[ ! \"$num_jobs\" -gt 1 ]]; then","class":"lineCov","hits":"4","order":"194","possible_hits":"0",},
...
{"lineNum":"  301","line":"trap \'BATS_INTERRUPTED=true\' INT","class":"lineCov","hits":"4","order":"195","possible_hits":"0",},
{"lineNum":"  302","line":""},
{"lineNum":"  303","line":"bats_exec_suite_status=0","class":"lineCov","hits":"4","order":"196","possible_hits":"0",},
{"lineNum":"  304","line":"printf \'1..%d\\n\' \"${test_count}\"","class":"lineCov","hits":"4","order":"197","possible_hits":"0",},
{"lineNum":"  305","line":""},
{"lineNum":"  306","line":"# No point on continuing if there\'s no tests."},
{"lineNum":"  307","line":"if [[ \"${test_count}\" == 0 ]]; then","class":"lineCov","hits":"4","order":"203","possible_hits":"0",},
{"lineNum":"  308","line":"  exit","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  309","line":"fi"},
{"lineNum":"  310","line":""},
{"lineNum":"  311","line":"export BATS_SUITE_TMPDIR=\"${BATS_RUN_TMPDIR}/suite\"","class":"lineCov","hits":"8","order":"204","possible_hits":"0",},
{"lineNum":"  312","line":"if ! mkdir \"$BATS_SUITE_TMPDIR\"; then","class":"lineCov","hits":"4","order":"205","possible_hits":"0",},
...
{"lineNum":"  321","line":"IFS=$\'\\n\' read -d \'\' -r -a  BATS_UNIQUE_TEST_FILENAMES < <(printf \"%s\\n\" \"$@\"| nl | sort -k 2 | uniq -f 1 | sort -n | cut -f 2-) || true","class":"lineCov","hits":"36","order":"206","possible_hits":"0",},
{"lineNum":"  322","line":""},
{"lineNum":"  323","line":"# shellcheck source=lib/bats-core/tracing.bash"},
{"lineNum":"  324","line":"source \"$BATS_ROOT/lib/bats-core/tracing.bash\"","class":"lineCov","hits":"4","order":"207","possible_hits":"0",},
{"lineNum":"  325","line":"bats_setup_tracing","class":"lineCov","hits":"4","order":"209","possible_hits":"0",},
{"lineNum":"  326","line":""},
{"lineNum":"  327","line":"trap bats_suite_exit_trap EXIT","class":"lineCov","hits":"8","order":"239","possible_hits":"0",},
{"lineNum":"  328","line":""},
{"lineNum":"  329","line":"exec 3<&1","class":"lineCov","hits":"8","order":"240","possible_hits":"0",},
{"lineNum":"  330","line":""},
{"lineNum":"  331","line":"bats_suite_exit_trap() {"},
{"lineNum":"  332","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"8","order":"679","possible_hits":"0",},
{"lineNum":"  333","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED}\" || -z \"${BATS_TEARDOWN_SUITE_COMPLETED}\" ]]; then","class":"lineCov","hits":"12","order":"680","possible_hits":"0",},
...
{"lineNum":"  345","line":"  fi"},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  if [[ -n \"$print_bats_out\" ]]; then","class":"lineCov","hits":"8","order":"681","possible_hits":"0",},
{"lineNum":"  348","line":"    bats_prefix_lines_for_tap_output < \"$BATS_OUT\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  349","line":"  fi"},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"  if [[ ${BATS_INTERRUPTED-NOTSET} != NOTSET ]]; then","class":"lineCov","hits":"8","order":"682","possible_hits":"0",},
{"lineNum":"  352","line":"    printf \"\\n# Received SIGINT, aborting ...\\n\\n\"","class":"lineCov","hits":"2","possible_hits":"0",},
{"lineNum":"  353","line":"  fi"},
{"lineNum":"  354","line":""},
{"lineNum":"  355","line":"  if [[ -d \"$BATS_RUN_LOGS_DIRECTORY\" && -n \"${BATS_INTERRUPTED:-}\" ]]; then","class":"lineCov","hits":"8","order":"683","possible_hits":"0",},
...
{"lineNum":"  358","line":"  fi"},
{"lineNum":"  359","line":"  exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"8","order":"684","possible_hits":"0",},
{"lineNum":"  360","line":"} >&3","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  361","line":""},
{"lineNum":"  362","line":"bats_run_teardown_suite() {"},
{"lineNum":"  363","line":"  local bats_teardown_suite_status=0","class":"lineCov","hits":"8","order":"671","possible_hits":"0",},
...
{"lineNum":"  366","line":"  trap bats_suite_exit_trap EXIT","class":"lineCov","hits":"8","order":"672","possible_hits":"0",},
{"lineNum":"  367","line":"  BATS_TEARDOWN_SUITE_COMPLETED=","class":"lineCov","hits":"8","order":"673","possible_hits":"0",},
{"lineNum":"  368","line":"  teardown_suite >>\"$BATS_OUT\" 2>&1 || bats_teardown_suite_status=$?","class":"lineCov","hits":"8","order":"674","possible_hits":"0",},
{"lineNum":"  369","line":"  if (( bats_teardown_suite_status == 0 )); then","class":"lineCov","hits":"8","order":"676","possible_hits":"0",},
{"lineNum":"  370","line":"    BATS_TEARDOWN_SUITE_COMPLETED=1","class":"lineCov","hits":"8","order":"677","possible_hits":"0",},
...
{"lineNum":"  384","line":"  :","class":"lineCov","hits":"8","order":"675","possible_hits":"0",},
{"lineNum":"  385","line":"}"},
{"lineNum":"  386","line":""},
{"lineNum":"  387","line":"trap bats_teardown_suite_trap EXIT","class":"lineCov","hits":"8","order":"241","possible_hits":"0",},
{"lineNum":"  388","line":""},
{"lineNum":"  389","line":"BATS_OUT=\"$BATS_RUN_TMPDIR/suite.out\"","class":"lineCov","hits":"8","order":"242","possible_hits":"0",},
{"lineNum":"  390","line":"if [[ -n \"$setup_suite_file\" ]]; then","class":"lineCov","hits":"8","order":"243","possible_hits":"0",},
...
{"lineNum":"  412","line":"  BATS_SETUP_SUITE_COMPLETED=1","class":"lineCov","hits":"8","order":"244","possible_hits":"0",},
{"lineNum":"  413","line":"fi"},
{"lineNum":"  414","line":""},
{"lineNum":"  415","line":""},
{"lineNum":"  416","line":"if [[ \"$num_jobs\" -gt 1 ]] && [[ -z \"$bats_no_parallelize_across_files\" ]]; then","class":"lineCov","hits":"8","order":"245","possible_hits":"0",},
...
{"lineNum":"  423","line":"  for filename in \"${BATS_UNIQUE_TEST_FILENAMES[@]}\"; do","class":"lineCov","hits":"8","order":"246","possible_hits":"0",},
{"lineNum":"  424","line":"    if [[ \"${BATS_INTERRUPTED-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"8","order":"247","possible_hits":"0",},
...
{"lineNum":"  427","line":"    fi"},
{"lineNum":"  428","line":"    bats-exec-file \"${flags[@]}\" \"$filename\" \"${TESTS_LIST_FILE}\" || bats_exec_suite_status=1","class":"lineCov","hits":"16","order":"248","possible_hits":"0",},
{"lineNum":"  429","line":"  done"},
{"lineNum":"  430","line":"fi"},
{"lineNum":"  431","line":""},
{"lineNum":"  432","line":"set -eET","class":"lineCov","hits":"8","order":"669","possible_hits":"0",},
{"lineNum":"  433","line":"bats_run_teardown_suite","class":"lineCov","hits":"8","order":"670","possible_hits":"0",},
{"lineNum":"  434","line":""},
{"lineNum":"  435","line":"exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"8","order":"678","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2022-10-19 20:14:07", "instrumented" : 229, "covered" : 86,};
var merged_data = [];
