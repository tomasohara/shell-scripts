...
{"lineNum":"  150","line":"    bats_get_failure_stack_trace stack_trace","class":"lineCov","hits":"4","order":"361","possible_hits":"0",},
...
{"lineNum":"  265","line":"  while read -r test_line; do","class":"lineCov","hits":"62","order":"285","possible_hits":"0",},
...
{"lineNum":"  269","line":"    if [[ \"$filename\" == \"${test_line::${#filename}}\" ]]; then","class":"lineCov","hits":"60","order":"286","possible_hits":"0",},
{"lineNum":"  270","line":"      # get the rest of the line without the separator \\t"},
{"lineNum":"  271","line":"      test_name=${test_line:$((1 + ${#filename} ))}","class":"lineCov","hits":"60","order":"287","possible_hits":"0",},
{"lineNum":"  272","line":"      tests_to_run+=(\"$test_name\")","class":"lineCov","hits":"60","order":"288","possible_hits":"0",},
...
{"lineNum":"  275","line":"      if [[ -z \"$test_number_in_suite\" ]]; then","class":"lineCov","hits":"60","order":"289","possible_hits":"0",},
...
var header = { "command" : "bats", "date" : "2022-09-26 10:26:52", "instrumented" : 176, "covered" : 82,};
var merged_data = [];
