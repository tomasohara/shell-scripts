...
<<<<<<< HEAD
{"lineNum":"  121","line":"    while read -r line; do","class":"lineCov","hits":"623","order":"132","possible_hits":"0",},
{"lineNum":"  122","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"627","order":"148","possible_hits":"0",},
{"lineNum":"  123","line":"        continue","class":"lineCov","hits":"604","order":"149","possible_hits":"0",},
{"lineNum":"  124","line":"      fi"},
{"lineNum":"  125","line":"      line=\"${line%$\'\\r\'}\"","class":"lineCov","hits":"17","order":"183","possible_hits":"0",},
{"lineNum":"  126","line":"      line=\"${line#* }\"","class":"lineCov","hits":"17","order":"184","possible_hits":"0",},
{"lineNum":"  127","line":"      TAG_REGEX=\"--tags \'(.*)\' (.*)\"","class":"lineCov","hits":"17","order":"185","possible_hits":"0",},
{"lineNum":"  128","line":"      if [[ \"$line\" =~ $TAG_REGEX ]]; then","class":"lineCov","hits":"17","order":"186","possible_hits":"0",},
{"lineNum":"  129","line":"        IFS=, read -ra tags <<<\"${BASH_REMATCH[1]}\" || true","class":"lineCov","hits":"34","order":"187","possible_hits":"0",},
{"lineNum":"  130","line":"        line=\"${BASH_REMATCH[2]}\"","class":"lineCov","hits":"17","order":"189","possible_hits":"0",},
=======
{"lineNum":"  121","line":"    while read -r line; do","class":"lineCov","hits":"262","order":"132","possible_hits":"0",},
{"lineNum":"  122","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"261","order":"148","possible_hits":"0",},
{"lineNum":"  123","line":"        continue","class":"lineCov","hits":"245","order":"149","possible_hits":"0",},
{"lineNum":"  124","line":"      fi"},
{"lineNum":"  125","line":"      line=\"${line%$\'\\r\'}\"","class":"lineCov","hits":"16","order":"183","possible_hits":"0",},
...
=======
{"lineNum":"  135","line":"      if bats_all_in tags \'bats:focus\'; then","class":"lineCov","hits":"16","order":"190","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
=======
{"lineNum":"  146","line":"      elif [[ $focus_mode == 1 ]]; then","class":"lineCov","hits":"16","order":"200","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
=======
{"lineNum":"  151","line":"      if [[ ${#filter_tags_list[@]} -gt 0 ]]; then","class":"lineCov","hits":"16","order":"201","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
=======
{"lineNum":"  181","line":"      test_line=$(printf \"%s\\t%s\" \"$filename\" \"$line\")","class":"lineCov","hits":"32","order":"202","possible_hits":"0",},
{"lineNum":"  182","line":"      all_tests+=(\"$test_line\")","class":"lineCov","hits":"16","order":"203","possible_hits":"0",},
{"lineNum":"  183","line":"      printf \"%s\\n\" \"$test_line\" >>\"$TESTS_LIST_FILE\"","class":"lineCov","hits":"16","order":"204","possible_hits":"0",},
{"lineNum":"  184","line":"      # avoid unbound variable errors on empty array expansion with old bash versions"},
{"lineNum":"  185","line":"      if [[ ${#test_names[@]} -gt 0 && \" ${test_names[*]} \" == *\" $line \"* ]]; then","class":"lineCov","hits":"31","order":"205","possible_hits":"0",},
{"lineNum":"  186","line":"        test_dupes+=(\"$line\")","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  187","line":"        continue","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  188","line":"      fi"},
{"lineNum":"  189","line":"      test_names+=(\"$line\")","class":"lineCov","hits":"16","order":"206","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
<<<<<<< HEAD
{"lineNum":"  355","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"2","order":"798","possible_hits":"0",},
{"lineNum":"  356","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED}\" || -z \"${BATS_TEARDOWN_SUITE_COMPLETED}\" ]]; then","class":"lineCov","hits":"3","order":"799","possible_hits":"0",},
=======
{"lineNum":"  355","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"2","order":"694","possible_hits":"0",},
{"lineNum":"  356","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED}\" || -z \"${BATS_TEARDOWN_SUITE_COMPLETED}\" ]]; then","class":"lineCov","hits":"3","order":"695","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
{"lineNum":"  369","line":""},
<<<<<<< HEAD
{"lineNum":"  370","line":"  if [[ -n \"$print_bats_out\" ]]; then","class":"lineCov","hits":"2","order":"800","possible_hits":"0",},
{"lineNum":"  371","line":"    bats_prefix_lines_for_tap_output <\"$BATS_OUT\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  372","line":"  fi"},
{"lineNum":"  373","line":""},
{"lineNum":"  374","line":"  if [[ ${BATS_INTERRUPTED-NOTSET} != NOTSET ]]; then","class":"lineCov","hits":"2","order":"801","possible_hits":"0",},
{"lineNum":"  375","line":"    printf \"\\n# Received SIGINT, aborting ...\\n\\n\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  376","line":"  fi"},
{"lineNum":"  377","line":""},
{"lineNum":"  378","line":"  if [[ -d \"$BATS_RUN_LOGS_DIRECTORY\" && -n \"${BATS_INTERRUPTED:-}\" ]]; then","class":"lineCov","hits":"2","order":"802","possible_hits":"0",},
...
{"lineNum":"  381","line":"  fi"},
{"lineNum":"  382","line":"  exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"2","order":"803","possible_hits":"0",},
{"lineNum":"  383","line":"} >&3","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  384","line":""},
{"lineNum":"  385","line":"bats_run_teardown_suite() {"},
{"lineNum":"  386","line":"  local bats_teardown_suite_status=0","class":"lineCov","hits":"2","order":"789","possible_hits":"0",},
...
{"lineNum":"  389","line":"  trap bats_suite_exit_trap EXIT","class":"lineCov","hits":"2","order":"790","possible_hits":"0",},
{"lineNum":"  390","line":"  BATS_TEARDOWN_SUITE_COMPLETED=","class":"lineCov","hits":"2","order":"791","possible_hits":"0",},
{"lineNum":"  391","line":"  teardown_suite >>\"$BATS_OUT\" 2>&1 || bats_teardown_suite_status=$?","class":"lineCov","hits":"2","order":"792","possible_hits":"0",},
{"lineNum":"  392","line":"  if ((bats_teardown_suite_status == 0)); then","class":"lineCov","hits":"2","order":"794","possible_hits":"0",},
{"lineNum":"  393","line":"    BATS_TEARDOWN_SUITE_COMPLETED=1","class":"lineCov","hits":"2","order":"795","possible_hits":"0",},
=======
{"lineNum":"  370","line":"  if [[ -n \"$print_bats_out\" ]]; then","class":"lineCov","hits":"2","order":"696","possible_hits":"0",},
{"lineNum":"  371","line":"    bats_prefix_lines_for_tap_output <\"$BATS_OUT\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  372","line":"  fi"},
{"lineNum":"  373","line":""},
{"lineNum":"  374","line":"  if [[ ${BATS_INTERRUPTED-NOTSET} != NOTSET ]]; then","class":"lineCov","hits":"2","order":"697","possible_hits":"0",},
{"lineNum":"  375","line":"    printf \"\\n# Received SIGINT, aborting ...\\n\\n\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  376","line":"  fi"},
{"lineNum":"  377","line":""},
{"lineNum":"  378","line":"  if [[ -d \"$BATS_RUN_LOGS_DIRECTORY\" && -n \"${BATS_INTERRUPTED:-}\" ]]; then","class":"lineCov","hits":"2","order":"698","possible_hits":"0",},
{"lineNum":"  379","line":"    # aborting a test run with CTRL+C does not save the runlog file"},
{"lineNum":"  380","line":"    [[ \"$BATS_RUNLOG_FILE\" != /dev/null ]] && rm \"$BATS_RUNLOG_FILE\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  381","line":"  fi"},
{"lineNum":"  382","line":"  exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"2","order":"699","possible_hits":"0",},
{"lineNum":"  383","line":"} >&3","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  384","line":""},
{"lineNum":"  385","line":"bats_run_teardown_suite() {"},
{"lineNum":"  386","line":"  local bats_teardown_suite_status=0","class":"lineCov","hits":"2","order":"685","possible_hits":"0",},
{"lineNum":"  387","line":"  # avoid being called twice, in case this is not called through bats_teardown_suite_trap"},
{"lineNum":"  388","line":"  # but from the end of file"},
{"lineNum":"  389","line":"  trap bats_suite_exit_trap EXIT","class":"lineCov","hits":"2","order":"686","possible_hits":"0",},
{"lineNum":"  390","line":"  BATS_TEARDOWN_SUITE_COMPLETED=","class":"lineCov","hits":"2","order":"687","possible_hits":"0",},
{"lineNum":"  391","line":"  teardown_suite >>\"$BATS_OUT\" 2>&1 || bats_teardown_suite_status=$?","class":"lineCov","hits":"2","order":"688","possible_hits":"0",},
{"lineNum":"  392","line":"  if ((bats_teardown_suite_status == 0)); then","class":"lineCov","hits":"2","order":"690","possible_hits":"0",},
{"lineNum":"  393","line":"    BATS_TEARDOWN_SUITE_COMPLETED=1","class":"lineCov","hits":"2","order":"691","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
<<<<<<< HEAD
{"lineNum":"  408","line":"  :","class":"lineCov","hits":"2","order":"793","possible_hits":"0",},
=======
{"lineNum":"  408","line":"  :","class":"lineCov","hits":"2","order":"689","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"  409","line":"}"},
{"lineNum":"  410","line":""},
...
{"lineNum":"  454","line":""},
<<<<<<< HEAD
{"lineNum":"  455","line":"set -eET","class":"lineCov","hits":"2","order":"787","possible_hits":"0",},
{"lineNum":"  456","line":"bats_run_teardown_suite","class":"lineCov","hits":"2","order":"788","possible_hits":"0",},
{"lineNum":"  457","line":""},
{"lineNum":"  458","line":"if [[ \"$focus_mode\" == 1 && $bats_exec_suite_status -eq 0 ]]; then","class":"lineCov","hits":"2","order":"796","possible_hits":"0",},
=======
{"lineNum":"  455","line":"set -eET","class":"lineCov","hits":"2","order":"683","possible_hits":"0",},
{"lineNum":"  456","line":"bats_run_teardown_suite","class":"lineCov","hits":"2","order":"684","possible_hits":"0",},
{"lineNum":"  457","line":""},
{"lineNum":"  458","line":"if [[ \"$focus_mode\" == 1 && $bats_exec_suite_status -eq 0 ]]; then","class":"lineCov","hits":"2","order":"692","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
{"lineNum":"  466","line":""},
<<<<<<< HEAD
{"lineNum":"  467","line":"exit \"$bats_exec_suite_status\" # the actual exit code will be set by the exit trap using bats_exec_suite_status","class":"lineCov","hits":"2","order":"797","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2023-05-19 18:20:07", "instrumented" : 245, "covered" : 90,};
=======
{"lineNum":"  467","line":"exit \"$bats_exec_suite_status\" # the actual exit code will be set by the exit trap using bats_exec_suite_status","class":"lineCov","hits":"2","order":"693","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2023-05-06 21:38:20", "instrumented" : 245, "covered" : 90,};
>>>>>>> integration-testing-3fa2c13
var merged_data = [];
