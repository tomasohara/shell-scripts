...
{"lineNum":"  121","line":"    while read -r line; do","class":"lineCov","hits":"10","order":"129","possible_hits":"0",},
{"lineNum":"  122","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"9","order":"148","possible_hits":"0",},
{"lineNum":"  123","line":"        continue","class":"lineCov","hits":"9","order":"149","possible_hits":"0",},
{"lineNum":"  124","line":"      fi"},
{"lineNum":"  125","line":"      line=\"${line%$\'\\r\'}\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  126","line":"      line=\"${line#* }\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  127","line":"      TAG_REGEX=\"--tags \'(.*)\' (.*)\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  128","line":"      if [[ \"$line\" =~ $TAG_REGEX ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  129","line":"        IFS=, read -ra tags <<<\"${BASH_REMATCH[1]}\" || true","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  130","line":"        line=\"${BASH_REMATCH[2]}\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  131","line":"      else"},
{"lineNum":"  132","line":"        tags=()"},
{"lineNum":"  133","line":"      fi"},
{"lineNum":"  134","line":"      # is this test focused?"},
{"lineNum":"  135","line":"      if bats_all_in tags \'bats:focus\'; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  145","line":"        fi"},
{"lineNum":"  146","line":"      elif [[ $focus_mode == 1 ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  150","line":"      fi"},
{"lineNum":"  151","line":"      if [[ ${#filter_tags_list[@]} -gt 0 ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  179","line":"        fi"},
{"lineNum":"  180","line":"      fi"},
{"lineNum":"  181","line":"      test_line=$(printf \"%s\\t%s\" \"$filename\" \"$line\")","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  182","line":"      all_tests+=(\"$test_line\")","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  185","line":"      if [[ ${#test_names[@]} -gt 0 && \" ${test_names[*]} \" == *\" $line \"* ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  188","line":"      fi"},
{"lineNum":"  189","line":"      test_names+=(\"$line\")","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  190","line":"    done < <(BATS_TEST_FILTER=\"$filter\" bats-preprocess \"$filename\")","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  191","line":""},
{"lineNum":"  192","line":"    if [[ \"${#test_dupes[@]}\" -ne 0 ]]; then","class":"lineCov","hits":"1","order":"151","possible_hits":"0",},
...
{"lineNum":"  196","line":""},
{"lineNum":"  197","line":"  test_count=\"${#all_tests[@]}\"","class":"lineCov","hits":"1","order":"152","possible_hits":"0",},
{"lineNum":"  198","line":"}"},
{"lineNum":"  199","line":""},
...
{"lineNum":"  223","line":""},
{"lineNum":"  224","line":"if [[ -n \"$filter_status\" ]]; then","class":"lineCov","hits":"1","order":"153","possible_hits":"0",},
...
{"lineNum":"  303","line":"fi"},
{"lineNum":"  304","line":""},
{"lineNum":"  305","line":"if [[ -n \"$count_only_flag\" ]]; then","class":"lineCov","hits":"1","order":"154","possible_hits":"0",},
...
{"lineNum":"  308","line":"fi"},
{"lineNum":"  309","line":""},
{"lineNum":"  310","line":"if [[ -n \"$bats_no_parallelize_across_files\" ]] && [[ ! \"$num_jobs\" -gt 1 ]]; then","class":"lineCov","hits":"1","order":"155","possible_hits":"0",},
...
{"lineNum":"  312","line":"fi"},
{"lineNum":"  313","line":""},
{"lineNum":"  314","line":"if [[ -n \"$bats_no_parallelize_within_files\" ]] && [[ ! \"$num_jobs\" -gt 1 ]]; then","class":"lineCov","hits":"1","order":"156","possible_hits":"0",},
...
{"lineNum":"  319","line":"trap \'BATS_INTERRUPTED=true\' INT","class":"lineCov","hits":"1","order":"157","possible_hits":"0",},
{"lineNum":"  320","line":""},
{"lineNum":"  321","line":"if [[ -n \"$focus_mode\" ]]; then","class":"lineCov","hits":"1","order":"158","possible_hits":"0",},
...
{"lineNum":"  323","line":"fi"},
{"lineNum":"  324","line":""},
{"lineNum":"  325","line":"bats_exec_suite_status=0","class":"lineCov","hits":"1","order":"159","possible_hits":"0",},
{"lineNum":"  326","line":"printf \'1..%d\\n\' \"${test_count}\"","class":"lineCov","hits":"1","order":"160","possible_hits":"0",},
{"lineNum":"  327","line":""},
{"lineNum":"  328","line":"# No point on continuing if there\'s no tests."},
{"lineNum":"  329","line":"if [[ \"${test_count}\" == 0 ]]; then","class":"lineCov","hits":"1","order":"161","possible_hits":"0",},
{"lineNum":"  330","line":"  exit","class":"lineCov","hits":"1","order":"162","possible_hits":"0",},
{"lineNum":"  331","line":"fi"},
{"lineNum":"  332","line":""},
{"lineNum":"  333","line":"export BATS_SUITE_TMPDIR=\"${BATS_RUN_TMPDIR}/suite\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  334","line":"if ! mkdir \"$BATS_SUITE_TMPDIR\"; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  346","line":"source \"$BATS_ROOT/lib/bats-core/tracing.bash\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  347","line":"bats_setup_tracing","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  348","line":""},
{"lineNum":"  349","line":"trap bats_suite_exit_trap EXIT","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"exec 3<&1","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  352","line":""},
{"lineNum":"  353","line":"# shellcheck disable=SC2317"},
{"lineNum":"  354","line":"bats_suite_exit_trap() {"},
{"lineNum":"  355","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  356","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED}\" || -z \"${BATS_TEARDOWN_SUITE_COMPLETED}\" ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  368","line":"  fi"},
{"lineNum":"  369","line":""},
{"lineNum":"  370","line":"  if [[ -n \"$print_bats_out\" ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  371","line":"    bats_prefix_lines_for_tap_output <\"$BATS_OUT\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  372","line":"  fi"},
{"lineNum":"  373","line":""},
{"lineNum":"  374","line":"  if [[ ${BATS_INTERRUPTED-NOTSET} != NOTSET ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  375","line":"    printf \"\\n# Received SIGINT, aborting ...\\n\\n\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  376","line":"  fi"},
{"lineNum":"  377","line":""},
{"lineNum":"  378","line":"  if [[ -d \"$BATS_RUN_LOGS_DIRECTORY\" && -n \"${BATS_INTERRUPTED:-}\" ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  381","line":"  fi"},
{"lineNum":"  382","line":"  exit \"$bats_exec_suite_status\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  383","line":"} >&3","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  384","line":""},
{"lineNum":"  385","line":"bats_run_teardown_suite() {"},
{"lineNum":"  386","line":"  local bats_teardown_suite_status=0","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  389","line":"  trap bats_suite_exit_trap EXIT","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  390","line":"  BATS_TEARDOWN_SUITE_COMPLETED=","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  391","line":"  teardown_suite >>\"$BATS_OUT\" 2>&1 || bats_teardown_suite_status=$?","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  392","line":"  if ((bats_teardown_suite_status == 0)); then","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  393","line":"    BATS_TEARDOWN_SUITE_COMPLETED=1","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  408","line":"  :","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  409","line":"}"},
{"lineNum":"  410","line":""},
{"lineNum":"  411","line":"trap bats_teardown_suite_trap EXIT","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  412","line":""},
{"lineNum":"  413","line":"BATS_OUT=\"$BATS_RUN_TMPDIR/suite.out\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  414","line":"if [[ -n \"$setup_suite_file\" ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  436","line":"  BATS_SETUP_SUITE_COMPLETED=1","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  437","line":"fi"},
{"lineNum":"  438","line":""},
{"lineNum":"  439","line":"if [[ \"$num_jobs\" -gt 1 ]] && [[ -z \"$bats_no_parallelize_across_files\" ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  446","line":"  for filename in \"${BATS_UNIQUE_TEST_FILENAMES[@]}\"; do","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  447","line":"    if [[ \"${BATS_INTERRUPTED-NOTSET}\" != NOTSET ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  450","line":"    fi"},
{"lineNum":"  451","line":"    bats-exec-file \"${flags[@]}\" \"$filename\" \"${TESTS_LIST_FILE}\" || bats_exec_suite_status=1","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  452","line":"  done"},
{"lineNum":"  453","line":"fi"},
{"lineNum":"  454","line":""},
{"lineNum":"  455","line":"set -eET","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  456","line":"bats_run_teardown_suite","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  457","line":""},
{"lineNum":"  458","line":"if [[ \"$focus_mode\" == 1 && $bats_exec_suite_status -eq 0 ]]; then","class":"lineNoCov","hits":"0","possible_hits":"0",},
...
{"lineNum":"  465","line":"fi"},
{"lineNum":"  466","line":""},
{"lineNum":"  467","line":"exit \"$bats_exec_suite_status\" # the actual exit code will be set by the exit trap using bats_exec_suite_status","class":"lineNoCov","hits":"0","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2023-06-15 21:56:13", "instrumented" : 245, "covered" : 45,};
var merged_data = [];
