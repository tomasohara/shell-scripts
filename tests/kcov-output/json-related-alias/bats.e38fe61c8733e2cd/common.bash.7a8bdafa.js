...
<<<<<<< HEAD
{"lineNum":"    4","line":"  while IFS= read -r line; do","class":"lineCov","hits":"676","order":"565","possible_hits":"0",},
{"lineNum":"    5","line":"    printf \'# %s\\n\' \"$line\" || break # avoid feedback loop when errors are redirected into BATS_OUT (see #353)","class":"lineCov","hits":"317","order":"567","possible_hits":"0",},
{"lineNum":"    6","line":"  done"},
{"lineNum":"    7","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"21","order":"570","possible_hits":"0",},
=======
{"lineNum":"    4","line":"  while IFS= read -r line; do","class":"lineCov","hits":"70","order":"574","possible_hits":"0",},
{"lineNum":"    5","line":"    printf \'# %s\\n\' \"$line\" || break # avoid feedback loop when errors are redirected into BATS_OUT (see #353)","class":"lineCov","hits":"23","order":"575","possible_hits":"0",},
{"lineNum":"    6","line":"  done"},
{"lineNum":"    7","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"12","order":"576","possible_hits":"0",},
...
<<<<<<< HEAD
{"lineNum":"   13","line":"  local line","class":"lineCov","hits":"21","order":"566","possible_hits":"0",},
{"lineNum":"   14","line":"  while read -r line; do","class":"lineCov","hits":"338","order":"568","possible_hits":"0",},
{"lineNum":"   15","line":"    printf \"%s\\n\" \"${line//$BATS_TEST_SOURCE/$BATS_TEST_FILENAME}\"","class":"lineCov","hits":"317","order":"569","possible_hits":"0",},
{"lineNum":"   16","line":"  done"},
{"lineNum":"   17","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"21","order":"571","possible_hits":"0",},
=======
{"lineNum":"   13","line":"  local line","class":"lineCov","hits":"12","order":"577","possible_hits":"0",},
{"lineNum":"   14","line":"  while read -r line; do","class":"lineCov","hits":"35","order":"578","possible_hits":"0",},
{"lineNum":"   15","line":"    printf \"%s\\n\" \"${line//$BATS_TEST_SOURCE/$BATS_TEST_FILENAME}\"","class":"lineCov","hits":"23","order":"579","possible_hits":"0",},
{"lineNum":"   16","line":"  done"},
{"lineNum":"   17","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"12","order":"580","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
<<<<<<< HEAD
{"lineNum":"   23","line":"  printf -v \"$1\" -- \"%s%s%s\" \"$BATS_BEGIN_CODE_QUOTE\" \"$2\" \"$BATS_END_CODE_QUOTE\"","class":"lineCov","hits":"33","order":"552","possible_hits":"0",},
=======
{"lineNum":"   23","line":"  printf -v \"$1\" -- \"%s%s%s\" \"$BATS_BEGIN_CODE_QUOTE\" \"$2\" \"$BATS_END_CODE_QUOTE\"","class":"lineCov","hits":"12","order":"564","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"   24","line":"}"},
{"lineNum":"   25","line":""},
...
<<<<<<< HEAD
{"lineNum":"  221","line":"  local output=\"${1?}\"","class":"lineCov","hits":"33","order":"524","possible_hits":"0",},
{"lineNum":"  222","line":"  shift","class":"lineCov","hits":"33","order":"525","possible_hits":"0",},
{"lineNum":"  223","line":"  \"bats_format_file_line_reference_${BATS_LINE_REFERENCE_FORMAT?}\" \"$@\"","class":"lineCov","hits":"33","order":"526","possible_hits":"0",},
{"lineNum":"  224","line":"}"},
{"lineNum":"  225","line":""},
{"lineNum":"  226","line":"bats_format_file_line_reference_comma_line() {"},
{"lineNum":"  227","line":"  printf -v \"$output\" \"%s, line %d\" \"$@\"","class":"lineCov","hits":"33","order":"527","possible_hits":"0",},
=======
{"lineNum":"  221","line":"  local output=\"${1?}\"","class":"lineCov","hits":"12","order":"536","possible_hits":"0",},
{"lineNum":"  222","line":"  shift","class":"lineCov","hits":"12","order":"537","possible_hits":"0",},
{"lineNum":"  223","line":"  \"bats_format_file_line_reference_${BATS_LINE_REFERENCE_FORMAT?}\" \"$@\"","class":"lineCov","hits":"12","order":"538","possible_hits":"0",},
{"lineNum":"  224","line":"}"},
{"lineNum":"  225","line":""},
{"lineNum":"  226","line":"bats_format_file_line_reference_comma_line() {"},
{"lineNum":"  227","line":"  printf -v \"$output\" \"%s, line %d\" \"$@\"","class":"lineCov","hits":"12","order":"539","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"  228","line":"}"},
{"lineNum":"  229","line":""},
...
<<<<<<< HEAD
var header = { "command" : "bats", "date" : "2023-05-19 18:20:38", "instrumented" : 121, "covered" : 35,};
=======
var header = { "command" : "bats", "date" : "2023-05-06 21:39:31", "instrumented" : 121, "covered" : 35,};
>>>>>>> integration-testing-3fa2c13
var merged_data = [];
