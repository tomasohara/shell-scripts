...
{"lineNum":"   87","line":"  bats_check_status_from_trap","class":"lineCov","hits":"25","order":"447","possible_hits":"0",},
{"lineNum":"   88","line":"  local bats_teardown_trap_status=0","class":"lineCov","hits":"24","order":"450","possible_hits":"0",},
{"lineNum":"   89","line":""},
...
{"lineNum":"   93","line":"  local killer_pid=${2:-}","class":"lineCov","hits":"24","order":"451","possible_hits":"0",},
{"lineNum":"   94","line":""},
...
{"lineNum":"   98","line":"  BATS_TEARDOWN_STARTED=${1:-1}","class":"lineCov","hits":"24","order":"452","possible_hits":"0",},
{"lineNum":"   99","line":"  teardown >>\"$BATS_OUT\" 2>&1 || bats_teardown_trap_status=\"$?\"","class":"lineCov","hits":"24","order":"453","possible_hits":"0",},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"  if [[ $bats_teardown_trap_status -eq 0 ]]; then","class":"lineCov","hits":"24","order":"454","possible_hits":"0",},
{"lineNum":"  102","line":"    BATS_TEARDOWN_COMPLETED=1","class":"lineCov","hits":"24","order":"455","possible_hits":"0",},
...
{"lineNum":"  106","line":"  fi"},
{"lineNum":"  107","line":""},
{"lineNum":"  108","line":"  bats_exit_trap \"$killer_pid\"","class":"lineCov","hits":"24","order":"456","possible_hits":"0",},
{"lineNum":"  109","line":"}"},
{"lineNum":"  110","line":""},
...
{"lineNum":"  115","line":"  local status","class":"lineCov","hits":"24","order":"457","possible_hits":"0",},
{"lineNum":"  116","line":"  local exit_metadata=\'\'","class":"lineCov","hits":"24","order":"458","possible_hits":"0",},
{"lineNum":"  117","line":"  local killer_pid=${1:-}","class":"lineCov","hits":"24","order":"459","possible_hits":"0",},
{"lineNum":"  118","line":"  trap - ERR EXIT","class":"lineCov","hits":"24","order":"460","possible_hits":"0",},
{"lineNum":"  119","line":"  if [[ -n \"${BATS_TEST_TIMEOUT:-}\" ]]; then","class":"lineCov","hits":"24","order":"461","possible_hits":"0",},
...
{"lineNum":"  122","line":"  fi"},
{"lineNum":"  123","line":""},
{"lineNum":"  124","line":"  if [[ -n \"$BATS_TEST_SKIPPED\" ]]; then","class":"lineCov","hits":"24","order":"462","possible_hits":"0",},
...
{"lineNum":"  128","line":"    fi"},
{"lineNum":"  129","line":"  elif [[ \"${BATS_TIMED_OUT-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"24","order":"463","possible_hits":"0",},
{"lineNum":"  130","line":"    exit_metadata=\" # timeout after ${BATS_TEST_TIMEOUT}s\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  131","line":"  fi"},
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"  BATS_TEST_TIME=\'\'","class":"lineCov","hits":"24","order":"464","possible_hits":"0",},
{"lineNum":"  134","line":"  if [[ -n \"$BATS_ENABLE_TIMING\" ]]; then","class":"lineCov","hits":"24","order":"465","possible_hits":"0",},
{"lineNum":"  135","line":"    BATS_TEST_TIME=\" in \"$(($(get_mills_since_epoch) - BATS_TEST_START_TIME))\"ms\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  136","line":"  fi"},
{"lineNum":"  137","line":""},
{"lineNum":"  138","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"24","order":"466","possible_hits":"0",},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  local should_retry=\'\'","class":"lineCov","hits":"24","order":"467","possible_hits":"0",},
{"lineNum":"  141","line":"  if [[ -z \"$BATS_TEST_COMPLETED\" || -z \"$BATS_TEARDOWN_COMPLETED\" || \"${BATS_INTERRUPTED-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"40","order":"468","possible_hits":"0",},
{"lineNum":"  142","line":"    if [[ \"$BATS_ERROR_STATUS\" -eq 0 ]]; then","class":"lineCov","hits":"8","order":"495","possible_hits":"0",},
...
{"lineNum":"  153","line":"    fi"},
{"lineNum":"  154","line":"    if bats_should_retry_test; then","class":"lineCov","hits":"8","order":"496","possible_hits":"0",},
...
{"lineNum":"  159","line":"      printf \'not ok %d %s%s\\n\' \"$BATS_SUITE_TEST_NUMBER\" \"${BATS_TEST_NAME_PREFIX:-}${BATS_TEST_DESCRIPTION}${BATS_TEST_TIME}\" \"$exit_metadata\" >&3","class":"lineCov","hits":"8","order":"497","possible_hits":"0",},
{"lineNum":"  160","line":"      if (( ${#BATS_TEST_TAGS[@]} > 0 )); then","class":"lineCov","hits":"8","order":"498","possible_hits":"0",},
...
{"lineNum":"  165","line":"      local stack_trace","class":"lineCov","hits":"8","order":"499","possible_hits":"0",},
{"lineNum":"  166","line":"      bats_get_failure_stack_trace stack_trace","class":"lineCov","hits":"8","order":"500","possible_hits":"0",},
{"lineNum":"  167","line":"      bats_print_stack_trace \"${stack_trace[@]}\" >&3","class":"lineCov","hits":"8","order":"504","possible_hits":"0",},
{"lineNum":"  168","line":"      bats_print_failed_command \"${stack_trace[@]}\" >&3","class":"lineCov","hits":"8","order":"537","possible_hits":"0",},
{"lineNum":"  169","line":""},
{"lineNum":"  170","line":"      if [[ $BATS_PRINT_OUTPUT_ON_FAILURE ]]; then","class":"lineCov","hits":"8","order":"564","possible_hits":"0",},
...
{"lineNum":"  178","line":""},
{"lineNum":"  179","line":"      print_bats_out=1","class":"lineCov","hits":"8","order":"565","possible_hits":"0",},
{"lineNum":"  180","line":"      status=1","class":"lineCov","hits":"8","order":"566","possible_hits":"0",},
{"lineNum":"  181","line":"      local state=failed","class":"lineCov","hits":"8","order":"567","possible_hits":"0",},
{"lineNum":"  182","line":"    fi"},
{"lineNum":"  183","line":"  else"},
{"lineNum":"  184","line":"    printf \'ok %d %s%s\\n\' \"$BATS_SUITE_TEST_NUMBER\" \"${BATS_TEST_NAME_PREFIX:-}${BATS_TEST_DESCRIPTION}${BATS_TEST_TIME}\" \\","class":"lineCov","hits":"16","order":"469","possible_hits":"0",},
{"lineNum":"  185","line":"      \"$exit_metadata\" >&3"},
{"lineNum":"  186","line":"    status=0","class":"lineCov","hits":"16","order":"470","possible_hits":"0",},
{"lineNum":"  187","line":"    local state=passed","class":"lineCov","hits":"16","order":"472","possible_hits":"0",},
{"lineNum":"  188","line":"  fi"},
{"lineNum":"  189","line":""},
{"lineNum":"  190","line":"  if [[ -z \"$should_retry\" ]]; then","class":"lineCov","hits":"24","order":"474","possible_hits":"0",},
{"lineNum":"  191","line":"    printf \"%s %s\\t%s\\n\" \"$state\" \"$BATS_TEST_FILENAME\" \"$BATS_TEST_NAME\" >>\"$BATS_RUNLOG_FILE\"","class":"lineCov","hits":"24","order":"475","possible_hits":"0",},
{"lineNum":"  192","line":""},
{"lineNum":"  193","line":"    if [[ $print_bats_out ]]; then","class":"lineCov","hits":"24","order":"476","possible_hits":"0",},
{"lineNum":"  194","line":"      bats_prefix_lines_for_tap_output <\"$BATS_OUT\" | bats_replace_filename >&3","class":"lineCov","hits":"16","order":"568","possible_hits":"0",},
{"lineNum":"  195","line":"    fi"},
{"lineNum":"  196","line":"  fi"},
{"lineNum":"  197","line":"  if [[ $BATS_GATHER_TEST_OUTPUTS_IN ]]; then","class":"lineCov","hits":"24","order":"477","possible_hits":"0",},
...
{"lineNum":"  203","line":"  fi"},
{"lineNum":"  204","line":"  rm -f \"$BATS_OUT\"","class":"lineCov","hits":"24","order":"478","possible_hits":"0",},
{"lineNum":"  205","line":"  exit \"$status\"","class":"lineCov","hits":"24","order":"479","possible_hits":"0",},
{"lineNum":"  206","line":"}"},
{"lineNum":"  207","line":""},
...
{"lineNum":"  333","line":""},
{"lineNum":"  334","line":"  BATS_TEST_COMPLETED=1","class":"lineCov","hits":"16","order":"444","possible_hits":"0",},
{"lineNum":"  335","line":"  # shellcheck disable=SC2064"},
{"lineNum":"  336","line":"  trap \"bats_exit_trap $BATS_killer_pid\" EXIT","class":"lineCov","hits":"16","order":"445","possible_hits":"0",},
{"lineNum":"  337","line":"  bats_teardown_trap \"\" \"$BATS_killer_pid\" # pass empty parameter to signify call outside trap","class":"lineCov","hits":"16","order":"446","possible_hits":"0",},
{"lineNum":"  338","line":"}"},
{"lineNum":"  339","line":""},
...
var header = { "command" : "bats", "date" : "2023-04-12 19:01:06", "instrumented" : 186, "covered" : 98,};
var merged_data = [];
