...
{"lineNum":"    4","line":"  while IFS= read -r line; do","class":"lineCov","hits":"3","order":"437","possible_hits":"0",},
...
{"lineNum":"    6","line":"  done"},
{"lineNum":"    7","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"2","order":"438","possible_hits":"0",},
{"lineNum":"    8","line":"    printf \'# %s\\n\' \"$line\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"    9","line":"  fi"},
{"lineNum":"   10","line":"}"},
{"lineNum":"   11","line":""},
{"lineNum":"   12","line":"function bats_replace_filename() {"},
{"lineNum":"   13","line":"  local line","class":"lineCov","hits":"2","order":"439","possible_hits":"0",},
{"lineNum":"   14","line":"  while read -r line; do","class":"lineCov","hits":"2","order":"440","possible_hits":"0",},
...
{"lineNum":"   17","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"2","order":"441","possible_hits":"0",},
{"lineNum":"   18","line":"    printf \"%s\\n\" \"${line//$BATS_TEST_SOURCE/$BATS_TEST_FILENAME}\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"   19","line":"  fi"},
{"lineNum":"   20","line":"}"},
{"lineNum":"   21","line":""},
{"lineNum":"   22","line":"bats_quote_code() { # <var> <code>"},
{"lineNum":"   23","line":"  printf -v \"$1\" -- \"%s%s%s\" \"$BATS_BEGIN_CODE_QUOTE\" \"$2\" \"$BATS_END_CODE_QUOTE\"","class":"lineCov","hits":"2","order":"431","possible_hits":"0",},
{"lineNum":"   24","line":"}"},
{"lineNum":"   25","line":""},
...
{"lineNum":"  103","line":"  local -r result_name=$1","class":"lineCov","hits":"65","order":"173","possible_hits":"0",},
{"lineNum":"  104","line":"  shift","class":"lineCov","hits":"65","order":"174","possible_hits":"0",},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"  if (($# == 0)); then","class":"lineCov","hits":"65","order":"175","possible_hits":"0",},
{"lineNum":"  107","line":"    eval \"$result_name=()\"","class":"lineCov","hits":"130","order":"176","possible_hits":"0",},
{"lineNum":"  108","line":"    return 0","class":"lineCov","hits":"65","order":"177","possible_hits":"0",},
{"lineNum":"  109","line":"  fi"},
{"lineNum":"  110","line":""},
...
{"lineNum":"  196","line":"  local -a trailing_args=()","class":"lineCov","hits":"130","order":"164","possible_hits":"0",},
{"lineNum":"  197","line":"  while (($# > 0)) && [[ $1 != -- ]]; do","class":"lineCov","hits":"390","order":"165","possible_hits":"0",},
{"lineNum":"  198","line":"    local array=$1","class":"lineCov","hits":"130","order":"166","possible_hits":"0",},
{"lineNum":"  199","line":"    shift","class":"lineCov","hits":"130","order":"167","possible_hits":"0",},
{"lineNum":"  200","line":""},
{"lineNum":"  201","line":"    if eval \"(( \\${#${array}[@]} > 0 ))\"; then","class":"lineCov","hits":"260","order":"168","possible_hits":"0",},
{"lineNum":"  202","line":"      eval \"trailing_args+=(\\\"\\${${array}[@]}\\\")\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  203","line":"    fi"},
{"lineNum":"  204","line":"  done"},
{"lineNum":"  205","line":"  shift # remove -- separator","class":"lineCov","hits":"65","order":"169","possible_hits":"0",},
{"lineNum":"  206","line":""},
{"lineNum":"  207","line":"  if (($# == 0)); then","class":"lineCov","hits":"65","order":"170","possible_hits":"0",},
...
{"lineNum":"  210","line":"  fi"},
{"lineNum":"  211","line":""},
{"lineNum":"  212","line":"  if ((${#trailing_args[@]} > 0)); then","class":"lineCov","hits":"65","order":"171","possible_hits":"0",},
{"lineNum":"  213","line":"    \"$@\" \"${trailing_args[@]}\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  214","line":"  else"},
{"lineNum":"  215","line":"    \"$@\"","class":"lineCov","hits":"65","order":"172","possible_hits":"0",},
{"lineNum":"  216","line":"  fi"},
{"lineNum":"  217","line":"}"},
{"lineNum":"  218","line":""},
...
{"lineNum":"  221","line":"  local output=\"${1?}\"","class":"lineCov","hits":"2","order":"403","possible_hits":"0",},
{"lineNum":"  222","line":"  shift","class":"lineCov","hits":"2","order":"404","possible_hits":"0",},
{"lineNum":"  223","line":"  \"bats_format_file_line_reference_${BATS_LINE_REFERENCE_FORMAT?}\" \"$@\"","class":"lineCov","hits":"2","order":"405","possible_hits":"0",},
{"lineNum":"  224","line":"}"},
{"lineNum":"  225","line":""},
{"lineNum":"  226","line":"bats_format_file_line_reference_comma_line() {"},
{"lineNum":"  227","line":"  printf -v \"$output\" \"%s, line %d\" \"$@\"","class":"lineCov","hits":"2","order":"406","possible_hits":"0",},
{"lineNum":"  228","line":"}"},
{"lineNum":"  229","line":""},
...
var header = { "command" : "bats", "date" : "2023-04-06 21:10:44", "instrumented" : 121, "covered" : 33,};
var merged_data = [];
