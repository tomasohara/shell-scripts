...
{"lineNum":"    2","line":"set -eET","class":"lineCov","hits":"3","order":"372","possible_hits":"0",},
{"lineNum":"    3","line":""},
{"lineNum":"    4","line":"# Variables used in other scripts."},
{"lineNum":"    5","line":"BATS_ENABLE_TIMING=\'\'","class":"lineCov","hits":"3","order":"373","possible_hits":"0",},
{"lineNum":"    6","line":"BATS_EXTENDED_SYNTAX=\'\'","class":"lineCov","hits":"3","order":"374","possible_hits":"0",},
{"lineNum":"    7","line":"BATS_TRACE_LEVEL=\"${BATS_TRACE_LEVEL:-0}\"","class":"lineCov","hits":"3","order":"375","possible_hits":"0",},
{"lineNum":"    8","line":"BATS_PRINT_OUTPUT_ON_FAILURE=\"${BATS_PRINT_OUTPUT_ON_FAILURE:-}\"","class":"lineCov","hits":"3","order":"376","possible_hits":"0",},
{"lineNum":"    9","line":"BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS:-}\"","class":"lineCov","hits":"3","order":"377","possible_hits":"0",},
{"lineNum":"   10","line":"BATS_VERBOSE_RUN=\"${BATS_VERBOSE_RUN:-}\"","class":"lineCov","hits":"3","order":"378","possible_hits":"0",},
{"lineNum":"   11","line":"BATS_GATHER_TEST_OUTPUTS_IN=\"${BATS_GATHER_TEST_OUTPUTS_IN:-}\"","class":"lineCov","hits":"3","order":"379","possible_hits":"0",},
{"lineNum":"   12","line":"BATS_TEST_NAME_PREFIX=\"${BATS_TEST_NAME_PREFIX:-}\"","class":"lineCov","hits":"3","order":"380","possible_hits":"0",},
{"lineNum":"   13","line":""},
{"lineNum":"   14","line":"while [[ \"$#\" -ne 0 ]]; do","class":"lineCov","hits":"6","order":"381","possible_hits":"0",},
{"lineNum":"   15","line":"  case \"$1\" in","class":"lineCov","hits":"6","order":"382","possible_hits":"0",},
{"lineNum":"   16","line":"  -T)"},
...
{"lineNum":"   40","line":"    ;;"},
{"lineNum":"   41","line":"  *)"},
{"lineNum":"   42","line":"    break","class":"lineCov","hits":"3","order":"384","possible_hits":"0",},
{"lineNum":"   43","line":"    ;;"},
{"lineNum":"   44","line":"  esac"},
{"lineNum":"   45","line":"  shift","class":"lineCov","hits":"3","order":"383","possible_hits":"0",},
{"lineNum":"   46","line":"done"},
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"export BATS_TEST_FILENAME=\"$1\"","class":"lineCov","hits":"6","order":"385","possible_hits":"0",},
{"lineNum":"   49","line":"export BATS_TEST_NAME=\"$2\"","class":"lineCov","hits":"6","order":"386","possible_hits":"0",},
{"lineNum":"   50","line":"export BATS_SUITE_TEST_NUMBER=\"$3\"","class":"lineCov","hits":"6","order":"387","possible_hits":"0",},
{"lineNum":"   51","line":"export BATS_TEST_NUMBER=\"$4\"","class":"lineCov","hits":"6","order":"388","possible_hits":"0",},
{"lineNum":"   52","line":"BATS_TEST_TRY_NUMBER=\"$5\"","class":"lineCov","hits":"3","order":"389","possible_hits":"0",},
{"lineNum":"   53","line":""},
{"lineNum":"   54","line":"if [[ -z \"$BATS_TEST_FILENAME\" ]]; then","class":"lineCov","hits":"3","order":"390","possible_hits":"0",},
...
{"lineNum":"   57","line":"elif [[ ! -f \"$BATS_TEST_FILENAME\" ]]; then","class":"lineCov","hits":"3","order":"391","possible_hits":"0",},
...
{"lineNum":"   63","line":"  local tests_tmpdir=\"${BATS_RUN_TMPDIR}/test\"","class":"lineCov","hits":"3","order":"399","possible_hits":"0",},
{"lineNum":"   64","line":"  if ! mkdir -p \"$tests_tmpdir\"; then","class":"lineCov","hits":"3","order":"400","possible_hits":"0",},
...
{"lineNum":"   67","line":"  fi"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"  BATS_TEST_TMPDIR=\"$tests_tmpdir/$BATS_SUITE_TEST_NUMBER\"","class":"lineCov","hits":"3","order":"401","possible_hits":"0",},
{"lineNum":"   70","line":"  if ! mkdir \"$BATS_TEST_TMPDIR\"; then","class":"lineCov","hits":"3","order":"402","possible_hits":"0",},
...
{"lineNum":"   73","line":"  fi"},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":"  printf \"%s\\n\" \"$BATS_TEST_NAME\" >\"$BATS_TEST_TMPDIR.name\"","class":"lineCov","hits":"3","order":"403","possible_hits":"0",},
{"lineNum":"   76","line":""},
{"lineNum":"   77","line":"  export BATS_TEST_TMPDIR","class":"lineCov","hits":"3","order":"404","possible_hits":"0",},
{"lineNum":"   78","line":"}"},
{"lineNum":"   79","line":""},
...
{"lineNum":"   82","line":"source \"$BATS_ROOT/lib/bats-core/test_functions.bash\"","class":"lineCov","hits":"3","order":"392","possible_hits":"0",},
...
{"lineNum":"  131","line":"  fi"},
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"  BATS_TEST_TIME=\'\'","class":"lineCov","hits":"5","order":"464","possible_hits":"0",},
{"lineNum":"  134","line":"  if [[ -n \"$BATS_ENABLE_TIMING\" ]]; then","class":"lineCov","hits":"5","order":"465","possible_hits":"0",},
{"lineNum":"  135","line":"    BATS_TEST_TIME=\" in \"$(($(get_mills_since_epoch) - BATS_TEST_START_TIME))\"ms\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  136","line":"  fi"},
{"lineNum":"  137","line":""},
{"lineNum":"  138","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"5","order":"466","possible_hits":"0",},
{"lineNum":"  139","line":""},
...
{"lineNum":"  184","line":"    printf \'ok %d %s%s\\n\' \"$BATS_SUITE_TEST_NUMBER\" \"${BATS_TEST_NAME_PREFIX:-}${BATS_TEST_DESCRIPTION}${BATS_TEST_TIME}\" \\","class":"lineCov","hits":"4","order":"579","possible_hits":"0",},
{"lineNum":"  185","line":"      \"$exit_metadata\" >&3"},
{"lineNum":"  186","line":"    status=0","class":"lineCov","hits":"4","order":"580","possible_hits":"0",},
{"lineNum":"  187","line":"    local state=passed","class":"lineCov","hits":"4","order":"581","possible_hits":"0",},
{"lineNum":"  188","line":"  fi"},
{"lineNum":"  189","line":""},
{"lineNum":"  190","line":"  if [[ -z \"$should_retry\" ]]; then","class":"lineCov","hits":"5","order":"544","possible_hits":"0",},
{"lineNum":"  191","line":"    printf \"%s %s\\t%s\\n\" \"$state\" \"$BATS_TEST_FILENAME\" \"$BATS_TEST_NAME\" >>\"$BATS_RUNLOG_FILE\"","class":"lineCov","hits":"5","order":"545","possible_hits":"0",},
{"lineNum":"  192","line":""},
{"lineNum":"  193","line":"    if [[ $print_bats_out ]]; then","class":"lineCov","hits":"5","order":"546","possible_hits":"0",},
{"lineNum":"  194","line":"      bats_prefix_lines_for_tap_output <\"$BATS_OUT\" | bats_replace_filename >&3","class":"lineCov","hits":"2","order":"547","possible_hits":"0",},
{"lineNum":"  195","line":"    fi"},
{"lineNum":"  196","line":"  fi"},
...
{"lineNum":"  289","line":"  local ms_since_epoch","class":"lineCov","hits":"6","order":"421","possible_hits":"0",},
{"lineNum":"  290","line":"  ms_since_epoch=$(date +%s%N)","class":"lineCov","hits":"12","order":"422","possible_hits":"0",},
{"lineNum":"  291","line":"  if [[ \"$ms_since_epoch\" == *N || \"${#ms_since_epoch}\" -lt 19 ]]; then","class":"lineCov","hits":"9","order":"423","possible_hits":"0",},
{"lineNum":"  292","line":"    ms_since_epoch=$(($(date +%s) * 1000))","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  293","line":"  else"},
{"lineNum":"  294","line":"    ms_since_epoch=$((ms_since_epoch / 1000000))","class":"lineCov","hits":"6","order":"424","possible_hits":"0",},
{"lineNum":"  295","line":"  fi"},
{"lineNum":"  296","line":""},
{"lineNum":"  297","line":"  printf \"%d\\n\" \"$ms_since_epoch\"","class":"lineCov","hits":"6","order":"425","possible_hits":"0",},
{"lineNum":"  298","line":"}"},
{"lineNum":"  299","line":""},
{"lineNum":"  300","line":"bats_perform_test() {"},
{"lineNum":"  301","line":"  if ! declare -F \"$BATS_TEST_NAME\" &>/dev/null; then","class":"lineCov","hits":"3","order":"410","possible_hits":"0",},
...
{"lineNum":"  309","line":"  if [[ -n \"${BATS_TEST_SKIPPED-}\" ]]; then","class":"lineCov","hits":"3","order":"411","possible_hits":"0",},
...
{"lineNum":"  315","line":"  fi"},
{"lineNum":"  316","line":""},
{"lineNum":"  317","line":"  local BATS_killer_pid=\'\'","class":"lineCov","hits":"3","order":"412","possible_hits":"0",},
{"lineNum":"  318","line":"  if [[ -n \"${BATS_TEST_TIMEOUT:-}\" ]]; then","class":"lineCov","hits":"3","order":"413","possible_hits":"0",},
...
{"lineNum":"  321","line":"  fi"},
{"lineNum":"  322","line":"  BATS_TEST_COMPLETED=","class":"lineCov","hits":"3","order":"414","possible_hits":"0",},
{"lineNum":"  323","line":"  BATS_TEST_SKIPPED=${BATS_TEST_SKIPPED-}","class":"lineCov","hits":"3","order":"415","possible_hits":"0",},
{"lineNum":"  324","line":"  BATS_TEARDOWN_COMPLETED=","class":"lineCov","hits":"3","order":"416","possible_hits":"0",},
{"lineNum":"  325","line":"  BATS_ERROR_STATUS=","class":"lineCov","hits":"3","order":"417","possible_hits":"0",},
{"lineNum":"  326","line":"  bats_setup_tracing","class":"lineCov","hits":"3","order":"418","possible_hits":"0",},
{"lineNum":"  327","line":"  # use parameter to mark this call as trap call"},
{"lineNum":"  328","line":"  # shellcheck disable=SC2064"},
{"lineNum":"  329","line":"  trap \"bats_teardown_trap as-exit-trap $BATS_killer_pid\" EXIT","class":"lineCov","hits":"6","order":"419","possible_hits":"0",},
{"lineNum":"  330","line":""},
...
{"lineNum":"  343","line":"source \"$BATS_ROOT/lib/bats-core/preprocessing.bash\"","class":"lineCov","hits":"3","order":"396","possible_hits":"0",},
{"lineNum":"  344","line":""},
{"lineNum":"  345","line":"exec 3<&1","class":"lineCov","hits":"3","order":"397","possible_hits":"0",},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"bats_create_test_tmpdirs","class":"lineCov","hits":"3","order":"398","possible_hits":"0",},
{"lineNum":"  348","line":"# Run the given test."},
{"lineNum":"  349","line":"bats_evaluate_preprocessed_source","class":"lineCov","hits":"3","order":"405","possible_hits":"0",},
{"lineNum":"  350","line":"readonly BATS_TEST_TAGS","class":"lineCov","hits":"3","order":"408","possible_hits":"0",},
{"lineNum":"  351","line":"bats_perform_test","class":"lineCov","hits":"3","order":"409","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2023-05-18 22:53:10", "instrumented" : 186, "covered" : 98,};
var merged_data = [];
