...
{"lineNum":"    2","line":"set -e","class":"lineCov","hits":"1","order":"96","possible_hits":"0",},
{"lineNum":"    3","line":""},
{"lineNum":"    4","line":"count_only_flag=\'\'","class":"lineCov","hits":"1","order":"97","possible_hits":"0",},
{"lineNum":"    5","line":"filter=\'\'","class":"lineCov","hits":"1","order":"98","possible_hits":"0",},
{"lineNum":"    6","line":"num_jobs=${BATS_NUMBER_OF_PARALLEL_JOBS:-1}","class":"lineCov","hits":"1","order":"99","possible_hits":"0",},
{"lineNum":"    7","line":"bats_no_parallelize_across_files=${BATS_NO_PARALLELIZE_ACROSS_FILES-}","class":"lineCov","hits":"1","order":"100","possible_hits":"0",},
{"lineNum":"    8","line":"bats_no_parallelize_within_files=","class":"lineCov","hits":"1","order":"101","possible_hits":"0",},
{"lineNum":"    9","line":"filter_status=\'\'","class":"lineCov","hits":"1","order":"102","possible_hits":"0",},
{"lineNum":"   10","line":"filter_tags_list=()"},
{"lineNum":"   11","line":"flags=(\'--dummy-flag\') # add a dummy flag to prevent unset variable errors on empty array expansion in old bash versions","class":"lineCov","hits":"1","order":"103","possible_hits":"0",},
{"lineNum":"   12","line":"setup_suite_file=\'\'","class":"lineCov","hits":"1","order":"104","possible_hits":"0",},
{"lineNum":"   13","line":"BATS_TRACE_LEVEL=\"${BATS_TRACE_LEVEL:-0}\"","class":"lineCov","hits":"1","order":"105","possible_hits":"0",},
{"lineNum":"   14","line":"BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS=","class":"lineCov","hits":"1","order":"106","possible_hits":"0",},
{"lineNum":"   15","line":""},
...
{"lineNum":"   22","line":"source \"$BATS_ROOT/lib/bats-core/common.bash\"","class":"lineCov","hits":"1","order":"107","possible_hits":"0",},
{"lineNum":"   23","line":""},
{"lineNum":"   24","line":"while [[ \"$#\" -ne 0 ]]; do","class":"lineCov","hits":"2","order":"108","possible_hits":"0",},
...
{"lineNum":"   40","line":"    ;;"},
{"lineNum":"   41","line":"  -x)"},
{"lineNum":"   42","line":"    flags+=(\'-x\')","class":"lineCov","hits":"2","order":"109","possible_hits":"0",},
{"lineNum":"   43","line":"    ;;"},
...
{"lineNum":"   91","line":"    ;;"},
{"lineNum":"   92","line":"  *)"},
{"lineNum":"   93","line":"    break","class":"lineCov","hits":"1","order":"111","possible_hits":"0",},
{"lineNum":"   94","line":"    ;;"},
{"lineNum":"   95","line":"  esac"},
{"lineNum":"   96","line":"  shift","class":"lineCov","hits":"1","order":"110","possible_hits":"0",},
{"lineNum":"   97","line":"done"},
{"lineNum":"   98","line":""},
{"lineNum":"   99","line":"if [[ \"$num_jobs\" != 1 ]]; then","class":"lineCov","hits":"1","order":"112","possible_hits":"0",},
...
{"lineNum":"  110","line":"TESTS_LIST_FILE=\"${BATS_RUN_TMPDIR}/test_list_file.txt\"","class":"lineCov","hits":"1","order":"113","possible_hits":"0",},
{"lineNum":"  111","line":""},
...
{"lineNum":"  122","line":"    while read -r line; do","class":"lineCov","hits":"67","order":"125","possible_hits":"0",},
{"lineNum":"  123","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"66","order":"142","possible_hits":"0",},
{"lineNum":"  124","line":"        continue","class":"lineCov","hits":"63","order":"143","possible_hits":"0",},
{"lineNum":"  125","line":"      fi"},
{"lineNum":"  126","line":"      line=\"${line%$\'\\r\'}\"","class":"lineCov","hits":"3","order":"176","possible_hits":"0",},
{"lineNum":"  127","line":"      line=\"${line#* }\"","class":"lineCov","hits":"3","order":"177","possible_hits":"0",},
{"lineNum":"  128","line":"      TAG_REGEX=\"--tags \'(.*)\' (.*)\"","class":"lineCov","hits":"3","order":"178","possible_hits":"0",},
{"lineNum":"  129","line":"      if [[ \"$line\" =~ $TAG_REGEX ]]; then","class":"lineCov","hits":"3","order":"179","possible_hits":"0",},
{"lineNum":"  130","line":"        IFS=, read -ra tags <<<\"${BASH_REMATCH[1]}\" || true","class":"lineCov","hits":"6","order":"180","possible_hits":"0",},
{"lineNum":"  131","line":"        line=\"${BASH_REMATCH[2]}\"","class":"lineCov","hits":"3","order":"181","possible_hits":"0",},
{"lineNum":"  132","line":"      else"},
{"lineNum":"  133","line":"        tags=()"},
{"lineNum":"  134","line":"      fi"},
{"lineNum":"  135","line":"      if [[ ${#filter_tags_list[@]} -gt 0 ]]; then","class":"lineCov","hits":"3","order":"182","possible_hits":"0",},
...
{"lineNum":"  163","line":"        fi"},
{"lineNum":"  164","line":"      fi"},
{"lineNum":"  165","line":"      test_line=$(printf \"%s\\t%s\" \"$filename\" \"$line\")","class":"lineCov","hits":"6","order":"184","possible_hits":"0",},
{"lineNum":"  166","line":"      all_tests+=(\"$test_line\")","class":"lineCov","hits":"3","order":"185","possible_hits":"0",},
{"lineNum":"  167","line":"      printf \"%s\\n\" \"$test_line\" >>\"$TESTS_LIST_FILE\"","class":"lineCov","hits":"3","order":"186","possible_hits":"0",},
{"lineNum":"  168","line":"      # avoid unbound variable errors on empty array expansion with old bash versions"},
{"lineNum":"  169","line":"      if [[ ${#test_names[@]} -gt 0 && \" ${test_names[*]} \" == *\" $line \"* ]]; then","class":"lineCov","hits":"5","order":"187","possible_hits":"0",},
...
{"lineNum":"  172","line":"      fi"},
{"lineNum":"  173","line":"      test_names+=(\"$line\")","class":"lineCov","hits":"3","order":"188","possible_hits":"0",},
...
{"lineNum":"  332","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"2","order":"506","possible_hits":"0",},
{"lineNum":"  333","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED}\" || -z \"${BATS_TEARDOWN_SUITE_COMPLETED}\" ]]; then","class":"lineCov","hits":"3","order":"507","possible_hits":"0",},
...
{"lineNum":"  345","line":"  fi"},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  if [[ -n \"$print_bats_out\" ]]; then","class":"lineCov","hits":"2","order":"508","possible_hits":"0",},
{"lineNum":"  348","line":"    bats_prefix_lines_for_tap_output < \"$BATS_OUT\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  349","line":"  fi"},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"  if [[ ${BATS_INTERRUPTED-NOTSET} != NOTSET ]]; then","class":"lineCov","hits":"2","order":"509","possible_hits":"0",},
{"lineNum":"  352","line":"    printf \"\\n# Received SIGINT, aborting ...\\n\\n\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  353","line":"  fi"},
{"lineNum":"  354","line":""},
{"lineNum":"  355","line":"  if [[ -d \"$BATS_RUN_LOGS_DIRECTORY\" && -n \"${BATS_INTERRUPTED:-}\" ]]; then","class":"lineCov","hits":"2","order":"510","possible_hits":"0",},
...
{"lineNum":"  358","line":"  fi"},
{"lineNum":"  359","line":"  exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"2","order":"511","possible_hits":"0",},
{"lineNum":"  360","line":"} >&3","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  361","line":""},
{"lineNum":"  362","line":"bats_run_teardown_suite() {"},
{"lineNum":"  363","line":"  local bats_teardown_suite_status=0","class":"lineCov","hits":"2","order":"498","possible_hits":"0",},
...
{"lineNum":"  366","line":"  trap bats_suite_exit_trap EXIT","class":"lineCov","hits":"2","order":"499","possible_hits":"0",},
{"lineNum":"  367","line":"  BATS_TEARDOWN_SUITE_COMPLETED=","class":"lineCov","hits":"2","order":"500","possible_hits":"0",},
{"lineNum":"  368","line":"  teardown_suite >>\"$BATS_OUT\" 2>&1 || bats_teardown_suite_status=$?","class":"lineCov","hits":"2","order":"501","possible_hits":"0",},
{"lineNum":"  369","line":"  if (( bats_teardown_suite_status == 0 )); then","class":"lineCov","hits":"2","order":"503","possible_hits":"0",},
{"lineNum":"  370","line":"    BATS_TEARDOWN_SUITE_COMPLETED=1","class":"lineCov","hits":"2","order":"504","possible_hits":"0",},
...
{"lineNum":"  384","line":"  :","class":"lineCov","hits":"2","order":"502","possible_hits":"0",},
{"lineNum":"  385","line":"}"},
{"lineNum":"  386","line":""},
...
{"lineNum":"  427","line":"    fi"},
{"lineNum":"  428","line":"    bats-exec-file \"${flags[@]}\" \"$filename\" \"${TESTS_LIST_FILE}\" || bats_exec_suite_status=1","class":"lineCov","hits":"2","order":"248","possible_hits":"0",},
{"lineNum":"  429","line":"  done"},
{"lineNum":"  430","line":"fi"},
{"lineNum":"  431","line":""},
{"lineNum":"  432","line":"set -eET","class":"lineCov","hits":"2","order":"496","possible_hits":"0",},
{"lineNum":"  433","line":"bats_run_teardown_suite","class":"lineCov","hits":"2","order":"497","possible_hits":"0",},
{"lineNum":"  434","line":""},
{"lineNum":"  435","line":"exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"2","order":"505","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2022-10-25 17:15:46", "instrumented" : 229, "covered" : 85,};
var merged_data = [];
