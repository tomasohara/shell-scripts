...
{"lineNum":"   87","line":"  bats_check_status_from_trap","class":"lineCov","hits":"21","order":"428","possible_hits":"0",},
{"lineNum":"   88","line":"  local bats_teardown_trap_status=0","class":"lineCov","hits":"21","order":"431","possible_hits":"0",},
{"lineNum":"   89","line":""},
...
{"lineNum":"   93","line":"  local killer_pid=${2:-}","class":"lineCov","hits":"21","order":"432","possible_hits":"0",},
{"lineNum":"   94","line":""},
...
{"lineNum":"   98","line":"  BATS_TEARDOWN_STARTED=${1:-1}","class":"lineCov","hits":"21","order":"433","possible_hits":"0",},
{"lineNum":"   99","line":"  teardown >>\"$BATS_OUT\" 2>&1 || bats_teardown_trap_status=\"$?\"","class":"lineCov","hits":"21","order":"434","possible_hits":"0",},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"  if [[ $bats_teardown_trap_status -eq 0 ]]; then","class":"lineCov","hits":"21","order":"436","possible_hits":"0",},
{"lineNum":"  102","line":"    BATS_TEARDOWN_COMPLETED=1","class":"lineCov","hits":"21","order":"437","possible_hits":"0",},
...
{"lineNum":"  106","line":"  fi"},
{"lineNum":"  107","line":""},
{"lineNum":"  108","line":"  bats_exit_trap \"$killer_pid\"","class":"lineCov","hits":"21","order":"438","possible_hits":"0",},
{"lineNum":"  109","line":"}"},
{"lineNum":"  110","line":""},
...
{"lineNum":"  115","line":"  local status","class":"lineCov","hits":"21","order":"439","possible_hits":"0",},
{"lineNum":"  116","line":"  local exit_metadata=\'\'","class":"lineCov","hits":"21","order":"440","possible_hits":"0",},
{"lineNum":"  117","line":"  local killer_pid=${1:-}","class":"lineCov","hits":"21","order":"441","possible_hits":"0",},
{"lineNum":"  118","line":"  trap - ERR EXIT","class":"lineCov","hits":"21","order":"442","possible_hits":"0",},
{"lineNum":"  119","line":"  if [[ -n \"${BATS_TEST_TIMEOUT:-}\" ]]; then","class":"lineCov","hits":"21","order":"443","possible_hits":"0",},
...
{"lineNum":"  122","line":"  fi"},
{"lineNum":"  123","line":""},
{"lineNum":"  124","line":"  if [[ -n \"$BATS_TEST_SKIPPED\" ]]; then","class":"lineCov","hits":"21","order":"444","possible_hits":"0",},
...
{"lineNum":"  128","line":"    fi"},
{"lineNum":"  129","line":"  elif [[ \"${BATS_TIMED_OUT-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"21","order":"445","possible_hits":"0",},
{"lineNum":"  130","line":"     exit_metadata=\" # timeout after ${BATS_TEST_TIMEOUT}s\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  131","line":"  fi"},
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"  BATS_TEST_TIME=\'\'","class":"lineCov","hits":"21","order":"446","possible_hits":"0",},
{"lineNum":"  134","line":"  if [[ -n \"$BATS_ENABLE_TIMING\" ]]; then","class":"lineCov","hits":"21","order":"447","possible_hits":"0",},
{"lineNum":"  135","line":"    BATS_TEST_TIME=\" in \"$(( $(get_mills_since_epoch) - BATS_TEST_START_TIME ))\"ms\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  136","line":"  fi"},
{"lineNum":"  137","line":""},
{"lineNum":"  138","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"21","order":"448","possible_hits":"0",},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  local should_retry=\'\'","class":"lineCov","hits":"21","order":"449","possible_hits":"0",},
{"lineNum":"  141","line":"  if [[ -z \"$BATS_TEST_COMPLETED\" || -z \"$BATS_TEARDOWN_COMPLETED\" || \"${BATS_INTERRUPTED-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"35","order":"450","possible_hits":"0",},
{"lineNum":"  142","line":"    if [[ \"$BATS_ERROR_STATUS\" -eq 0 ]]; then","class":"lineCov","hits":"7","order":"477","possible_hits":"0",},
...
{"lineNum":"  153","line":"    fi"},
{"lineNum":"  154","line":"    if bats_should_retry_test; then","class":"lineCov","hits":"7","order":"478","possible_hits":"0",},
...
{"lineNum":"  159","line":"      printf \'not ok %d %s%s\\n\' \"$BATS_SUITE_TEST_NUMBER\" \"${BATS_TEST_NAME_PREFIX:-}${BATS_TEST_DESCRIPTION}${BATS_TEST_TIME}\" \"$exit_metadata\" >&3","class":"lineCov","hits":"7","order":"479","possible_hits":"0",},
{"lineNum":"  160","line":"      local stack_trace","class":"lineCov","hits":"7","order":"480","possible_hits":"0",},
{"lineNum":"  161","line":"      bats_get_failure_stack_trace stack_trace","class":"lineCov","hits":"7","order":"481","possible_hits":"0",},
{"lineNum":"  162","line":"      bats_print_stack_trace \"${stack_trace[@]}\" >&3","class":"lineCov","hits":"7","order":"485","possible_hits":"0",},
{"lineNum":"  163","line":"      bats_print_failed_command \"${stack_trace[@]}\" >&3","class":"lineCov","hits":"7","order":"512","possible_hits":"0",},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"      if [[ $BATS_PRINT_OUTPUT_ON_FAILURE ]]; then","class":"lineCov","hits":"7","order":"539","possible_hits":"0",},
...
{"lineNum":"  173","line":""},
{"lineNum":"  174","line":"      print_bats_out=1","class":"lineCov","hits":"7","order":"540","possible_hits":"0",},
{"lineNum":"  175","line":"      status=1","class":"lineCov","hits":"7","order":"541","possible_hits":"0",},
{"lineNum":"  176","line":"      local state=failed","class":"lineCov","hits":"7","order":"542","possible_hits":"0",},
{"lineNum":"  177","line":"    fi"},
{"lineNum":"  178","line":"  else"},
{"lineNum":"  179","line":"    printf \'ok %d %s%s\\n\' \"$BATS_SUITE_TEST_NUMBER\" \"${BATS_TEST_NAME_PREFIX:-}${BATS_TEST_DESCRIPTION}${BATS_TEST_TIME}\" \\","class":"lineCov","hits":"14","order":"451","possible_hits":"0",},
{"lineNum":"  180","line":"      \"$exit_metadata\" >&3"},
{"lineNum":"  181","line":"    status=0","class":"lineCov","hits":"14","order":"454","possible_hits":"0",},
{"lineNum":"  182","line":"    local state=passed","class":"lineCov","hits":"14","order":"455","possible_hits":"0",},
{"lineNum":"  183","line":"  fi"},
{"lineNum":"  184","line":""},
{"lineNum":"  185","line":"  if [[ -z \"$should_retry\" ]]; then","class":"lineCov","hits":"21","order":"456","possible_hits":"0",},
{"lineNum":"  186","line":"    printf \"%s %s\\t%s\\n\" \"$state\" \"$BATS_TEST_FILENAME\" \"$BATS_TEST_NAME\" >> \"$BATS_RUNLOG_FILE\"","class":"lineCov","hits":"21","order":"457","possible_hits":"0",},
{"lineNum":"  187","line":""},
{"lineNum":"  188","line":"    if [[ $print_bats_out ]]; then","class":"lineCov","hits":"21","order":"458","possible_hits":"0",},
{"lineNum":"  189","line":"      bats_prefix_lines_for_tap_output < \"$BATS_OUT\" | bats_replace_filename >&3","class":"lineCov","hits":"14","order":"543","possible_hits":"0",},
{"lineNum":"  190","line":"    fi"},
{"lineNum":"  191","line":"  fi"},
{"lineNum":"  192","line":"  if [[ $BATS_GATHER_TEST_OUTPUTS_IN ]]; then","class":"lineCov","hits":"21","order":"459","possible_hits":"0",},
...
{"lineNum":"  198","line":"  fi"},
{"lineNum":"  199","line":"  rm -f \"$BATS_OUT\"","class":"lineCov","hits":"21","order":"460","possible_hits":"0",},
{"lineNum":"  200","line":"  exit \"$status\"","class":"lineCov","hits":"21","order":"461","possible_hits":"0",},
{"lineNum":"  201","line":"}"},
{"lineNum":"  202","line":""},
...
{"lineNum":"  318","line":""},
{"lineNum":"  319","line":"  BATS_TEST_COMPLETED=1","class":"lineCov","hits":"14","order":"425","possible_hits":"0",},
{"lineNum":"  320","line":"  # shellcheck disable=SC2064"},
{"lineNum":"  321","line":"  trap \"bats_exit_trap $BATS_killer_pid\" EXIT","class":"lineCov","hits":"14","order":"426","possible_hits":"0",},
{"lineNum":"  322","line":"  bats_teardown_trap \"\" \"$BATS_killer_pid\" # pass empty parameter to signify call outside trap","class":"lineCov","hits":"14","order":"427","possible_hits":"0",},
{"lineNum":"  323","line":"}"},
{"lineNum":"  324","line":""},
...
var header = { "command" : "bats", "date" : "2022-10-19 20:14:17", "instrumented" : 177, "covered" : 95,};
var merged_data = [];
