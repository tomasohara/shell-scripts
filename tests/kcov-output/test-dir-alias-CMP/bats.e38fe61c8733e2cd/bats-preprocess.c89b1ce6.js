...
{"lineNum":"    5","line":"  local name=\"$1\"","class":"lineCov","hits":"72","order":"145","possible_hits":"0",},
{"lineNum":"    6","line":"  local result=\'test_\'","class":"lineCov","hits":"72","order":"146","possible_hits":"0",},
{"lineNum":"    7","line":"  local hex_code","class":"lineCov","hits":"72","order":"147","possible_hits":"0",},
{"lineNum":"    8","line":""},
{"lineNum":"    9","line":"  if [[ ! \"$name\" =~ [^[:alnum:]\\ _-] ]]; then","class":"lineCov","hits":"72","order":"148","possible_hits":"0",},
{"lineNum":"   10","line":"    name=\"${name//_/-5f}\"","class":"lineCov","hits":"72","order":"149","possible_hits":"0",},
{"lineNum":"   11","line":"    name=\"${name//-/-2d}\"","class":"lineCov","hits":"72","order":"150","possible_hits":"0",},
{"lineNum":"   12","line":"    name=\"${name// /_}\"","class":"lineCov","hits":"72","order":"151","possible_hits":"0",},
{"lineNum":"   13","line":"    result+=\"$name\"","class":"lineCov","hits":"72","order":"152","possible_hits":"0",},
...
{"lineNum":"   29","line":"  fi"},
{"lineNum":"   30","line":""},
{"lineNum":"   31","line":"  printf -v \"$2\" \'%s\' \"$result\"","class":"lineCov","hits":"72","order":"153","possible_hits":"0",},
{"lineNum":"   32","line":"}"},
{"lineNum":"   33","line":""},
...
{"lineNum":"   78","line":"{"},
{"lineNum":"   79","line":"  while IFS= read -r line; do","class":"lineCov","hits":"2136","order":"135","possible_hits":"0",},
{"lineNum":"   80","line":"    (( ++line_number ))","class":"lineCov","hits":"1064","order":"136","possible_hits":"0",},
{"lineNum":"   81","line":"    line=\"${line//$\'\\r\'/}\"","class":"lineCov","hits":"1064","order":"137","possible_hits":"0",},
{"lineNum":"   82","line":"    if [[ \"$line\" =~ $BATS_TEST_PATTERN ]] || [[ \"$line\" =~ $BATS_TEST_PATTERN_COMMENT ]]; then","class":"lineCov","hits":"2056","order":"138","possible_hits":"0",},
{"lineNum":"   83","line":"      name=\"${BASH_REMATCH[1]#[\\\'\\\"]}\"","class":"lineCov","hits":"72","order":"141","possible_hits":"0",},
{"lineNum":"   84","line":"      name=\"${name%[\\\'\\\"]}\"","class":"lineCov","hits":"72","order":"142","possible_hits":"0",},
{"lineNum":"   85","line":"      body=\"${BASH_REMATCH[2]:-}\"","class":"lineCov","hits":"72","order":"143","possible_hits":"0",},
{"lineNum":"   86","line":"      bats_encode_test_name \"$name\" \'encoded_name\'","class":"lineCov","hits":"72","order":"144","possible_hits":"0",},
{"lineNum":"   87","line":"      printf \'%s() { bats_test_begin \"%s\"; %s\\n\' \"${encoded_name:?}\" \"$name\" \"$body\" || :","class":"lineCov","hits":"72","order":"154","possible_hits":"0",},
{"lineNum":"   88","line":""},
...
{"lineNum":"   92","line":"      if [[ -z \"$BATS_TEST_FILTER\" || \"$name\" =~ $BATS_TEST_FILTER ]]; then","class":"lineCov","hits":"72","order":"169","possible_hits":"0",},
{"lineNum":"   93","line":"        IFS=,","class":"lineCov","hits":"72","order":"170","possible_hits":"0",},
{"lineNum":"   94","line":"        tests+=(\"--tags \'${tags[*]-}\' $encoded_name\")","class":"lineCov","hits":"72","order":"171","possible_hits":"0",},
{"lineNum":"   95","line":"      fi"},
...
{"lineNum":"   99","line":"      if [[ \"$line\" =~ $BATS_COMMENT_COMMAND_PATTERN ]]; then","class":"lineCov","hits":"992","order":"139","possible_hits":"0",},
...
{"lineNum":"  109","line":"      fi"},
{"lineNum":"  110","line":"      printf \'%s\\n\' \"$line\"","class":"lineCov","hits":"992","order":"140","possible_hits":"0",},
{"lineNum":"  111","line":"    fi"},
...
var header = { "command" : "bats", "date" : "2022-09-26 10:25:12", "instrumented" : 71, "covered" : 35,};
var merged_data = [];
