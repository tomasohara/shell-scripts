...
{"lineNum":"    8","line":"  printf \"%s\\n\" \"$header\"","class":"lineCov","hits":"1","order":"155","possible_hits":"0",},
{"lineNum":"    9","line":""},
{"lineNum":"   10","line":"  # if we detect a TAP plan"},
{"lineNum":"   11","line":"  if [[ \"$header\" =~ $header_pattern ]]; then","class":"lineCov","hits":"1","order":"156","possible_hits":"0",},
{"lineNum":"   12","line":"    # extract the number of tests ..."},
{"lineNum":"   13","line":"    local expected_number_of_tests=\"${header:3}\"","class":"lineCov","hits":"1","order":"157","possible_hits":"0",},
{"lineNum":"   14","line":"    # ... count the actual number of [not ] oks..."},
{"lineNum":"   15","line":"    local actual_number_of_tests=0","class":"lineCov","hits":"1","order":"158","possible_hits":"0",},
{"lineNum":"   16","line":"    while IFS= read -r line; do","class":"lineCov","hits":"2","order":"159","possible_hits":"0",},
{"lineNum":"   17","line":"        # forward line"},
{"lineNum":"   18","line":"        printf \"%s\\n\" \"$line\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"   19","line":"        case \"$line\" in","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"   20","line":"        \'ok \'*)"},
...
{"lineNum":"   29","line":"    if [[ \"${actual_number_of_tests}\" != \"${expected_number_of_tests}\" ]]; then","class":"lineCov","hits":"1","order":"160","possible_hits":"0",},
...
var header = { "command" : "bats", "date" : "2022-09-21 22:03:03", "instrumented" : 14, "covered" : 9,};
var merged_data = [];
