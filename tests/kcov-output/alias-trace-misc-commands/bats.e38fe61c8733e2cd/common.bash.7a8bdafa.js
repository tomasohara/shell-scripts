...
{"lineNum":"    4","line":"  while IFS= read -r line; do","class":"lineCov","hits":"1382","order":"583","possible_hits":"0",},
{"lineNum":"    5","line":"    printf \'# %s\\n\' \"$line\" || break # avoid feedback loop when errors are redirected into BATS_OUT (see #353)","class":"lineCov","hits":"654","order":"584","possible_hits":"0",},
{"lineNum":"    6","line":"  done"},
{"lineNum":"    7","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"37","order":"585","possible_hits":"0",},
{"lineNum":"    8","line":"    printf \'# %s\\n\' \"$line\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"    9","line":"  fi"},
{"lineNum":"   10","line":"}"},
{"lineNum":"   11","line":""},
{"lineNum":"   12","line":"function bats_replace_filename() {"},
{"lineNum":"   13","line":"  local line","class":"lineCov","hits":"37","order":"586","possible_hits":"0",},
{"lineNum":"   14","line":"  while read -r line; do","class":"lineCov","hits":"691","order":"587","possible_hits":"0",},
{"lineNum":"   15","line":"    printf \"%s\\n\" \"${line//$BATS_TEST_SOURCE/$BATS_TEST_FILENAME}\"","class":"lineCov","hits":"654","order":"588","possible_hits":"0",},
...
{"lineNum":"  134","line":"  local -r haystack_array=$1","class":"lineCov","hits":"38","order":"190","possible_hits":"0",},
{"lineNum":"  135","line":"  shift","class":"lineCov","hits":"38","order":"191","possible_hits":"0",},
{"lineNum":"  136","line":""},
{"lineNum":"  137","line":"  local -i haystack_length # just to appease shellcheck","class":"lineCov","hits":"38","order":"192","possible_hits":"0",},
{"lineNum":"  138","line":"  eval \"local -r haystack_length=\\${#${haystack_array}[@]}\"","class":"lineCov","hits":"76","order":"193","possible_hits":"0",},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  local -i haystack_index=0         # initialize only here to continue from last search position","class":"lineCov","hits":"38","order":"194","possible_hits":"0",},
{"lineNum":"  141","line":"  local search_value haystack_value # just to appease shellcheck","class":"lineCov","hits":"38","order":"195","possible_hits":"0",},
{"lineNum":"  142","line":"  for ((i = 1; i <= $#; ++i)); do","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  143","line":"    eval \"local search_value=${!i}\"","class":"lineCov","hits":"76","order":"197","possible_hits":"0",},
{"lineNum":"  144","line":"    for (( ; haystack_index < haystack_length; ++haystack_index)); do","class":"lineCov","hits":"152","order":"196","possible_hits":"0",},
...
{"lineNum":"  153","line":"    return 1 # we ran of the end of the haystack without finding the value!","class":"lineCov","hits":"38","order":"198","possible_hits":"0",},
...
var header = { "command" : "bats", "date" : "2023-06-15 21:55:07", "instrumented" : 121, "covered" : 35,};
var merged_data = [];
