...
{"lineNum":"  122","line":"    while read -r line; do","class":"lineCov","hits":"298","order":"122","possible_hits":"0",},
{"lineNum":"  123","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"296","order":"148","possible_hits":"0",},
{"lineNum":"  124","line":"        continue","class":"lineCov","hits":"278","order":"149","possible_hits":"0",},
{"lineNum":"  125","line":"      fi"},
{"lineNum":"  126","line":"      line=\"${line%$\'\\r\'}\"","class":"lineCov","hits":"18","order":"176","possible_hits":"0",},
{"lineNum":"  127","line":"      line=\"${line#* }\"","class":"lineCov","hits":"18","order":"177","possible_hits":"0",},
{"lineNum":"  128","line":"      TAG_REGEX=\"--tags \'(.*)\' (.*)\"","class":"lineCov","hits":"18","order":"178","possible_hits":"0",},
{"lineNum":"  129","line":"      if [[ \"$line\" =~ $TAG_REGEX ]]; then","class":"lineCov","hits":"18","order":"179","possible_hits":"0",},
{"lineNum":"  130","line":"        IFS=, read -ra tags <<<\"${BASH_REMATCH[1]}\" || true","class":"lineCov","hits":"36","order":"181","possible_hits":"0",},
{"lineNum":"  131","line":"        line=\"${BASH_REMATCH[2]}\"","class":"lineCov","hits":"18","order":"182","possible_hits":"0",},
{"lineNum":"  132","line":"      else"},
{"lineNum":"  133","line":"        tags=()"},
{"lineNum":"  134","line":"      fi"},
{"lineNum":"  135","line":"      if [[ ${#filter_tags_list[@]} -gt 0 ]]; then","class":"lineCov","hits":"18","order":"183","possible_hits":"0",},
...
{"lineNum":"  163","line":"        fi"},
{"lineNum":"  164","line":"      fi"},
{"lineNum":"  165","line":"      test_line=$(printf \"%s\\t%s\" \"$filename\" \"$line\")","class":"lineCov","hits":"36","order":"184","possible_hits":"0",},
{"lineNum":"  166","line":"      all_tests+=(\"$test_line\")","class":"lineCov","hits":"18","order":"185","possible_hits":"0",},
{"lineNum":"  167","line":"      printf \"%s\\n\" \"$test_line\" >>\"$TESTS_LIST_FILE\"","class":"lineCov","hits":"18","order":"186","possible_hits":"0",},
{"lineNum":"  168","line":"      # avoid unbound variable errors on empty array expansion with old bash versions"},
{"lineNum":"  169","line":"      if [[ ${#test_names[@]} -gt 0 && \" ${test_names[*]} \" == *\" $line \"* ]]; then","class":"lineCov","hits":"34","order":"187","possible_hits":"0",},
...
{"lineNum":"  172","line":"      fi"},
{"lineNum":"  173","line":"      test_names+=(\"$line\")","class":"lineCov","hits":"18","order":"188","possible_hits":"0",},
...
{"lineNum":"  332","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"4","order":"601","possible_hits":"0",},
{"lineNum":"  333","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED}\" || -z \"${BATS_TEARDOWN_SUITE_COMPLETED}\" ]]; then","class":"lineCov","hits":"6","order":"602","possible_hits":"0",},
...
{"lineNum":"  345","line":"  fi"},
{"lineNum":"  346","line":""},
{"lineNum":"  347","line":"  if [[ -n \"$print_bats_out\" ]]; then","class":"lineCov","hits":"4","order":"603","possible_hits":"0",},
{"lineNum":"  348","line":"    bats_prefix_lines_for_tap_output < \"$BATS_OUT\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  349","line":"  fi"},
{"lineNum":"  350","line":""},
{"lineNum":"  351","line":"  if [[ ${BATS_INTERRUPTED-NOTSET} != NOTSET ]]; then","class":"lineCov","hits":"4","order":"604","possible_hits":"0",},
{"lineNum":"  352","line":"    printf \"\\n# Received SIGINT, aborting ...\\n\\n\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  353","line":"  fi"},
{"lineNum":"  354","line":""},
{"lineNum":"  355","line":"  if [[ -d \"$BATS_RUN_LOGS_DIRECTORY\" && -n \"${BATS_INTERRUPTED:-}\" ]]; then","class":"lineCov","hits":"4","order":"605","possible_hits":"0",},
...
{"lineNum":"  358","line":"  fi"},
{"lineNum":"  359","line":"  exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"4","order":"606","possible_hits":"0",},
{"lineNum":"  360","line":"} >&3","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  361","line":""},
{"lineNum":"  362","line":"bats_run_teardown_suite() {"},
{"lineNum":"  363","line":"  local bats_teardown_suite_status=0","class":"lineCov","hits":"4","order":"593","possible_hits":"0",},
...
{"lineNum":"  366","line":"  trap bats_suite_exit_trap EXIT","class":"lineCov","hits":"4","order":"594","possible_hits":"0",},
{"lineNum":"  367","line":"  BATS_TEARDOWN_SUITE_COMPLETED=","class":"lineCov","hits":"4","order":"595","possible_hits":"0",},
{"lineNum":"  368","line":"  teardown_suite >>\"$BATS_OUT\" 2>&1 || bats_teardown_suite_status=$?","class":"lineCov","hits":"4","order":"596","possible_hits":"0",},
{"lineNum":"  369","line":"  if (( bats_teardown_suite_status == 0 )); then","class":"lineCov","hits":"4","order":"598","possible_hits":"0",},
{"lineNum":"  370","line":"    BATS_TEARDOWN_SUITE_COMPLETED=1","class":"lineCov","hits":"4","order":"599","possible_hits":"0",},
...
{"lineNum":"  384","line":"  :","class":"lineCov","hits":"4","order":"597","possible_hits":"0",},
{"lineNum":"  385","line":"}"},
{"lineNum":"  386","line":""},
...
{"lineNum":"  430","line":"fi"},
{"lineNum":"  431","line":""},
{"lineNum":"  432","line":"set -eET","class":"lineCov","hits":"4","order":"591","possible_hits":"0",},
{"lineNum":"  433","line":"bats_run_teardown_suite","class":"lineCov","hits":"4","order":"592","possible_hits":"0",},
{"lineNum":"  434","line":""},
{"lineNum":"  435","line":"exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"4","order":"600","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2022-09-26 10:26:55", "instrumented" : 229, "covered" : 85,};
var merged_data = [];
