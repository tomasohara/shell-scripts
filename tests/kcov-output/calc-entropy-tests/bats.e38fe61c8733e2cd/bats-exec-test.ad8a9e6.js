...
{"lineNum":"    2","line":"set -eET","class":"lineCov","hits":"18","order":"359","possible_hits":"0",},
{"lineNum":"    3","line":""},
{"lineNum":"    4","line":"# Variables used in other scripts."},
{"lineNum":"    5","line":"BATS_ENABLE_TIMING=\'\'","class":"lineCov","hits":"18","order":"360","possible_hits":"0",},
{"lineNum":"    6","line":"BATS_EXTENDED_SYNTAX=\'\'","class":"lineCov","hits":"18","order":"361","possible_hits":"0",},
{"lineNum":"    7","line":"BATS_TRACE_LEVEL=\"${BATS_TRACE_LEVEL:-0}\"","class":"lineCov","hits":"18","order":"362","possible_hits":"0",},
{"lineNum":"    8","line":"BATS_PRINT_OUTPUT_ON_FAILURE=\"${BATS_PRINT_OUTPUT_ON_FAILURE:-}\"","class":"lineCov","hits":"18","order":"363","possible_hits":"0",},
{"lineNum":"    9","line":"BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS:-}\"","class":"lineCov","hits":"18","order":"364","possible_hits":"0",},
{"lineNum":"   10","line":"BATS_VERBOSE_RUN=\"${BATS_VERBOSE_RUN:-}\"","class":"lineCov","hits":"18","order":"365","possible_hits":"0",},
{"lineNum":"   11","line":"BATS_GATHER_TEST_OUTPUTS_IN=\"${BATS_GATHER_TEST_OUTPUTS_IN:-}\"","class":"lineCov","hits":"18","order":"366","possible_hits":"0",},
{"lineNum":"   12","line":"BATS_TEST_NAME_PREFIX=\"${BATS_TEST_NAME_PREFIX:-}\"","class":"lineCov","hits":"18","order":"367","possible_hits":"0",},
{"lineNum":"   13","line":""},
{"lineNum":"   14","line":"while [[ \"$#\" -ne 0 ]]; do","class":"lineCov","hits":"36","order":"368","possible_hits":"0",},
{"lineNum":"   15","line":"  case \"$1\" in","class":"lineCov","hits":"36","order":"369","possible_hits":"0",},
{"lineNum":"   16","line":"  -T)"},
...
{"lineNum":"   40","line":"    ;;"},
{"lineNum":"   41","line":"  *)"},
{"lineNum":"   42","line":"    break","class":"lineCov","hits":"18","order":"371","possible_hits":"0",},
{"lineNum":"   43","line":"    ;;"},
{"lineNum":"   44","line":"  esac"},
{"lineNum":"   45","line":"  shift","class":"lineCov","hits":"18","order":"370","possible_hits":"0",},
{"lineNum":"   46","line":"done"},
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"export BATS_TEST_FILENAME=\"$1\"","class":"lineCov","hits":"36","order":"372","possible_hits":"0",},
{"lineNum":"   49","line":"export BATS_TEST_NAME=\"$2\"","class":"lineCov","hits":"36","order":"373","possible_hits":"0",},
{"lineNum":"   50","line":"export BATS_SUITE_TEST_NUMBER=\"$3\"","class":"lineCov","hits":"36","order":"374","possible_hits":"0",},
{"lineNum":"   51","line":"export BATS_TEST_NUMBER=\"$4\"","class":"lineCov","hits":"36","order":"375","possible_hits":"0",},
{"lineNum":"   52","line":"BATS_TEST_TRY_NUMBER=\"$5\"","class":"lineCov","hits":"18","order":"376","possible_hits":"0",},
{"lineNum":"   53","line":""},
{"lineNum":"   54","line":"if [[ -z \"$BATS_TEST_FILENAME\" ]]; then","class":"lineCov","hits":"18","order":"377","possible_hits":"0",},
...
{"lineNum":"   57","line":"elif [[ ! -f \"$BATS_TEST_FILENAME\" ]]; then","class":"lineCov","hits":"18","order":"378","possible_hits":"0",},
...
{"lineNum":"   63","line":"  local tests_tmpdir=\"${BATS_RUN_TMPDIR}/test\"","class":"lineCov","hits":"18","order":"386","possible_hits":"0",},
{"lineNum":"   64","line":"  if ! mkdir -p \"$tests_tmpdir\"; then","class":"lineCov","hits":"18","order":"387","possible_hits":"0",},
...
{"lineNum":"   67","line":"  fi"},
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"  BATS_TEST_TMPDIR=\"$tests_tmpdir/$BATS_SUITE_TEST_NUMBER\"","class":"lineCov","hits":"18","order":"388","possible_hits":"0",},
{"lineNum":"   70","line":"  if ! mkdir \"$BATS_TEST_TMPDIR\"; then","class":"lineCov","hits":"18","order":"389","possible_hits":"0",},
...
{"lineNum":"   73","line":"  fi"},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":"  printf \"%s\\n\" \"$BATS_TEST_NAME\" > \"$BATS_TEST_TMPDIR.name\"","class":"lineCov","hits":"18","order":"390","possible_hits":"0",},
{"lineNum":"   76","line":""},
{"lineNum":"   77","line":"  export BATS_TEST_TMPDIR","class":"lineCov","hits":"18","order":"391","possible_hits":"0",},
{"lineNum":"   78","line":"}"},
{"lineNum":"   79","line":""},
...
{"lineNum":"   82","line":"source \"$BATS_ROOT/lib/bats-core/test_functions.bash\"","class":"lineCov","hits":"18","order":"379","possible_hits":"0",},
{"lineNum":"   83","line":"# shellcheck source=lib/bats-core/tracing.bash disable=SC2153"},
{"lineNum":"   84","line":"source \"$BATS_ROOT/lib/bats-core/tracing.bash\"","class":"lineCov","hits":"18","order":"380","possible_hits":"0",},
{"lineNum":"   85","line":""},
{"lineNum":"   86","line":"bats_teardown_trap() {"},
{"lineNum":"   87","line":"  bats_check_status_from_trap","class":"lineCov","hits":"26","order":"430","possible_hits":"0",},
{"lineNum":"   88","line":"  local bats_teardown_trap_status=0","class":"lineCov","hits":"26","order":"431","possible_hits":"0",},
{"lineNum":"   89","line":""},
...
{"lineNum":"   93","line":"  local killer_pid=${2:-}","class":"lineCov","hits":"26","order":"432","possible_hits":"0",},
{"lineNum":"   94","line":""},
...
{"lineNum":"   98","line":"  BATS_TEARDOWN_STARTED=${1:-1}","class":"lineCov","hits":"26","order":"433","possible_hits":"0",},
{"lineNum":"   99","line":"  teardown >>\"$BATS_OUT\" 2>&1 || bats_teardown_trap_status=\"$?\"","class":"lineCov","hits":"26","order":"434","possible_hits":"0",},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"  if [[ $bats_teardown_trap_status -eq 0 ]]; then","class":"lineCov","hits":"26","order":"436","possible_hits":"0",},
{"lineNum":"  102","line":"    BATS_TEARDOWN_COMPLETED=1","class":"lineCov","hits":"26","order":"437","possible_hits":"0",},
...
{"lineNum":"  106","line":"  fi"},
{"lineNum":"  107","line":""},
{"lineNum":"  108","line":"  bats_exit_trap \"$killer_pid\"","class":"lineCov","hits":"26","order":"438","possible_hits":"0",},
{"lineNum":"  109","line":"}"},
{"lineNum":"  110","line":""},
{"lineNum":"  111","line":"# shellcheck source=lib/bats-core/common.bash"},
{"lineNum":"  112","line":"source \"$BATS_ROOT/lib/bats-core/common.bash\"","class":"lineCov","hits":"18","order":"381","possible_hits":"0",},
{"lineNum":"  113","line":""},
{"lineNum":"  114","line":"bats_exit_trap() {"},
{"lineNum":"  115","line":"  local status","class":"lineCov","hits":"26","order":"439","possible_hits":"0",},
{"lineNum":"  116","line":"  local exit_metadata=\'\'","class":"lineCov","hits":"26","order":"440","possible_hits":"0",},
{"lineNum":"  117","line":"  local killer_pid=${1:-}","class":"lineCov","hits":"26","order":"441","possible_hits":"0",},
{"lineNum":"  118","line":"  trap - ERR EXIT","class":"lineCov","hits":"26","order":"442","possible_hits":"0",},
{"lineNum":"  119","line":"  if [[ -n \"${BATS_TEST_TIMEOUT:-}\" ]]; then","class":"lineCov","hits":"26","order":"443","possible_hits":"0",},
...
{"lineNum":"  122","line":"  fi"},
{"lineNum":"  123","line":""},
{"lineNum":"  124","line":"  if [[ -n \"$BATS_TEST_SKIPPED\" ]]; then","class":"lineCov","hits":"26","order":"444","possible_hits":"0",},
...
{"lineNum":"  128","line":"    fi"},
{"lineNum":"  129","line":"  elif [[ \"${BATS_TIMED_OUT-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"26","order":"445","possible_hits":"0",},
{"lineNum":"  130","line":"     exit_metadata=\" # timeout after ${BATS_TEST_TIMEOUT}s\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  131","line":"  fi"},
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"  BATS_TEST_TIME=\'\'","class":"lineCov","hits":"26","order":"446","possible_hits":"0",},
{"lineNum":"  134","line":"  if [[ -n \"$BATS_ENABLE_TIMING\" ]]; then","class":"lineCov","hits":"26","order":"447","possible_hits":"0",},
{"lineNum":"  135","line":"    BATS_TEST_TIME=\" in \"$(( $(get_mills_since_epoch) - BATS_TEST_START_TIME ))\"ms\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  136","line":"  fi"},
{"lineNum":"  137","line":""},
{"lineNum":"  138","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"26","order":"448","possible_hits":"0",},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  local should_retry=\'\'","class":"lineCov","hits":"26","order":"449","possible_hits":"0",},
{"lineNum":"  141","line":"  if [[ -z \"$BATS_TEST_COMPLETED\" || -z \"$BATS_TEARDOWN_COMPLETED\" || \"${BATS_INTERRUPTED-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"42","order":"450","possible_hits":"0",},
{"lineNum":"  142","line":"    if [[ \"$BATS_ERROR_STATUS\" -eq 0 ]]; then","class":"lineCov","hits":"10","order":"451","possible_hits":"0",},
...
{"lineNum":"  153","line":"    fi"},
{"lineNum":"  154","line":"    if bats_should_retry_test; then","class":"lineCov","hits":"10","order":"452","possible_hits":"0",},
...
{"lineNum":"  159","line":"      printf \'not ok %d %s%s\\n\' \"$BATS_SUITE_TEST_NUMBER\" \"${BATS_TEST_NAME_PREFIX:-}${BATS_TEST_DESCRIPTION}${BATS_TEST_TIME}\" \"$exit_metadata\" >&3","class":"lineCov","hits":"10","order":"453","possible_hits":"0",},
{"lineNum":"  160","line":"      local stack_trace","class":"lineCov","hits":"10","order":"454","possible_hits":"0",},
{"lineNum":"  161","line":"      bats_get_failure_stack_trace stack_trace","class":"lineCov","hits":"10","order":"455","possible_hits":"0",},
{"lineNum":"  162","line":"      bats_print_stack_trace \"${stack_trace[@]}\" >&3","class":"lineCov","hits":"10","order":"461","possible_hits":"0",},
{"lineNum":"  163","line":"      bats_print_failed_command \"${stack_trace[@]}\" >&3","class":"lineCov","hits":"10","order":"488","possible_hits":"0",},
{"lineNum":"  164","line":""},
{"lineNum":"  165","line":"      if [[ $BATS_PRINT_OUTPUT_ON_FAILURE ]]; then","class":"lineCov","hits":"10","order":"515","possible_hits":"0",},
...
{"lineNum":"  173","line":""},
{"lineNum":"  174","line":"      print_bats_out=1","class":"lineCov","hits":"10","order":"516","possible_hits":"0",},
{"lineNum":"  175","line":"      status=1","class":"lineCov","hits":"10","order":"517","possible_hits":"0",},
{"lineNum":"  176","line":"      local state=failed","class":"lineCov","hits":"10","order":"518","possible_hits":"0",},
{"lineNum":"  177","line":"    fi"},
{"lineNum":"  178","line":"  else"},
{"lineNum":"  179","line":"    printf \'ok %d %s%s\\n\' \"$BATS_SUITE_TEST_NUMBER\" \"${BATS_TEST_NAME_PREFIX:-}${BATS_TEST_DESCRIPTION}${BATS_TEST_TIME}\" \\","class":"lineCov","hits":"16","order":"546","possible_hits":"0",},
{"lineNum":"  180","line":"      \"$exit_metadata\" >&3"},
{"lineNum":"  181","line":"    status=0","class":"lineCov","hits":"16","order":"547","possible_hits":"0",},
{"lineNum":"  182","line":"    local state=passed","class":"lineCov","hits":"16","order":"548","possible_hits":"0",},
{"lineNum":"  183","line":"  fi"},
{"lineNum":"  184","line":""},
{"lineNum":"  185","line":"  if [[ -z \"$should_retry\" ]]; then","class":"lineCov","hits":"26","order":"519","possible_hits":"0",},
{"lineNum":"  186","line":"    printf \"%s %s\\t%s\\n\" \"$state\" \"$BATS_TEST_FILENAME\" \"$BATS_TEST_NAME\" >> \"$BATS_RUNLOG_FILE\"","class":"lineCov","hits":"26","order":"520","possible_hits":"0",},
{"lineNum":"  187","line":""},
{"lineNum":"  188","line":"    if [[ $print_bats_out ]]; then","class":"lineCov","hits":"26","order":"521","possible_hits":"0",},
{"lineNum":"  189","line":"      bats_prefix_lines_for_tap_output < \"$BATS_OUT\" | bats_replace_filename >&3","class":"lineCov","hits":"20","order":"522","possible_hits":"0",},
{"lineNum":"  190","line":"    fi"},
{"lineNum":"  191","line":"  fi"},
{"lineNum":"  192","line":"  if [[ $BATS_GATHER_TEST_OUTPUTS_IN ]]; then","class":"lineCov","hits":"26","order":"530","possible_hits":"0",},
...
{"lineNum":"  198","line":"  fi"},
{"lineNum":"  199","line":"  rm -f \"$BATS_OUT\"","class":"lineCov","hits":"26","order":"531","possible_hits":"0",},
{"lineNum":"  200","line":"  exit \"$status\"","class":"lineCov","hits":"26","order":"532","possible_hits":"0",},
{"lineNum":"  201","line":"}"},
{"lineNum":"  202","line":""},
...
{"lineNum":"  283","line":"  local ms_since_epoch","class":"lineCov","hits":"36","order":"406","possible_hits":"0",},
{"lineNum":"  284","line":"  ms_since_epoch=$(date +%s%N)","class":"lineCov","hits":"72","order":"407","possible_hits":"0",},
{"lineNum":"  285","line":"  if [[ \"$ms_since_epoch\" == *N || \"${#ms_since_epoch}\" -lt 19 ]]; then","class":"lineCov","hits":"54","order":"408","possible_hits":"0",},
{"lineNum":"  286","line":"        ms_since_epoch=$(( $(date +%s) * 1000 ))","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  287","line":"  else"},
{"lineNum":"  288","line":"        ms_since_epoch=$(( ms_since_epoch / 1000000 ))","class":"lineCov","hits":"36","order":"409","possible_hits":"0",},
{"lineNum":"  289","line":"  fi"},
{"lineNum":"  290","line":""},
{"lineNum":"  291","line":"  printf \"%d\\n\" \"$ms_since_epoch\"","class":"lineCov","hits":"36","order":"410","possible_hits":"0",},
{"lineNum":"  292","line":"}"},
{"lineNum":"  293","line":""},
{"lineNum":"  294","line":"bats_perform_test() {"},
{"lineNum":"  295","line":"  if ! declare -F \"$BATS_TEST_NAME\" &>/dev/null; then","class":"lineCov","hits":"18","order":"396","possible_hits":"0",},
...
{"lineNum":"  300","line":"  fi"},
{"lineNum":"  301","line":""},
{"lineNum":"  302","line":"  local BATS_killer_pid=\'\'","class":"lineCov","hits":"18","order":"397","possible_hits":"0",},
{"lineNum":"  303","line":"  if [[ -n \"${BATS_TEST_TIMEOUT:-}\" ]]; then","class":"lineCov","hits":"18","order":"398","possible_hits":"0",},
...
{"lineNum":"  306","line":"  fi"},
{"lineNum":"  307","line":"  BATS_TEST_COMPLETED=","class":"lineCov","hits":"18","order":"399","possible_hits":"0",},
{"lineNum":"  308","line":"  BATS_TEST_SKIPPED=","class":"lineCov","hits":"18","order":"400","possible_hits":"0",},
{"lineNum":"  309","line":"  BATS_TEARDOWN_COMPLETED=","class":"lineCov","hits":"18","order":"401","possible_hits":"0",},
{"lineNum":"  310","line":"  BATS_ERROR_STATUS=","class":"lineCov","hits":"18","order":"402","possible_hits":"0",},
{"lineNum":"  311","line":"  bats_setup_tracing","class":"lineCov","hits":"18","order":"403","possible_hits":"0",},
{"lineNum":"  312","line":"  # use parameter to mark this call as trap call"},
{"lineNum":"  313","line":"  # shellcheck disable=SC2064"},
{"lineNum":"  314","line":"  trap \"bats_teardown_trap as-exit-trap $BATS_killer_pid\" EXIT","class":"lineCov","hits":"36","order":"404","possible_hits":"0",},
{"lineNum":"  315","line":""},
{"lineNum":"  316","line":"  BATS_TEST_START_TIME=$(get_mills_since_epoch)","class":"lineCov","hits":"72","order":"405","possible_hits":"0",},
{"lineNum":"  317","line":"  \"$BATS_TEST_NAME\" >>\"$BATS_OUT\" 2>&1 4>&1","class":"lineCov","hits":"36","order":"411","possible_hits":"0",},
{"lineNum":"  318","line":""},
{"lineNum":"  319","line":"  BATS_TEST_COMPLETED=1","class":"lineCov","hits":"16","order":"543","possible_hits":"0",},
{"lineNum":"  320","line":"  # shellcheck disable=SC2064"},
{"lineNum":"  321","line":"  trap \"bats_exit_trap $BATS_killer_pid\" EXIT","class":"lineCov","hits":"16","order":"544","possible_hits":"0",},
{"lineNum":"  322","line":"  bats_teardown_trap \"\" \"$BATS_killer_pid\" # pass empty parameter to signify call outside trap","class":"lineCov","hits":"16","order":"545","possible_hits":"0",},
{"lineNum":"  323","line":"}"},
{"lineNum":"  324","line":""},
{"lineNum":"  325","line":"trap bats_interrupt_trap INT","class":"lineCov","hits":"18","order":"382","possible_hits":"0",},
{"lineNum":"  326","line":""},
{"lineNum":"  327","line":"# shellcheck source=lib/bats-core/preprocessing.bash"},
{"lineNum":"  328","line":"source \"$BATS_ROOT/lib/bats-core/preprocessing.bash\"","class":"lineCov","hits":"18","order":"383","possible_hits":"0",},
{"lineNum":"  329","line":""},
{"lineNum":"  330","line":"exec 3<&1","class":"lineCov","hits":"18","order":"384","possible_hits":"0",},
{"lineNum":"  331","line":""},
{"lineNum":"  332","line":"bats_create_test_tmpdirs","class":"lineCov","hits":"18","order":"385","possible_hits":"0",},
{"lineNum":"  333","line":"# Run the given test."},
{"lineNum":"  334","line":"bats_evaluate_preprocessed_source","class":"lineCov","hits":"18","order":"392","possible_hits":"0",},
{"lineNum":"  335","line":"bats_perform_test","class":"lineCov","hits":"18","order":"395","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2022-09-26 10:26:55", "instrumented" : 177, "covered" : 95,};
var merged_data = [];
