...
<<<<<<< HEAD
{"lineNum":"  121","line":"    while read -r line; do","class":"lineCov","hits":"449","order":"132","possible_hits":"0",},
{"lineNum":"  122","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"449","order":"148","possible_hits":"0",},
{"lineNum":"  123","line":"        continue","class":"lineCov","hits":"435","order":"149","possible_hits":"0",},
{"lineNum":"  124","line":"      fi"},
...
=======
{"lineNum":"  121","line":"    while read -r line; do","class":"lineCov","hits":"201","order":"129","possible_hits":"0",},
{"lineNum":"  122","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"200","order":"148","possible_hits":"0",},
{"lineNum":"  123","line":"        continue","class":"lineCov","hits":"189","order":"149","possible_hits":"0",},
{"lineNum":"  124","line":"      fi"},
{"lineNum":"  125","line":"      line=\"${line%$\'\\r\'}\"","class":"lineCov","hits":"11","order":"183","possible_hits":"0",},
{"lineNum":"  126","line":"      line=\"${line#* }\"","class":"lineCov","hits":"11","order":"184","possible_hits":"0",},
{"lineNum":"  127","line":"      TAG_REGEX=\"--tags \'(.*)\' (.*)\"","class":"lineCov","hits":"11","order":"185","possible_hits":"0",},
{"lineNum":"  128","line":"      if [[ \"$line\" =~ $TAG_REGEX ]]; then","class":"lineCov","hits":"11","order":"187","possible_hits":"0",},
{"lineNum":"  129","line":"        IFS=, read -ra tags <<<\"${BASH_REMATCH[1]}\" || true","class":"lineCov","hits":"22","order":"188","possible_hits":"0",},
{"lineNum":"  130","line":"        line=\"${BASH_REMATCH[2]}\"","class":"lineCov","hits":"11","order":"189","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
=======
{"lineNum":"  135","line":"      if bats_all_in tags \'bats:focus\'; then","class":"lineCov","hits":"11","order":"190","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
=======
{"lineNum":"  146","line":"      elif [[ $focus_mode == 1 ]]; then","class":"lineCov","hits":"11","order":"200","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
=======
{"lineNum":"  151","line":"      if [[ ${#filter_tags_list[@]} -gt 0 ]]; then","class":"lineCov","hits":"11","order":"201","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
=======
{"lineNum":"  181","line":"      test_line=$(printf \"%s\\t%s\" \"$filename\" \"$line\")","class":"lineCov","hits":"22","order":"202","possible_hits":"0",},
{"lineNum":"  182","line":"      all_tests+=(\"$test_line\")","class":"lineCov","hits":"11","order":"203","possible_hits":"0",},
{"lineNum":"  183","line":"      printf \"%s\\n\" \"$test_line\" >>\"$TESTS_LIST_FILE\"","class":"lineCov","hits":"11","order":"204","possible_hits":"0",},
{"lineNum":"  184","line":"      # avoid unbound variable errors on empty array expansion with old bash versions"},
{"lineNum":"  185","line":"      if [[ ${#test_names[@]} -gt 0 && \" ${test_names[*]} \" == *\" $line \"* ]]; then","class":"lineCov","hits":"21","order":"205","possible_hits":"0",},
{"lineNum":"  186","line":"        test_dupes+=(\"$line\")","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  187","line":"        continue","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  188","line":"      fi"},
{"lineNum":"  189","line":"      test_names+=(\"$line\")","class":"lineCov","hits":"11","order":"206","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
{"lineNum":"  199","line":""},
<<<<<<< HEAD
{"lineNum":"  200","line":"TEST_ROOT=${1-}","class":"lineCov","hits":"1","order":"119","possible_hits":"0",},
{"lineNum":"  201","line":"TEST_ROOT=${TEST_ROOT%/*}","class":"lineCov","hits":"1","order":"120","possible_hits":"0",},
{"lineNum":"  202","line":"BATS_RUN_LOGS_DIRECTORY=\"$TEST_ROOT/.bats/run-logs\"","class":"lineCov","hits":"1","order":"122","possible_hits":"0",},
...
<<<<<<< HEAD
{"lineNum":"  355","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"2","order":"741","possible_hits":"0",},
{"lineNum":"  356","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED}\" || -z \"${BATS_TEARDOWN_SUITE_COMPLETED}\" ]]; then","class":"lineCov","hits":"3","order":"742","possible_hits":"0",},
=======
{"lineNum":"  355","line":"  local print_bats_out=\"${BATS_SHOW_OUTPUT_OF_SUCCEEDING_TESTS}\"","class":"lineCov","hits":"2","order":"663","possible_hits":"0",},
{"lineNum":"  356","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED}\" || -z \"${BATS_TEARDOWN_SUITE_COMPLETED}\" ]]; then","class":"lineCov","hits":"3","order":"664","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
{"lineNum":"  369","line":""},
<<<<<<< HEAD
{"lineNum":"  370","line":"  if [[ -n \"$print_bats_out\" ]]; then","class":"lineCov","hits":"2","order":"743","possible_hits":"0",},
{"lineNum":"  371","line":"    bats_prefix_lines_for_tap_output <\"$BATS_OUT\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  372","line":"  fi"},
{"lineNum":"  373","line":""},
{"lineNum":"  374","line":"  if [[ ${BATS_INTERRUPTED-NOTSET} != NOTSET ]]; then","class":"lineCov","hits":"2","order":"744","possible_hits":"0",},
{"lineNum":"  375","line":"    printf \"\\n# Received SIGINT, aborting ...\\n\\n\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  376","line":"  fi"},
{"lineNum":"  377","line":""},
{"lineNum":"  378","line":"  if [[ -d \"$BATS_RUN_LOGS_DIRECTORY\" && -n \"${BATS_INTERRUPTED:-}\" ]]; then","class":"lineCov","hits":"2","order":"745","possible_hits":"0",},
...
{"lineNum":"  381","line":"  fi"},
{"lineNum":"  382","line":"  exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"2","order":"746","possible_hits":"0",},
{"lineNum":"  383","line":"} >&3","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  384","line":""},
{"lineNum":"  385","line":"bats_run_teardown_suite() {"},
{"lineNum":"  386","line":"  local bats_teardown_suite_status=0","class":"lineCov","hits":"2","order":"732","possible_hits":"0",},
...
{"lineNum":"  389","line":"  trap bats_suite_exit_trap EXIT","class":"lineCov","hits":"2","order":"733","possible_hits":"0",},
{"lineNum":"  390","line":"  BATS_TEARDOWN_SUITE_COMPLETED=","class":"lineCov","hits":"2","order":"734","possible_hits":"0",},
{"lineNum":"  391","line":"  teardown_suite >>\"$BATS_OUT\" 2>&1 || bats_teardown_suite_status=$?","class":"lineCov","hits":"2","order":"735","possible_hits":"0",},
{"lineNum":"  392","line":"  if ((bats_teardown_suite_status == 0)); then","class":"lineCov","hits":"2","order":"737","possible_hits":"0",},
{"lineNum":"  393","line":"    BATS_TEARDOWN_SUITE_COMPLETED=1","class":"lineCov","hits":"2","order":"738","possible_hits":"0",},
=======
{"lineNum":"  370","line":"  if [[ -n \"$print_bats_out\" ]]; then","class":"lineCov","hits":"2","order":"665","possible_hits":"0",},
{"lineNum":"  371","line":"    bats_prefix_lines_for_tap_output <\"$BATS_OUT\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  372","line":"  fi"},
{"lineNum":"  373","line":""},
{"lineNum":"  374","line":"  if [[ ${BATS_INTERRUPTED-NOTSET} != NOTSET ]]; then","class":"lineCov","hits":"2","order":"666","possible_hits":"0",},
{"lineNum":"  375","line":"    printf \"\\n# Received SIGINT, aborting ...\\n\\n\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  376","line":"  fi"},
{"lineNum":"  377","line":""},
{"lineNum":"  378","line":"  if [[ -d \"$BATS_RUN_LOGS_DIRECTORY\" && -n \"${BATS_INTERRUPTED:-}\" ]]; then","class":"lineCov","hits":"2","order":"667","possible_hits":"0",},
{"lineNum":"  379","line":"    # aborting a test run with CTRL+C does not save the runlog file"},
{"lineNum":"  380","line":"    [[ \"$BATS_RUNLOG_FILE\" != /dev/null ]] && rm \"$BATS_RUNLOG_FILE\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  381","line":"  fi"},
{"lineNum":"  382","line":"  exit \"$bats_exec_suite_status\"","class":"lineCov","hits":"2","order":"668","possible_hits":"0",},
{"lineNum":"  383","line":"} >&3","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  384","line":""},
{"lineNum":"  385","line":"bats_run_teardown_suite() {"},
{"lineNum":"  386","line":"  local bats_teardown_suite_status=0","class":"lineCov","hits":"2","order":"654","possible_hits":"0",},
{"lineNum":"  387","line":"  # avoid being called twice, in case this is not called through bats_teardown_suite_trap"},
{"lineNum":"  388","line":"  # but from the end of file"},
{"lineNum":"  389","line":"  trap bats_suite_exit_trap EXIT","class":"lineCov","hits":"2","order":"655","possible_hits":"0",},
{"lineNum":"  390","line":"  BATS_TEARDOWN_SUITE_COMPLETED=","class":"lineCov","hits":"2","order":"656","possible_hits":"0",},
{"lineNum":"  391","line":"  teardown_suite >>\"$BATS_OUT\" 2>&1 || bats_teardown_suite_status=$?","class":"lineCov","hits":"2","order":"657","possible_hits":"0",},
{"lineNum":"  392","line":"  if ((bats_teardown_suite_status == 0)); then","class":"lineCov","hits":"2","order":"659","possible_hits":"0",},
{"lineNum":"  393","line":"    BATS_TEARDOWN_SUITE_COMPLETED=1","class":"lineCov","hits":"2","order":"660","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
<<<<<<< HEAD
{"lineNum":"  408","line":"  :","class":"lineCov","hits":"2","order":"736","possible_hits":"0",},
=======
{"lineNum":"  408","line":"  :","class":"lineCov","hits":"2","order":"658","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"  409","line":"}"},
{"lineNum":"  410","line":""},
...
{"lineNum":"  454","line":""},
<<<<<<< HEAD
{"lineNum":"  455","line":"set -eET","class":"lineCov","hits":"2","order":"730","possible_hits":"0",},
{"lineNum":"  456","line":"bats_run_teardown_suite","class":"lineCov","hits":"2","order":"731","possible_hits":"0",},
{"lineNum":"  457","line":""},
{"lineNum":"  458","line":"if [[ \"$focus_mode\" == 1 && $bats_exec_suite_status -eq 0 ]]; then","class":"lineCov","hits":"2","order":"739","possible_hits":"0",},
=======
{"lineNum":"  455","line":"set -eET","class":"lineCov","hits":"2","order":"652","possible_hits":"0",},
{"lineNum":"  456","line":"bats_run_teardown_suite","class":"lineCov","hits":"2","order":"653","possible_hits":"0",},
{"lineNum":"  457","line":""},
{"lineNum":"  458","line":"if [[ \"$focus_mode\" == 1 && $bats_exec_suite_status -eq 0 ]]; then","class":"lineCov","hits":"2","order":"661","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
{"lineNum":"  466","line":""},
<<<<<<< HEAD
{"lineNum":"  467","line":"exit \"$bats_exec_suite_status\" # the actual exit code will be set by the exit trap using bats_exec_suite_status","class":"lineCov","hits":"2","order":"740","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2023-05-19 18:20:25", "instrumented" : 245, "covered" : 90,};
=======
{"lineNum":"  467","line":"exit \"$bats_exec_suite_status\" # the actual exit code will be set by the exit trap using bats_exec_suite_status","class":"lineCov","hits":"2","order":"662","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2023-05-06 21:39:03", "instrumented" : 245, "covered" : 90,};
>>>>>>> integration-testing-3fa2c13
var merged_data = [];
