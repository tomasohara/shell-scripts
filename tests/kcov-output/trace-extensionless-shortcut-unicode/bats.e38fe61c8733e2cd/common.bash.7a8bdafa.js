...
<<<<<<< HEAD
{"lineNum":"    4","line":"  while IFS= read -r line; do","class":"lineCov","hits":"528","order":"557","possible_hits":"0",},
{"lineNum":"    5","line":"    printf \'# %s\\n\' \"$line\" || break # avoid feedback loop when errors are redirected into BATS_OUT (see #353)","class":"lineCov","hits":"254","order":"559","possible_hits":"0",},
{"lineNum":"    6","line":"  done"},
{"lineNum":"    7","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"10","order":"562","possible_hits":"0",},
=======
{"lineNum":"    4","line":"  while IFS= read -r line; do","class":"lineCov","hits":"38","order":"561","possible_hits":"0",},
{"lineNum":"    5","line":"    printf \'# %s\\n\' \"$line\" || break # avoid feedback loop when errors are redirected into BATS_OUT (see #353)","class":"lineCov","hits":"13","order":"562","possible_hits":"0",},
{"lineNum":"    6","line":"  done"},
{"lineNum":"    7","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"6","order":"563","possible_hits":"0",},
...
<<<<<<< HEAD
{"lineNum":"   13","line":"  local line","class":"lineCov","hits":"10","order":"558","possible_hits":"0",},
{"lineNum":"   14","line":"  while read -r line; do","class":"lineCov","hits":"264","order":"560","possible_hits":"0",},
{"lineNum":"   15","line":"    printf \"%s\\n\" \"${line//$BATS_TEST_SOURCE/$BATS_TEST_FILENAME}\"","class":"lineCov","hits":"254","order":"561","possible_hits":"0",},
{"lineNum":"   16","line":"  done"},
{"lineNum":"   17","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"10","order":"563","possible_hits":"0",},
=======
{"lineNum":"   13","line":"  local line","class":"lineCov","hits":"6","order":"564","possible_hits":"0",},
{"lineNum":"   14","line":"  while read -r line; do","class":"lineCov","hits":"19","order":"565","possible_hits":"0",},
{"lineNum":"   15","line":"    printf \"%s\\n\" \"${line//$BATS_TEST_SOURCE/$BATS_TEST_FILENAME}\"","class":"lineCov","hits":"13","order":"566","possible_hits":"0",},
{"lineNum":"   16","line":"  done"},
{"lineNum":"   17","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"6","order":"567","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
<<<<<<< HEAD
{"lineNum":"   23","line":"  printf -v \"$1\" -- \"%s%s%s\" \"$BATS_BEGIN_CODE_QUOTE\" \"$2\" \"$BATS_END_CODE_QUOTE\"","class":"lineCov","hits":"13","order":"544","possible_hits":"0",},
=======
{"lineNum":"   23","line":"  printf -v \"$1\" -- \"%s%s%s\" \"$BATS_BEGIN_CODE_QUOTE\" \"$2\" \"$BATS_END_CODE_QUOTE\"","class":"lineCov","hits":"6","order":"551","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"   24","line":"}"},
{"lineNum":"   25","line":""},
...
<<<<<<< HEAD
{"lineNum":"  103","line":"  local -r result_name=$1","class":"lineCov","hits":"24","order":"173","possible_hits":"0",},
{"lineNum":"  104","line":"  shift","class":"lineCov","hits":"24","order":"174","possible_hits":"0",},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"  if (($# == 0)); then","class":"lineCov","hits":"24","order":"175","possible_hits":"0",},
{"lineNum":"  107","line":"    eval \"$result_name=()\"","class":"lineCov","hits":"48","order":"176","possible_hits":"0",},
{"lineNum":"  108","line":"    return 0","class":"lineCov","hits":"24","order":"177","possible_hits":"0",},
=======
{"lineNum":"  103","line":"  local -r result_name=$1","class":"lineCov","hits":"22","order":"173","possible_hits":"0",},
{"lineNum":"  104","line":"  shift","class":"lineCov","hits":"22","order":"174","possible_hits":"0",},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"  if (($# == 0)); then","class":"lineCov","hits":"22","order":"175","possible_hits":"0",},
{"lineNum":"  107","line":"    eval \"$result_name=()\"","class":"lineCov","hits":"44","order":"176","possible_hits":"0",},
{"lineNum":"  108","line":"    return 0","class":"lineCov","hits":"22","order":"177","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"  109","line":"  fi"},
{"lineNum":"  110","line":""},
...
<<<<<<< HEAD
{"lineNum":"  134","line":"  local -r haystack_array=$1","class":"lineCov","hits":"12","order":"191","possible_hits":"0",},
{"lineNum":"  135","line":"  shift","class":"lineCov","hits":"12","order":"192","possible_hits":"0",},
{"lineNum":"  136","line":""},
{"lineNum":"  137","line":"  local -i haystack_length # just to appease shellcheck","class":"lineCov","hits":"12","order":"193","possible_hits":"0",},
{"lineNum":"  138","line":"  eval \"local -r haystack_length=\\${#${haystack_array}[@]}\"","class":"lineCov","hits":"24","order":"194","possible_hits":"0",},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  local -i haystack_index=0         # initialize only here to continue from last search position","class":"lineCov","hits":"12","order":"195","possible_hits":"0",},
{"lineNum":"  141","line":"  local search_value haystack_value # just to appease shellcheck","class":"lineCov","hits":"12","order":"196","possible_hits":"0",},
{"lineNum":"  142","line":"  for ((i = 1; i <= $#; ++i)); do","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  143","line":"    eval \"local search_value=${!i}\"","class":"lineCov","hits":"24","order":"198","possible_hits":"0",},
{"lineNum":"  144","line":"    for (( ; haystack_index < haystack_length; ++haystack_index)); do","class":"lineCov","hits":"48","order":"197","possible_hits":"0",},
=======
{"lineNum":"  134","line":"  local -r haystack_array=$1","class":"lineCov","hits":"11","order":"191","possible_hits":"0",},
{"lineNum":"  135","line":"  shift","class":"lineCov","hits":"11","order":"192","possible_hits":"0",},
{"lineNum":"  136","line":""},
{"lineNum":"  137","line":"  local -i haystack_length # just to appease shellcheck","class":"lineCov","hits":"11","order":"193","possible_hits":"0",},
{"lineNum":"  138","line":"  eval \"local -r haystack_length=\\${#${haystack_array}[@]}\"","class":"lineCov","hits":"22","order":"194","possible_hits":"0",},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"  local -i haystack_index=0         # initialize only here to continue from last search position","class":"lineCov","hits":"11","order":"195","possible_hits":"0",},
{"lineNum":"  141","line":"  local search_value haystack_value # just to appease shellcheck","class":"lineCov","hits":"11","order":"196","possible_hits":"0",},
{"lineNum":"  142","line":"  for ((i = 1; i <= $#; ++i)); do","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  143","line":"    eval \"local search_value=${!i}\"","class":"lineCov","hits":"22","order":"198","possible_hits":"0",},
{"lineNum":"  144","line":"    for (( ; haystack_index < haystack_length; ++haystack_index)); do","class":"lineCov","hits":"44","order":"197","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
<<<<<<< HEAD
{"lineNum":"  153","line":"    return 1 # we ran of the end of the haystack without finding the value!","class":"lineCov","hits":"12","order":"199","possible_hits":"0",},
=======
{"lineNum":"  153","line":"    return 1 # we ran of the end of the haystack without finding the value!","class":"lineCov","hits":"11","order":"199","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
<<<<<<< HEAD
{"lineNum":"  196","line":"  local -a trailing_args=()","class":"lineCov","hits":"48","order":"164","possible_hits":"0",},
{"lineNum":"  197","line":"  while (($# > 0)) && [[ $1 != -- ]]; do","class":"lineCov","hits":"144","order":"165","possible_hits":"0",},
{"lineNum":"  198","line":"    local array=$1","class":"lineCov","hits":"48","order":"166","possible_hits":"0",},
{"lineNum":"  199","line":"    shift","class":"lineCov","hits":"48","order":"167","possible_hits":"0",},
{"lineNum":"  200","line":""},
{"lineNum":"  201","line":"    if eval \"(( \\${#${array}[@]} > 0 ))\"; then","class":"lineCov","hits":"96","order":"168","possible_hits":"0",},
{"lineNum":"  202","line":"      eval \"trailing_args+=(\\\"\\${${array}[@]}\\\")\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  203","line":"    fi"},
{"lineNum":"  204","line":"  done"},
{"lineNum":"  205","line":"  shift # remove -- separator","class":"lineCov","hits":"24","order":"169","possible_hits":"0",},
{"lineNum":"  206","line":""},
{"lineNum":"  207","line":"  if (($# == 0)); then","class":"lineCov","hits":"24","order":"170","possible_hits":"0",},
=======
{"lineNum":"  196","line":"  local -a trailing_args=()","class":"lineCov","hits":"44","order":"164","possible_hits":"0",},
{"lineNum":"  197","line":"  while (($# > 0)) && [[ $1 != -- ]]; do","class":"lineCov","hits":"132","order":"165","possible_hits":"0",},
{"lineNum":"  198","line":"    local array=$1","class":"lineCov","hits":"44","order":"166","possible_hits":"0",},
{"lineNum":"  199","line":"    shift","class":"lineCov","hits":"44","order":"167","possible_hits":"0",},
{"lineNum":"  200","line":""},
{"lineNum":"  201","line":"    if eval \"(( \\${#${array}[@]} > 0 ))\"; then","class":"lineCov","hits":"88","order":"168","possible_hits":"0",},
{"lineNum":"  202","line":"      eval \"trailing_args+=(\\\"\\${${array}[@]}\\\")\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  203","line":"    fi"},
{"lineNum":"  204","line":"  done"},
{"lineNum":"  205","line":"  shift # remove -- separator","class":"lineCov","hits":"22","order":"169","possible_hits":"0",},
{"lineNum":"  206","line":""},
{"lineNum":"  207","line":"  if (($# == 0)); then","class":"lineCov","hits":"22","order":"170","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
{"lineNum":"  211","line":""},
<<<<<<< HEAD
{"lineNum":"  212","line":"  if ((${#trailing_args[@]} > 0)); then","class":"lineCov","hits":"24","order":"171","possible_hits":"0",},
{"lineNum":"  213","line":"    \"$@\" \"${trailing_args[@]}\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  214","line":"  else"},
{"lineNum":"  215","line":"    \"$@\"","class":"lineCov","hits":"24","order":"172","possible_hits":"0",},
=======
{"lineNum":"  212","line":"  if ((${#trailing_args[@]} > 0)); then","class":"lineCov","hits":"22","order":"171","possible_hits":"0",},
{"lineNum":"  213","line":"    \"$@\" \"${trailing_args[@]}\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  214","line":"  else"},
{"lineNum":"  215","line":"    \"$@\"","class":"lineCov","hits":"22","order":"172","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"  216","line":"  fi"},
{"lineNum":"  217","line":"}"},
{"lineNum":"  218","line":""},
...
<<<<<<< HEAD
{"lineNum":"  221","line":"  local output=\"${1?}\"","class":"lineCov","hits":"13","order":"516","possible_hits":"0",},
{"lineNum":"  222","line":"  shift","class":"lineCov","hits":"13","order":"517","possible_hits":"0",},
{"lineNum":"  223","line":"  \"bats_format_file_line_reference_${BATS_LINE_REFERENCE_FORMAT?}\" \"$@\"","class":"lineCov","hits":"13","order":"518","possible_hits":"0",},
{"lineNum":"  224","line":"}"},
{"lineNum":"  225","line":""},
{"lineNum":"  226","line":"bats_format_file_line_reference_comma_line() {"},
{"lineNum":"  227","line":"  printf -v \"$output\" \"%s, line %d\" \"$@\"","class":"lineCov","hits":"13","order":"519","possible_hits":"0",},
=======
{"lineNum":"  221","line":"  local output=\"${1?}\"","class":"lineCov","hits":"6","order":"523","possible_hits":"0",},
{"lineNum":"  222","line":"  shift","class":"lineCov","hits":"6","order":"524","possible_hits":"0",},
{"lineNum":"  223","line":"  \"bats_format_file_line_reference_${BATS_LINE_REFERENCE_FORMAT?}\" \"$@\"","class":"lineCov","hits":"6","order":"525","possible_hits":"0",},
{"lineNum":"  224","line":"}"},
{"lineNum":"  225","line":""},
{"lineNum":"  226","line":"bats_format_file_line_reference_comma_line() {"},
{"lineNum":"  227","line":"  printf -v \"$output\" \"%s, line %d\" \"$@\"","class":"lineCov","hits":"6","order":"526","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"  228","line":"}"},
{"lineNum":"  229","line":""},
...
<<<<<<< HEAD
var header = { "command" : "bats", "date" : "2023-05-19 18:20:25", "instrumented" : 121, "covered" : 35,};
=======
var header = { "command" : "bats", "date" : "2023-05-06 21:39:03", "instrumented" : 121, "covered" : 35,};
>>>>>>> integration-testing-3fa2c13
var merged_data = [];
