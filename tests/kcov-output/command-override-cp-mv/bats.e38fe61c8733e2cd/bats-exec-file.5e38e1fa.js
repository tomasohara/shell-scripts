...
{"lineNum":"  105","line":"  local bats_teardown_file_status=0","class":"lineCov","hits":"2","order":"735","possible_hits":"0",},
{"lineNum":"  106","line":"  # avoid running the therdown trap due to errors in teardown_file"},
{"lineNum":"  107","line":"  trap \'bats_file_exit_trap\' EXIT","class":"lineCov","hits":"2","order":"736","possible_hits":"0",},
{"lineNum":"  108","line":""},
{"lineNum":"  109","line":"  # rely on bats_error_trap to catch failures"},
{"lineNum":"  110","line":"  teardown_file >>\"$BATS_OUT\" 2>&1 || bats_teardown_file_status=$?","class":"lineCov","hits":"2","order":"737","possible_hits":"0",},
{"lineNum":"  111","line":""},
{"lineNum":"  112","line":"  if (( bats_teardown_file_status == 0 )); then","class":"lineCov","hits":"2","order":"739","possible_hits":"0",},
{"lineNum":"  113","line":"    BATS_TEARDOWN_FILE_COMPLETED=1","class":"lineCov","hits":"2","order":"740","possible_hits":"0",},
...
{"lineNum":"  130","line":"  local -r last_return_code=$?","class":"lineCov","hits":"2","order":"742","possible_hits":"0",},
{"lineNum":"  131","line":"  if [[ ${1:-} != in-teardown_trap ]]; then","class":"lineCov","hits":"2","order":"743","possible_hits":"0",},
{"lineNum":"  132","line":"    BATS_ERROR_STATUS=$last_return_code","class":"lineCov","hits":"2","order":"744","possible_hits":"0",},
{"lineNum":"  133","line":"  fi"},
{"lineNum":"  134","line":"  trap - ERR EXIT","class":"lineCov","hits":"2","order":"745","possible_hits":"0",},
{"lineNum":"  135","line":"  local failure_reason","class":"lineCov","hits":"2","order":"746","possible_hits":"0",},
{"lineNum":"  136","line":"  local -i failure_test_index=$(( BATS_FILE_FIRST_TEST_NUMBER_IN_SUITE + 1 ))","class":"lineCov","hits":"2","order":"747","possible_hits":"0",},
{"lineNum":"  137","line":"  if [[ -z \"$BATS_SETUP_FILE_COMPLETED\" || -z \"$BATS_TEARDOWN_FILE_COMPLETED\" ]]; then","class":"lineCov","hits":"3","order":"748","possible_hits":"0",},
...
{"lineNum":"  159","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED-}\" ]] && declare -F setup_suite >/dev/null; then","class":"lineCov","hits":"4","order":"749","possible_hits":"0",},
{"lineNum":"  160","line":"    bats_generate_warning 3 --no-stacktrace \"$BATS_TEST_FILENAME\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  161","line":"  fi"},
{"lineNum":"  162","line":""},
{"lineNum":"  163","line":"  exit $bats_exec_file_status","class":"lineCov","hits":"2","order":"750","possible_hits":"0",},
{"lineNum":"  164","line":"}"},
{"lineNum":"  165","line":""},
{"lineNum":"  166","line":"function setup_file() {"},
{"lineNum":"  167","line":"  return 0","class":"lineCov","hits":"2","order":"364","possible_hits":"0",},
{"lineNum":"  168","line":"}"},
{"lineNum":"  169","line":""},
{"lineNum":"  170","line":"function teardown_file() {"},
{"lineNum":"  171","line":"  return 0","class":"lineCov","hits":"2","order":"738","possible_hits":"0",},
{"lineNum":"  172","line":"}"},
{"lineNum":"  173","line":""},
...
{"lineNum":"  215","line":"  local status=0","class":"lineCov","hits":"58","order":"375","possible_hits":"0",},
{"lineNum":"  216","line":"  local should_try_again=1 try_number","class":"lineCov","hits":"58","order":"376","possible_hits":"0",},
{"lineNum":"  217","line":"  for ((try_number=1; should_try_again; ++try_number)); do","class":"lineCov","hits":"232","order":"377","possible_hits":"0",},
{"lineNum":"  218","line":"    if \"$BATS_LIBEXEC/bats-exec-test\" \"$@\" \"$try_number\"; then","class":"lineCov","hits":"58","order":"378","possible_hits":"0",},
{"lineNum":"  219","line":"      should_try_again=0","class":"lineCov","hits":"36","order":"476","possible_hits":"0",},
{"lineNum":"  220","line":"    else"},
{"lineNum":"  221","line":"      status=$?","class":"lineCov","hits":"22","order":"563","possible_hits":"0",},
{"lineNum":"  222","line":"      if ((status == BATS_RETRY_RETURN_CODE)); then","class":"lineCov","hits":"22","order":"564","possible_hits":"0",},
{"lineNum":"  223","line":"        should_try_again=1","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  224","line":"      else"},
{"lineNum":"  225","line":"        should_try_again=0","class":"lineCov","hits":"22","order":"565","possible_hits":"0",},
{"lineNum":"  226","line":"        bats_exec_file_status=$status","class":"lineCov","hits":"22","order":"566","possible_hits":"0",},
{"lineNum":"  227","line":"      fi"},
{"lineNum":"  228","line":"    fi"},
{"lineNum":"  229","line":"  done"},
{"lineNum":"  230","line":"  return $status","class":"lineCov","hits":"58","order":"477","possible_hits":"0",},
{"lineNum":"  231","line":"}"},
{"lineNum":"  232","line":""},
...
{"lineNum":"  286","line":"  bats_exec_file_status=0","class":"lineCov","hits":"2","order":"368","possible_hits":"0",},
{"lineNum":"  287","line":""},
{"lineNum":"  288","line":"  if [[ \"$num_jobs\" != 1 && \"${BATS_NO_PARALLELIZE_WITHIN_FILE-False}\" == False ]]; then","class":"lineCov","hits":"2","order":"369","possible_hits":"0",},
...
{"lineNum":"  292","line":"    local test_number_in_suite=$BATS_FILE_FIRST_TEST_NUMBER_IN_SUITE \\","class":"lineCov","hits":"2","order":"370","possible_hits":"0",},
{"lineNum":"  293","line":"          test_number_in_file=0"},
{"lineNum":"  294","line":"    for test_name in \"${tests_to_run[@]}\"; do","class":"lineCov","hits":"58","order":"371","possible_hits":"0",},
{"lineNum":"  295","line":"      if [[ \"${BATS_INTERRUPTED-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"58","order":"372","possible_hits":"0",},
...
{"lineNum":"  300","line":"      if [[ $test_name ]]; then","class":"lineCov","hits":"58","order":"373","possible_hits":"0",},
{"lineNum":"  301","line":"        ((++test_number_in_suite))"},
{"lineNum":"  302","line":"        ((++test_number_in_file))"},
{"lineNum":"  303","line":"        bats_run_test_with_retries \"${flags[@]}\" \"$filename\" \"$test_name\" \\","class":"lineCov","hits":"58","order":"374","possible_hits":"0",},
...
{"lineNum":"  350","line":"trap \'BATS_INTERRUPTED=true\' INT","class":"lineCov","hits":"2","order":"366","possible_hits":"0",},
{"lineNum":"  351","line":"bats_run_tests","class":"lineCov","hits":"2","order":"367","possible_hits":"0",},
{"lineNum":"  352","line":""},
{"lineNum":"  353","line":"trap bats_interrupt_trap INT","class":"lineCov","hits":"2","order":"733","possible_hits":"0",},
{"lineNum":"  354","line":"bats_run_teardown_file","class":"lineCov","hits":"2","order":"734","possible_hits":"0",},
{"lineNum":"  355","line":""},
{"lineNum":"  356","line":"exit $bats_exec_file_status","class":"lineCov","hits":"2","order":"741","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2022-10-11 20:50:30", "instrumented" : 176, "covered" : 97,};
var merged_data = [];
