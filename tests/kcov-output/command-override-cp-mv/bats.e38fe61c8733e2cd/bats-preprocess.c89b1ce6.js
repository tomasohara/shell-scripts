...
{"lineNum":"    5","line":"  local name=\"$1\"","class":"lineCov","hits":"26","order":"154","possible_hits":"0",},
{"lineNum":"    6","line":"  local result=\'test_\'","class":"lineCov","hits":"26","order":"155","possible_hits":"0",},
{"lineNum":"    7","line":"  local hex_code","class":"lineCov","hits":"26","order":"156","possible_hits":"0",},
{"lineNum":"    8","line":""},
{"lineNum":"    9","line":"  if [[ ! \"$name\" =~ [^[:alnum:]\\ _-] ]]; then","class":"lineCov","hits":"26","order":"157","possible_hits":"0",},
{"lineNum":"   10","line":"    name=\"${name//_/-5f}\"","class":"lineCov","hits":"26","order":"158","possible_hits":"0",},
{"lineNum":"   11","line":"    name=\"${name//-/-2d}\"","class":"lineCov","hits":"26","order":"159","possible_hits":"0",},
{"lineNum":"   12","line":"    name=\"${name// /_}\"","class":"lineCov","hits":"26","order":"160","possible_hits":"0",},
{"lineNum":"   13","line":"    result+=\"$name\"","class":"lineCov","hits":"26","order":"161","possible_hits":"0",},
...
{"lineNum":"   29","line":"  fi"},
{"lineNum":"   30","line":""},
{"lineNum":"   31","line":"  printf -v \"$2\" \'%s\' \"$result\"","class":"lineCov","hits":"26","order":"162","possible_hits":"0",},
{"lineNum":"   32","line":"}"},
{"lineNum":"   33","line":""},
...
{"lineNum":"   78","line":"{"},
<<<<<<< HEAD
{"lineNum":"   79","line":"  while IFS= read -r line; do","class":"lineCov","hits":"1980","order":"142","possible_hits":"0",},
{"lineNum":"   80","line":"    ((++line_number))","class":"lineCov","hits":"987","order":"143","possible_hits":"0",},
{"lineNum":"   81","line":"    line=\"${line//$\'\\r\'/}\"","class":"lineCov","hits":"987","order":"144","possible_hits":"0",},
{"lineNum":"   82","line":"    if [[ \"$line\" =~ $BATS_TEST_PATTERN ]] || [[ \"$line\" =~ $BATS_TEST_PATTERN_COMMENT ]]; then","class":"lineCov","hits":"1941","order":"145","possible_hits":"0",},
=======
{"lineNum":"   79","line":"  while IFS= read -r line; do","class":"lineCov","hits":"992","order":"142","possible_hits":"0",},
{"lineNum":"   80","line":"    ((++line_number))","class":"lineCov","hits":"494","order":"143","possible_hits":"0",},
{"lineNum":"   81","line":"    line=\"${line//$\'\\r\'/}\"","class":"lineCov","hits":"494","order":"144","possible_hits":"0",},
{"lineNum":"   82","line":"    if [[ \"$line\" =~ $BATS_TEST_PATTERN ]] || [[ \"$line\" =~ $BATS_TEST_PATTERN_COMMENT ]]; then","class":"lineCov","hits":"962","order":"145","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"   83","line":"      name=\"${BASH_REMATCH[1]#[\\\'\\\"]}\"","class":"lineCov","hits":"26","order":"150","possible_hits":"0",},
{"lineNum":"   84","line":"      name=\"${name%[\\\'\\\"]}\"","class":"lineCov","hits":"26","order":"151","possible_hits":"0",},
{"lineNum":"   85","line":"      body=\"${BASH_REMATCH[2]:-}\"","class":"lineCov","hits":"26","order":"152","possible_hits":"0",},
{"lineNum":"   86","line":"      bats_encode_test_name \"$name\" \'encoded_name\'","class":"lineCov","hits":"26","order":"153","possible_hits":"0",},
{"lineNum":"   87","line":"      printf \'%s() { bats_test_begin \"%s\"; %s\\n\' \"${encoded_name:?}\" \"$name\" \"$body\" || :","class":"lineCov","hits":"26","order":"163","possible_hits":"0",},
{"lineNum":"   88","line":""},
...
{"lineNum":"   92","line":"      if [[ -z \"$BATS_TEST_FILTER\" || \"$name\" =~ $BATS_TEST_FILTER ]]; then","class":"lineCov","hits":"26","order":"178","possible_hits":"0",},
{"lineNum":"   93","line":"        IFS=,","class":"lineCov","hits":"26","order":"179","possible_hits":"0",},
{"lineNum":"   94","line":"        tests+=(\"--tags \'${tags[*]-}\' $encoded_name\")","class":"lineCov","hits":"26","order":"180","possible_hits":"0",},
{"lineNum":"   95","line":"      fi"},
...
<<<<<<< HEAD
{"lineNum":"   99","line":"      if [[ \"$line\" =~ $BATS_COMMENT_COMMAND_PATTERN ]]; then","class":"lineCov","hits":"938","order":"146","possible_hits":"0",},
=======
{"lineNum":"   99","line":"      if [[ \"$line\" =~ $BATS_COMMENT_COMMAND_PATTERN ]]; then","class":"lineCov","hits":"468","order":"146","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
...
{"lineNum":"  109","line":"      fi"},
<<<<<<< HEAD
{"lineNum":"  110","line":"      printf \'%s\\n\' \"$line\"","class":"lineCov","hits":"936","order":"147","possible_hits":"0",},
=======
{"lineNum":"  110","line":"      printf \'%s\\n\' \"$line\"","class":"lineCov","hits":"468","order":"147","possible_hits":"0",},
>>>>>>> integration-testing-3fa2c13
{"lineNum":"  111","line":"    fi"},
{"lineNum":"  112","line":"  done"},
{"lineNum":"  113","line":"} <<<\"$(<\"$test_file\")\"$\'\\n\'","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"for test_name in \"${tests[@]}\"; do","class":"lineCov","hits":"26","order":"181","possible_hits":"0",},
{"lineNum":"  116","line":"  printf \'bats_test_function %s\\n\' \"$test_name\"","class":"lineCov","hits":"26","order":"182","possible_hits":"0",},
...
var header = { "command" : "bats", "date" : "2023-05-19 18:20:31", "instrumented" : 71, "covered" : 35,};
=======
{"lineNum":"  119","line":"exit $exit_code","class":"lineCov","hits":"2","order":"187","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2023-05-06 21:39:15", "instrumented" : 71, "covered" : 35,};
>>>>>>> integration-testing-3fa2c13
var merged_data = [];
