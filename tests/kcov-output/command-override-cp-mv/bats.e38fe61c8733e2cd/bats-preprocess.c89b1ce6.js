...
{"lineNum":"    2","line":"set -e","class":"lineCov","hits":"2","order":"120","possible_hits":"0",},
{"lineNum":"    3","line":""},
{"lineNum":"    4","line":"bats_encode_test_name() {"},
{"lineNum":"    5","line":"  local name=\"$1\"","class":"lineCov","hits":"58","order":"144","possible_hits":"0",},
{"lineNum":"    6","line":"  local result=\'test_\'","class":"lineCov","hits":"58","order":"145","possible_hits":"0",},
{"lineNum":"    7","line":"  local hex_code","class":"lineCov","hits":"58","order":"146","possible_hits":"0",},
{"lineNum":"    8","line":""},
{"lineNum":"    9","line":"  if [[ ! \"$name\" =~ [^[:alnum:]\\ _-] ]]; then","class":"lineCov","hits":"58","order":"147","possible_hits":"0",},
{"lineNum":"   10","line":"    name=\"${name//_/-5f}\"","class":"lineCov","hits":"58","order":"148","possible_hits":"0",},
{"lineNum":"   11","line":"    name=\"${name//-/-2d}\"","class":"lineCov","hits":"58","order":"149","possible_hits":"0",},
{"lineNum":"   12","line":"    name=\"${name// /_}\"","class":"lineCov","hits":"58","order":"150","possible_hits":"0",},
{"lineNum":"   13","line":"    result+=\"$name\"","class":"lineCov","hits":"58","order":"151","possible_hits":"0",},
...
{"lineNum":"   29","line":"  fi"},
{"lineNum":"   30","line":""},
{"lineNum":"   31","line":"  printf -v \"$2\" \'%s\' \"$result\"","class":"lineCov","hits":"58","order":"152","possible_hits":"0",},
{"lineNum":"   32","line":"}"},
{"lineNum":"   33","line":""},
{"lineNum":"   34","line":"BATS_TEST_PATTERN=\"^[[:blank:]]*@test[[:blank:]]+(.*[^[:blank:]])[[:blank:]]+\\{(.*)\\$\"","class":"lineCov","hits":"2","order":"121","possible_hits":"0",},
{"lineNum":"   35","line":"BATS_TEST_PATTERN_COMMENT=\"[[:blank:]]*([^[:blank:]()]+)[[:blank:]]*\\(?\\)?[[:blank:]]+\\{[[:blank:]]+#[[:blank:]]*@test[[:blank:]]*\\$\""},
{"lineNum":"   36","line":"BATS_COMMENT_COMMAND_PATTERN=\"^[[:blank:]]*#[[:blank:]]*bats[[:blank:]]+(.*)$\"","class":"lineCov","hits":"2","order":"122","possible_hits":"0",},
{"lineNum":"   37","line":"BATS_VALID_TAG_PATTERN=\"[-_:[:alnum:]]+\"","class":"lineCov","hits":"2","order":"123","possible_hits":"0",},
{"lineNum":"   38","line":"BATS_VALID_TAGS_PATTERN=\"^ *($BATS_VALID_TAG_PATTERN)?( *, *$BATS_VALID_TAG_PATTERN)* *$\"","class":"lineCov","hits":"2","order":"124","possible_hits":"0",},
{"lineNum":"   39","line":""},
{"lineNum":"   40","line":"# shellcheck source=lib/bats-core/common.bash"},
{"lineNum":"   41","line":"source \"$BATS_ROOT/lib/bats-core/common.bash\"","class":"lineCov","hits":"2","order":"125","possible_hits":"0",},
{"lineNum":"   42","line":""},
...
{"lineNum":"   69","line":"}"},
{"lineNum":"   70","line":""},
{"lineNum":"   71","line":"test_file=\"$1\"","class":"lineCov","hits":"2","order":"126","possible_hits":"0",},
...
{"lineNum":"   76","line":"line_number=0","class":"lineCov","hits":"2","order":"127","possible_hits":"0",},
{"lineNum":"   77","line":"exit_code=0","class":"lineCov","hits":"2","order":"128","possible_hits":"0",},
{"lineNum":"   78","line":"{"},
{"lineNum":"   79","line":"  while IFS= read -r line; do","class":"lineCov","hits":"1832","order":"129","possible_hits":"0",},
{"lineNum":"   80","line":"    (( ++line_number ))","class":"lineCov","hits":"914","order":"130","possible_hits":"0",},
{"lineNum":"   81","line":"    line=\"${line//$\'\\r\'/}\"","class":"lineCov","hits":"914","order":"131","possible_hits":"0",},
{"lineNum":"   82","line":"    if [[ \"$line\" =~ $BATS_TEST_PATTERN ]] || [[ \"$line\" =~ $BATS_TEST_PATTERN_COMMENT ]]; then","class":"lineCov","hits":"1770","order":"132","possible_hits":"0",},
{"lineNum":"   83","line":"      name=\"${BASH_REMATCH[1]#[\\\'\\\"]}\"","class":"lineCov","hits":"58","order":"140","possible_hits":"0",},
{"lineNum":"   84","line":"      name=\"${name%[\\\'\\\"]}\"","class":"lineCov","hits":"58","order":"141","possible_hits":"0",},
{"lineNum":"   85","line":"      body=\"${BASH_REMATCH[2]:-}\"","class":"lineCov","hits":"58","order":"142","possible_hits":"0",},
{"lineNum":"   86","line":"      bats_encode_test_name \"$name\" \'encoded_name\'","class":"lineCov","hits":"58","order":"143","possible_hits":"0",},
{"lineNum":"   87","line":"      printf \'%s() { bats_test_begin \"%s\"; %s\\n\' \"${encoded_name:?}\" \"$name\" \"$body\" || :","class":"lineCov","hits":"58","order":"153","possible_hits":"0",},
{"lineNum":"   88","line":""},
...
{"lineNum":"   92","line":"      if [[ -z \"$BATS_TEST_FILTER\" || \"$name\" =~ $BATS_TEST_FILTER ]]; then","class":"lineCov","hits":"58","order":"168","possible_hits":"0",},
{"lineNum":"   93","line":"        IFS=,","class":"lineCov","hits":"58","order":"169","possible_hits":"0",},
{"lineNum":"   94","line":"        tests+=(\"--tags \'${tags[*]-}\' $encoded_name\")","class":"lineCov","hits":"58","order":"170","possible_hits":"0",},
{"lineNum":"   95","line":"      fi"},
...
{"lineNum":"   99","line":"      if [[ \"$line\" =~ $BATS_COMMENT_COMMAND_PATTERN ]]; then","class":"lineCov","hits":"856","order":"133","possible_hits":"0",},
...
{"lineNum":"  109","line":"      fi"},
{"lineNum":"  110","line":"      printf \'%s\\n\' \"$line\"","class":"lineCov","hits":"856","order":"136","possible_hits":"0",},
{"lineNum":"  111","line":"    fi"},
{"lineNum":"  112","line":"  done"},
{"lineNum":"  113","line":"} <<<\"$(<\"$test_file\")\"$\'\\n\'","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"for test_name in \"${tests[@]}\"; do","class":"lineCov","hits":"58","order":"174","possible_hits":"0",},
{"lineNum":"  116","line":"  printf \'bats_test_function %s\\n\' \"$test_name\"","class":"lineCov","hits":"58","order":"175","possible_hits":"0",},
{"lineNum":"  117","line":"done"},
{"lineNum":"  118","line":""},
{"lineNum":"  119","line":"exit $exit_code","class":"lineCov","hits":"2","order":"183","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2022-10-11 20:50:30", "instrumented" : 71, "covered" : 35,};
var merged_data = [];
