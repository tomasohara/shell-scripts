...
{"lineNum":"    4","line":"    while IFS= read -r line; do","class":"lineCov","hits":"108","order":"546","possible_hits":"0",},
{"lineNum":"    5","line":"      printf \'# %s\\n\' \"$line\" || break # avoid feedback loop when errors are redirected into BATS_OUT (see #353)","class":"lineCov","hits":"45","order":"547","possible_hits":"0",},
{"lineNum":"    6","line":"    done"},
{"lineNum":"    7","line":"    if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"9","order":"550","possible_hits":"0",},
...
{"lineNum":"   14","line":"  while read -r line; do","class":"lineCov","hits":"54","order":"548","possible_hits":"0",},
{"lineNum":"   15","line":"    printf \"%s\\n\" \"${line//$BATS_TEST_SOURCE/$BATS_TEST_FILENAME}\"","class":"lineCov","hits":"45","order":"549","possible_hits":"0",},
...
var header = { "command" : "bats", "date" : "2022-10-01 22:25:38", "instrumented" : 106, "covered" : 22,};
var merged_data = [];
