...
{"lineNum":"    4","line":"source \"$BATS_ROOT/lib/bats-core/common.bash\"","class":"lineCov","hits":"15","order":"227","possible_hits":"0",},
{"lineNum":"    5","line":""},
{"lineNum":"    6","line":"bats_capture_stack_trace() {"},
{"lineNum":"    7","line":"  local test_file","class":"lineCov","hits":"117","order":"337","possible_hits":"0",},
{"lineNum":"    8","line":"  local funcname","class":"lineCov","hits":"117","order":"338","possible_hits":"0",},
{"lineNum":"    9","line":"  local i","class":"lineCov","hits":"117","order":"339","possible_hits":"0",},
{"lineNum":"   10","line":""},
...
{"lineNum":"   21","line":"      break","class":"lineCov","hits":"109","order":"430","possible_hits":"0",},
{"lineNum":"   22","line":"      ;;"},
{"lineNum":"   23","line":"    esac"},
{"lineNum":"   24","line":"    if [[ \"${BASH_SOURCE[$i + 1]:-}\" == *\"bats-exec-file\" ]] && [[ \"$funcname\" == \'source\' ]]; then","class":"lineCov","hits":"37","order":"345","possible_hits":"0",},
{"lineNum":"   25","line":"      break","class":"lineCov","hits":"8","order":"346","possible_hits":"0",},
{"lineNum":"   26","line":"    fi"},
{"lineNum":"   27","line":"  done"},
{"lineNum":"   28","line":"}"},
{"lineNum":"   29","line":""},
{"lineNum":"   30","line":"bats_get_failure_stack_trace() {"},
{"lineNum":"   31","line":"  local stack_trace_var","class":"lineCov","hits":"2","order":"517","possible_hits":"0",},
{"lineNum":"   32","line":"  # See bats_debug_trap for details."},
{"lineNum":"   33","line":"  if [[ -n \"${BATS_DEBUG_LAST_STACK_TRACE_IS_VALID:-}\" ]]; then","class":"lineCov","hits":"2","order":"518","possible_hits":"0",},
{"lineNum":"   34","line":"    stack_trace_var=BATS_DEBUG_LAST_STACK_TRACE","class":"lineCov","hits":"2","order":"519","possible_hits":"0",},
...
{"lineNum":"   47","line":"  local frame","class":"lineCov","hits":"2","order":"521","possible_hits":"0",},
{"lineNum":"   48","line":"  local index=1","class":"lineCov","hits":"2","order":"522","possible_hits":"0",},
{"lineNum":"   49","line":"  local count=\"${#@}\"","class":"lineCov","hits":"2","order":"523","possible_hits":"0",},
{"lineNum":"   50","line":"  local filename","class":"lineCov","hits":"2","order":"524","possible_hits":"0",},
{"lineNum":"   51","line":"  local lineno","class":"lineCov","hits":"2","order":"525","possible_hits":"0",},
{"lineNum":"   52","line":""},
{"lineNum":"   53","line":"  for frame in \"$@\"; do","class":"lineCov","hits":"2","order":"526","possible_hits":"0",},
{"lineNum":"   54","line":"    bats_frame_filename \"$frame\" \'filename\'","class":"lineCov","hits":"2","order":"527","possible_hits":"0",},
{"lineNum":"   55","line":"    bats_trim_filename \"$filename\" \'filename\'","class":"lineCov","hits":"2","order":"533","possible_hits":"0",},
{"lineNum":"   56","line":"    bats_frame_lineno \"$frame\" \'lineno\'","class":"lineCov","hits":"2","order":"535","possible_hits":"0",},
{"lineNum":"   57","line":""},
{"lineNum":"   58","line":"    printf \'%s\' \"${BATS_STACK_TRACE_PREFIX-# }\"","class":"lineCov","hits":"2","order":"537","possible_hits":"0",},
{"lineNum":"   59","line":"    if [[ $index -eq 1 ]]; then","class":"lineCov","hits":"2","order":"538","possible_hits":"0",},
{"lineNum":"   60","line":"      printf \'(\'","class":"lineCov","hits":"2","order":"539","possible_hits":"0",},
{"lineNum":"   61","line":"    else"},
{"lineNum":"   62","line":"      printf \' \'","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"   63","line":"    fi"},
{"lineNum":"   64","line":""},
{"lineNum":"   65","line":"    local fn","class":"lineCov","hits":"2","order":"540","possible_hits":"0",},
{"lineNum":"   66","line":"    bats_frame_function \"$frame\" \'fn\'","class":"lineCov","hits":"2","order":"541","possible_hits":"0",},
{"lineNum":"   67","line":"    if [[ \"$fn\" != \"${BATS_TEST_NAME-}\" ]] &&","class":"lineCov","hits":"2","order":"544","possible_hits":"0",},
...
{"lineNum":"   74","line":"    fi"},
{"lineNum":"   75","line":""},
{"lineNum":"   76","line":"    local reference","class":"lineCov","hits":"2","order":"545","possible_hits":"0",},
{"lineNum":"   77","line":"    bats_format_file_line_reference reference \"$filename\" \"$lineno\"","class":"lineCov","hits":"2","order":"546","possible_hits":"0",},
{"lineNum":"   78","line":"    if [[ $index -eq $count ]]; then","class":"lineCov","hits":"2","order":"551","possible_hits":"0",},
{"lineNum":"   79","line":"      printf \'in test file %s)\\n\' \"$reference\"","class":"lineCov","hits":"2","order":"552","possible_hits":"0",},
...
{"lineNum":"   89","line":"  local stack_trace=(\"${@}\")","class":"lineCov","hits":"4","order":"554","possible_hits":"0",},
{"lineNum":"   90","line":"  if [[ ${#stack_trace[@]} -eq 0 ]]; then","class":"lineCov","hits":"2","order":"555","possible_hits":"0",},
{"lineNum":"   91","line":"    return 0","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"   92","line":"  fi"},
{"lineNum":"   93","line":"  local frame=\"${stack_trace[${#stack_trace[@]} - 1]}\"","class":"lineCov","hits":"2","order":"556","possible_hits":"0",},
{"lineNum":"   94","line":"  local filename","class":"lineCov","hits":"2","order":"557","possible_hits":"0",},
{"lineNum":"   95","line":"  local lineno","class":"lineCov","hits":"2","order":"558","possible_hits":"0",},
{"lineNum":"   96","line":"  local failed_line","class":"lineCov","hits":"2","order":"559","possible_hits":"0",},
{"lineNum":"   97","line":"  local failed_command","class":"lineCov","hits":"2","order":"560","possible_hits":"0",},
{"lineNum":"   98","line":""},
{"lineNum":"   99","line":"  bats_frame_filename \"$frame\" \'filename\'","class":"lineCov","hits":"2","order":"561","possible_hits":"0",},
{"lineNum":"  100","line":"  bats_frame_lineno \"$frame\" \'lineno\'","class":"lineCov","hits":"2","order":"562","possible_hits":"0",},
{"lineNum":"  101","line":"  bats_extract_line \"$filename\" \"$lineno\" \'failed_line\'","class":"lineCov","hits":"2","order":"563","possible_hits":"0",},
{"lineNum":"  102","line":"  bats_strip_string \"$failed_line\" \'failed_command\'","class":"lineCov","hits":"2","order":"570","possible_hits":"0",},
{"lineNum":"  103","line":"  local quoted_failed_command","class":"lineCov","hits":"2","order":"573","possible_hits":"0",},
{"lineNum":"  104","line":"  bats_quote_code quoted_failed_command \"$failed_command\"","class":"lineCov","hits":"2","order":"574","possible_hits":"0",},
{"lineNum":"  105","line":"  printf \'#   %s \' \"${quoted_failed_command}\"","class":"lineCov","hits":"2","order":"576","possible_hits":"0",},
{"lineNum":"  106","line":""},
{"lineNum":"  107","line":"  if [[ \"${BATS_TIMED_OUT-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"2","order":"577","possible_hits":"0",},
...
{"lineNum":"  111","line":"  fi"},
{"lineNum":"  112","line":""},
{"lineNum":"  113","line":"  if [[ \"$BATS_ERROR_STATUS\" -eq 1 ]]; then","class":"lineCov","hits":"2","order":"578","possible_hits":"0",},
{"lineNum":"  114","line":"    printf \'failed%s\\n\' \"$BATS_ERROR_SUFFIX\"","class":"lineCov","hits":"2","order":"579","possible_hits":"0",},
...
{"lineNum":"  121","line":"  printf -v \"$2\" \'%s\' \"${1%% *}\"","class":"lineCov","hits":"4","order":"536","possible_hits":"0",},
{"lineNum":"  122","line":"}"},
{"lineNum":"  123","line":""},
{"lineNum":"  124","line":"bats_frame_function() {"},
{"lineNum":"  125","line":"  local __bff_function=\"${1#* }\"","class":"lineCov","hits":"2","order":"542","possible_hits":"0",},
{"lineNum":"  126","line":"  printf -v \"$2\" \'%s\' \"${__bff_function%% *}\"","class":"lineCov","hits":"2","order":"543","possible_hits":"0",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"bats_frame_filename() {"},
{"lineNum":"  130","line":"  local __bff_filename=\"${1#* }\"","class":"lineCov","hits":"4","order":"528","possible_hits":"0",},
{"lineNum":"  131","line":"  __bff_filename=\"${__bff_filename#* }\"","class":"lineCov","hits":"4","order":"529","possible_hits":"0",},
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"  if [[ \"$__bff_filename\" == \"${BATS_TEST_SOURCE-}\" ]]; then","class":"lineCov","hits":"4","order":"530","possible_hits":"0",},
{"lineNum":"  134","line":"    __bff_filename=\"$BATS_TEST_FILENAME\"","class":"lineCov","hits":"4","order":"531","possible_hits":"0",},
{"lineNum":"  135","line":"  fi"},
{"lineNum":"  136","line":"  printf -v \"$2\" \'%s\' \"$__bff_filename\"","class":"lineCov","hits":"4","order":"532","possible_hits":"0",},
{"lineNum":"  137","line":"}"},
{"lineNum":"  138","line":""},
{"lineNum":"  139","line":"bats_extract_line() {"},
{"lineNum":"  140","line":"  local __bats_extract_line_line","class":"lineCov","hits":"2","order":"564","possible_hits":"0",},
{"lineNum":"  141","line":"  local __bats_extract_line_index=0","class":"lineCov","hits":"2","order":"565","possible_hits":"0",},
{"lineNum":"  142","line":""},
{"lineNum":"  143","line":"  while IFS= read -r __bats_extract_line_line; do","class":"lineCov","hits":"294","order":"566","possible_hits":"0",},
{"lineNum":"  144","line":"    if [[ \"$((++__bats_extract_line_index))\" -eq \"$2\" ]]; then","class":"lineCov","hits":"147","order":"567","possible_hits":"0",},
{"lineNum":"  145","line":"      printf -v \"$3\" \'%s\' \"${__bats_extract_line_line%$\'\\r\'}\"","class":"lineCov","hits":"2","order":"568","possible_hits":"0",},
{"lineNum":"  146","line":"      break","class":"lineCov","hits":"2","order":"569","possible_hits":"0",},
{"lineNum":"  147","line":"    fi"},
{"lineNum":"  148","line":"  done <\"$1\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  149","line":"}"},
{"lineNum":"  150","line":""},
{"lineNum":"  151","line":"bats_strip_string() {"},
{"lineNum":"  152","line":"  [[ \"$1\" =~ ^[[:space:]]*(.*)[[:space:]]*$ ]]","class":"lineCov","hits":"2","order":"571","possible_hits":"0",},
{"lineNum":"  153","line":"  printf -v \"$2\" \'%s\' \"${BASH_REMATCH[1]}\"","class":"lineCov","hits":"2","order":"572","possible_hits":"0",},
{"lineNum":"  154","line":"}"},
{"lineNum":"  155","line":""},
{"lineNum":"  156","line":"bats_trim_filename() {"},
{"lineNum":"  157","line":"  printf -v \"$2\" \'%s\' \"${1#\"$BATS_CWD\"/}\"","class":"lineCov","hits":"2","order":"534","possible_hits":"0",},
{"lineNum":"  158","line":"}"},
{"lineNum":"  159","line":""},
...
{"lineNum":"  163","line":"  local output_var=\"$1\" path=\"$2\"","class":"lineCov","hits":"631","order":"247","possible_hits":"0",},
{"lineNum":"  164","line":"  if [[ \"$output_var\" != NORMALIZED_INPUT ]]; then","class":"lineCov","hits":"631","order":"248","possible_hits":"0",},
{"lineNum":"  165","line":"    local NORMALIZED_INPUT","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  166","line":"  fi"},
{"lineNum":"  167","line":"  if [[ $path == ?:* ]]; then","class":"lineCov","hits":"631","order":"249","possible_hits":"0",},
...
{"lineNum":"  173","line":"    NORMALIZED_INPUT=\"$path\"","class":"lineCov","hits":"631","order":"250","possible_hits":"0",},
{"lineNum":"  174","line":"  fi"},
{"lineNum":"  175","line":"  printf -v \"$output_var\" \"%s\" \"$NORMALIZED_INPUT\"","class":"lineCov","hits":"631","order":"251","possible_hits":"0",},
{"lineNum":"  176","line":"}"},
{"lineNum":"  177","line":""},
{"lineNum":"  178","line":"bats_emit_trace() {"},
{"lineNum":"  179","line":"  if [[ $BATS_TRACE_LEVEL -gt 0 ]]; then","class":"lineCov","hits":"117","order":"348","possible_hits":"0",},
...
{"lineNum":"  255","line":"  local NORMALIZED_INPUT","class":"lineCov","hits":"631","order":"245","possible_hits":"0",},
{"lineNum":"  256","line":"  bats_normalize_windows_dir_path NORMALIZED_INPUT \"${1%/*}\"","class":"lineCov","hits":"631","order":"246","possible_hits":"0",},
{"lineNum":"  257","line":"  local file_excluded=\'\' path","class":"lineCov","hits":"631","order":"252","possible_hits":"0",},
{"lineNum":"  258","line":"  for path in \"${BATS_DEBUG_EXCLUDE_PATHS[@]}\"; do","class":"lineCov","hits":"1243","order":"253","possible_hits":"0",},
{"lineNum":"  259","line":"    if [[ \"$NORMALIZED_INPUT\" == \"$path\"* ]]; then","class":"lineCov","hits":"1243","order":"254","possible_hits":"0",},
{"lineNum":"  260","line":"      file_excluded=1","class":"lineCov","hits":"514","order":"255","possible_hits":"0",},
{"lineNum":"  261","line":"      break","class":"lineCov","hits":"514","order":"256","possible_hits":"0",},
{"lineNum":"  262","line":"    fi"},
...
{"lineNum":"  269","line":"    \"${BATS_TIMED_OUT-NOTSET}\" == NOTSET ]]; then","class":"lineCov","hits":"865","order":"257","possible_hits":"0",},
...
{"lineNum":"  272","line":"    )"},
{"lineNum":"  273","line":""},
{"lineNum":"  274","line":"    BATS_DEBUG_LAST_LINENO=(${BASH_LINENO[@]+\"${BASH_LINENO[@]}\"})","class":"lineCov","hits":"117","order":"334","possible_hits":"0",},
{"lineNum":"  275","line":"    BATS_DEBUG_LAST_SOURCE=(${BASH_SOURCE[@]+\"${BASH_SOURCE[@]}\"})","class":"lineCov","hits":"117","order":"335","possible_hits":"0",},
{"lineNum":"  276","line":"    bats_capture_stack_trace","class":"lineCov","hits":"117","order":"336","possible_hits":"0",},
{"lineNum":"  277","line":"    bats_emit_trace","class":"lineCov","hits":"117","order":"347","possible_hits":"0",},
{"lineNum":"  278","line":"  fi"},
{"lineNum":"  279","line":"}"},
{"lineNum":"  280","line":""},
...
{"lineNum":"  292","line":"  local status=\"$?\"","class":"lineCov","hits":"17","order":"447","possible_hits":"0",},
{"lineNum":"  293","line":"  if [[ -z \"${BATS_TEST_COMPLETED:-}\" ]]; then","class":"lineCov","hits":"17","order":"448","possible_hits":"0",},
{"lineNum":"  294","line":"    BATS_ERROR_STATUS=\"${BATS_ERROR_STATUS:-$status}\"","class":"lineCov","hits":"9","order":"506","possible_hits":"0",},
{"lineNum":"  295","line":"    if [[ \"$BATS_ERROR_STATUS\" -eq 0 ]]; then","class":"lineCov","hits":"9","order":"507","possible_hits":"0",},
{"lineNum":"  296","line":"      BATS_ERROR_STATUS=1","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  297","line":"    fi"},
{"lineNum":"  298","line":"    trap - DEBUG","class":"lineCov","hits":"9","order":"508","possible_hits":"0",},
{"lineNum":"  299","line":"  fi"},
{"lineNum":"  300","line":"}"},
{"lineNum":"  301","line":""},
{"lineNum":"  302","line":"bats_add_debug_exclude_path() { # <path>"},
{"lineNum":"  303","line":"  if [[ -z \"$1\" ]]; then        # don\'t exclude everything","class":"lineCov","hits":"24","order":"232","possible_hits":"0",},
...
{"lineNum":"  306","line":"  fi"},
{"lineNum":"  307","line":"  if [[ \"$OSTYPE\" == cygwin || \"$OSTYPE\" == msys ]]; then","class":"lineCov","hits":"48","order":"233","possible_hits":"0",},
...
{"lineNum":"  312","line":"    BATS_DEBUG_EXCLUDE_PATHS+=(\"$1\")","class":"lineCov","hits":"24","order":"234","possible_hits":"0",},
{"lineNum":"  313","line":"  fi"},
{"lineNum":"  314","line":"}"},
{"lineNum":"  315","line":""},
...
{"lineNum":"  335","line":"  BATS_DEBUG_LAST_STACK_TRACE_IS_VALID=","class":"lineCov","hits":"8","order":"229","possible_hits":"0",},
{"lineNum":"  336","line":"  BATS_ERROR_SUFFIX=","class":"lineCov","hits":"8","order":"230","possible_hits":"0",},
{"lineNum":"  337","line":"  BATS_DEBUG_EXCLUDE_PATHS=()"},
{"lineNum":"  338","line":"  # exclude some paths by default"},
{"lineNum":"  339","line":"  bats_add_debug_exclude_path \"$BATS_ROOT/lib/\"","class":"lineCov","hits":"8","order":"231","possible_hits":"0",},
{"lineNum":"  340","line":"  bats_add_debug_exclude_path \"$BATS_ROOT/libexec/\"","class":"lineCov","hits":"8","order":"235","possible_hits":"0",},
{"lineNum":"  341","line":""},
{"lineNum":"  342","line":"  exec 4<&1 # used for tracing","class":"lineCov","hits":"8","order":"236","possible_hits":"0",},
{"lineNum":"  343","line":"  if [[ \"${BATS_TRACE_LEVEL:-0}\" -gt 0 ]]; then","class":"lineCov","hits":"8","order":"237","possible_hits":"0",},
...
{"lineNum":"  353","line":"  fi"},
{"lineNum":"  354","line":""},
{"lineNum":"  355","line":"  local exclude_paths path","class":"lineCov","hits":"8","order":"238","possible_hits":"0",},
{"lineNum":"  356","line":"  # exclude user defined libraries"},
{"lineNum":"  357","line":"  IFS=\':\' read -r exclude_paths <<<\"${BATS_DEBUG_EXCLUDE_PATHS:-}\"","class":"lineCov","hits":"16","order":"239","possible_hits":"0",},
{"lineNum":"  358","line":"  for path in \"${exclude_paths[@]}\"; do","class":"lineCov","hits":"8","order":"240","possible_hits":"0",},
{"lineNum":"  359","line":"    if [[ -n \"$path\" ]]; then","class":"lineCov","hits":"8","order":"241","possible_hits":"0",},
{"lineNum":"  360","line":"      bats_add_debug_exclude_path \"$path\"","class":"lineCov","hits":"8","order":"242","possible_hits":"0",},
{"lineNum":"  361","line":"    fi"},
{"lineNum":"  362","line":"  done"},
{"lineNum":"  363","line":""},
{"lineNum":"  364","line":"  # turn on traps after setting excludes to avoid tracing the exclude setup"},
{"lineNum":"  365","line":"  trap \'bats_debug_trap \"$BASH_SOURCE\"\' DEBUG","class":"lineCov","hits":"8","order":"243","possible_hits":"0",},
{"lineNum":"  366","line":"  trap \'bats_error_trap\' ERR","class":"lineCov","hits":"16","order":"244","possible_hits":"0",},
{"lineNum":"  367","line":"}"},
{"lineNum":"  368","line":""},
{"lineNum":"  369","line":"bats_error_trap() {"},
{"lineNum":"  370","line":"  bats_check_status_from_trap","class":"lineCov","hits":"7","order":"505","possible_hits":"0",},
{"lineNum":"  371","line":""},
...
{"lineNum":"  376","line":"    -z \"$BATS_DEBUG_LAST_STACK_TRACE_IS_VALID\" ]]; then","class":"lineCov","hits":"10","order":"509","possible_hits":"0",},
...
{"lineNum":"  379","line":"    )"},
{"lineNum":"  380","line":"  fi"},
{"lineNum":"  381","line":"  BATS_DEBUG_LAST_STACK_TRACE_IS_VALID=1","class":"lineCov","hits":"4","order":"510","possible_hits":"0",},
{"lineNum":"  382","line":"}"},
{"lineNum":"  383","line":""},
...
var header = { "command" : "bats", "date" : "2023-04-09 21:57:31", "instrumented" : 168, "covered" : 110,};
var merged_data = [];
