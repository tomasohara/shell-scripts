...
{"lineNum":"   96","line":""},
{"lineNum":"   97","line":"  BATS_SOURCE_FILE_COMPLETED=1","class":"lineCov","hits":"2","order":"356","possible_hits":"0",},
{"lineNum":"   98","line":""},
{"lineNum":"   99","line":"  setup_file >>\"$BATS_OUT\" 2>&1","class":"lineCov","hits":"2","order":"357","possible_hits":"0",},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"  BATS_SETUP_FILE_COMPLETED=1","class":"lineCov","hits":"2","order":"359","possible_hits":"0",},
{"lineNum":"  102","line":"}"},
{"lineNum":"  103","line":""},
{"lineNum":"  104","line":"bats_run_teardown_file() {"},
{"lineNum":"  105","line":"  local bats_teardown_file_status=0","class":"lineCov","hits":"2","order":"616","possible_hits":"0",},
{"lineNum":"  106","line":"  # avoid running the therdown trap due to errors in teardown_file"},
{"lineNum":"  107","line":"  trap \'bats_file_exit_trap\' EXIT","class":"lineCov","hits":"2","order":"617","possible_hits":"0",},
{"lineNum":"  108","line":""},
{"lineNum":"  109","line":"  # rely on bats_error_trap to catch failures"},
{"lineNum":"  110","line":"  teardown_file >>\"$BATS_OUT\" 2>&1 || bats_teardown_file_status=$?","class":"lineCov","hits":"2","order":"618","possible_hits":"0",},
{"lineNum":"  111","line":""},
{"lineNum":"  112","line":"  if ((bats_teardown_file_status == 0)); then","class":"lineCov","hits":"2","order":"620","possible_hits":"0",},
{"lineNum":"  113","line":"    BATS_TEARDOWN_FILE_COMPLETED=1","class":"lineCov","hits":"2","order":"621","possible_hits":"0",},
...
{"lineNum":"  132","line":"  local -r last_return_code=$?","class":"lineCov","hits":"2","order":"623","possible_hits":"0",},
{"lineNum":"  133","line":"  if [[ ${1:-} != in-teardown_trap ]]; then","class":"lineCov","hits":"2","order":"624","possible_hits":"0",},
{"lineNum":"  134","line":"    BATS_ERROR_STATUS=$last_return_code","class":"lineCov","hits":"2","order":"625","possible_hits":"0",},
{"lineNum":"  135","line":"  fi"},
{"lineNum":"  136","line":"  trap - ERR EXIT","class":"lineCov","hits":"2","order":"626","possible_hits":"0",},
{"lineNum":"  137","line":"  local failure_reason","class":"lineCov","hits":"2","order":"627","possible_hits":"0",},
{"lineNum":"  138","line":"  local -i failure_test_index=$((BATS_FILE_FIRST_TEST_NUMBER_IN_SUITE + 1))","class":"lineCov","hits":"2","order":"628","possible_hits":"0",},
{"lineNum":"  139","line":"  if [[ -n \"${BATS_TEST_SKIPPED-}\" ]]; then","class":"lineCov","hits":"2","order":"629","possible_hits":"0",},
...
{"lineNum":"  144","line":"  elif [[ -z \"$BATS_SETUP_FILE_COMPLETED\" || -z \"$BATS_TEARDOWN_FILE_COMPLETED\" ]]; then","class":"lineCov","hits":"3","order":"630","possible_hits":"0",},
...
{"lineNum":"  166","line":"  if [[ -z \"${BATS_SETUP_SUITE_COMPLETED-}\" ]] && declare -F setup_suite >/dev/null; then","class":"lineCov","hits":"4","order":"631","possible_hits":"0",},
{"lineNum":"  167","line":"    bats_generate_warning 3 --no-stacktrace \"$BATS_TEST_FILENAME\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  168","line":"  fi"},
{"lineNum":"  169","line":""},
{"lineNum":"  170","line":"  exit \"$bats_exec_file_status\"","class":"lineCov","hits":"2","order":"632","possible_hits":"0",},
{"lineNum":"  171","line":"}"},
{"lineNum":"  172","line":""},
{"lineNum":"  173","line":"function setup_file() {"},
{"lineNum":"  174","line":"  return 0","class":"lineCov","hits":"2","order":"358","possible_hits":"0",},
{"lineNum":"  175","line":"}"},
{"lineNum":"  176","line":""},
{"lineNum":"  177","line":"function teardown_file() {"},
{"lineNum":"  178","line":"  return 0","class":"lineCov","hits":"2","order":"619","possible_hits":"0",},
{"lineNum":"  179","line":"}"},
{"lineNum":"  180","line":""},
...
{"lineNum":"  222","line":"  local status=0","class":"lineCov","hits":"12","order":"371","possible_hits":"0",},
{"lineNum":"  223","line":"  local should_try_again=1 try_number","class":"lineCov","hits":"12","order":"372","possible_hits":"0",},
{"lineNum":"  224","line":"  for ((try_number = 1; should_try_again; ++try_number)); do","class":"lineCov","hits":"48","order":"373","possible_hits":"0",},
{"lineNum":"  225","line":"    if \"$BATS_LIBEXEC/bats-exec-test\" \"$@\" \"$try_number\"; then","class":"lineCov","hits":"12","order":"374","possible_hits":"0",},
{"lineNum":"  226","line":"      should_try_again=0","class":"lineCov","hits":"8","order":"479","possible_hits":"0",},
{"lineNum":"  227","line":"    else"},
{"lineNum":"  228","line":"      status=$?","class":"lineCov","hits":"4","order":"592","possible_hits":"0",},
{"lineNum":"  229","line":"      if ((status == BATS_RETRY_RETURN_CODE)); then","class":"lineCov","hits":"4","order":"593","possible_hits":"0",},
...
{"lineNum":"  233","line":"        should_try_again=0","class":"lineCov","hits":"4","order":"594","possible_hits":"0",},
{"lineNum":"  234","line":"        bats_exec_file_status=$status","class":"lineCov","hits":"4","order":"595","possible_hits":"0",},
{"lineNum":"  235","line":"      fi"},
{"lineNum":"  236","line":"    fi"},
{"lineNum":"  237","line":"  done"},
{"lineNum":"  238","line":"  return $status","class":"lineCov","hits":"12","order":"480","possible_hits":"0",},
{"lineNum":"  239","line":"}"},
{"lineNum":"  240","line":""},
...
{"lineNum":"  273","line":"  while read -r test_line; do","class":"lineCov","hits":"7","order":"294","possible_hits":"0",},
...
{"lineNum":"  277","line":"    if [[ \"$filename\" == \"${test_line::${#filename}}\" ]]; then","class":"lineCov","hits":"6","order":"295","possible_hits":"0",},
{"lineNum":"  278","line":"      # get the rest of the line without the separator \\t"},
{"lineNum":"  279","line":"      test_name=${test_line:$((1 + ${#filename}))}","class":"lineCov","hits":"6","order":"296","possible_hits":"0",},
{"lineNum":"  280","line":"      tests_to_run+=(\"$test_name\")","class":"lineCov","hits":"6","order":"297","possible_hits":"0",},
...
{"lineNum":"  283","line":"      if [[ -z \"$test_number_in_suite\" ]]; then","class":"lineCov","hits":"6","order":"298","possible_hits":"0",},
...
{"lineNum":"  294","line":"  bats_exec_file_status=0","class":"lineCov","hits":"2","order":"362","possible_hits":"0",},
{"lineNum":"  295","line":""},
{"lineNum":"  296","line":"  if [[ \"${BATS_RUN_TESTS_SKIPPED-}\" ]]; then","class":"lineCov","hits":"2","order":"363","possible_hits":"0",},
...
{"lineNum":"  308","line":"  fi"},
{"lineNum":"  309","line":""},
{"lineNum":"  310","line":"  if [[ \"$num_jobs\" -lt 1 ]]; then","class":"lineCov","hits":"2","order":"364","possible_hits":"0",},
...
{"lineNum":"  313","line":"  fi"},
{"lineNum":"  314","line":""},
{"lineNum":"  315","line":"  if [[ \"$num_jobs\" != 1 && \"${BATS_NO_PARALLELIZE_WITHIN_FILE-False}\" == False ]]; then","class":"lineCov","hits":"2","order":"365","possible_hits":"0",},
...
{"lineNum":"  319","line":"    local test_number_in_suite=$BATS_FILE_FIRST_TEST_NUMBER_IN_SUITE \\","class":"lineCov","hits":"2","order":"366","possible_hits":"0",},
{"lineNum":"  320","line":"      test_number_in_file=0"},
{"lineNum":"  321","line":"    for test_name in \"${tests_to_run[@]}\"; do","class":"lineCov","hits":"12","order":"367","possible_hits":"0",},
{"lineNum":"  322","line":"      if [[ \"${BATS_INTERRUPTED-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"12","order":"368","possible_hits":"0",},
...
{"lineNum":"  327","line":"      if [[ -n ${test_name-} ]]; then","class":"lineCov","hits":"12","order":"369","possible_hits":"0",},
{"lineNum":"  328","line":"        ((++test_number_in_suite))"},
{"lineNum":"  329","line":"        ((++test_number_in_file))"},
{"lineNum":"  330","line":"        bats_run_test_with_retries \"${flags[@]}\" \"$filename\" \"$test_name\" \\","class":"lineCov","hits":"12","order":"370","possible_hits":"0",},
...
{"lineNum":"  377","line":"trap \'BATS_INTERRUPTED=true\' INT","class":"lineCov","hits":"2","order":"360","possible_hits":"0",},
{"lineNum":"  378","line":"bats_run_tests","class":"lineCov","hits":"2","order":"361","possible_hits":"0",},
{"lineNum":"  379","line":""},
{"lineNum":"  380","line":"trap bats_interrupt_trap INT","class":"lineCov","hits":"2","order":"614","possible_hits":"0",},
{"lineNum":"  381","line":"bats_run_teardown_file","class":"lineCov","hits":"2","order":"615","possible_hits":"0",},
{"lineNum":"  382","line":""},
{"lineNum":"  383","line":"exit $bats_exec_file_status","class":"lineCov","hits":"2","order":"622","possible_hits":"0",},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2023-04-06 21:10:26", "instrumented" : 192, "covered" : 100,};
var merged_data = [];
