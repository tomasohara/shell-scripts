...
{"lineNum":"    7","line":"  local test_file","class":"lineCov","hits":"195","order":"337","possible_hits":"0",},
{"lineNum":"    8","line":"  local funcname","class":"lineCov","hits":"195","order":"338","possible_hits":"0",},
{"lineNum":"    9","line":"  local i","class":"lineCov","hits":"195","order":"339","possible_hits":"0",},
{"lineNum":"   10","line":""},
{"lineNum":"   11","line":"  BATS_DEBUG_LAST_STACK_TRACE=()"},
{"lineNum":"   12","line":""},
{"lineNum":"   13","line":"  for ((i = 2; i != ${#FUNCNAME[@]}; ++i)); do","class":"lineCov","hits":"550","order":"340","possible_hits":"0",},
...
{"lineNum":"   16","line":"    test_file=\"${BASH_SOURCE[$i]:-$BATS_TEST_SOURCE}\"","class":"lineCov","hits":"275","order":"341","possible_hits":"0",},
{"lineNum":"   17","line":"    funcname=\"${FUNCNAME[$i]}\"","class":"lineCov","hits":"275","order":"342","possible_hits":"0",},
{"lineNum":"   18","line":"    BATS_DEBUG_LAST_STACK_TRACE+=(\"${BASH_LINENO[$((i - 1))]} $funcname $test_file\")","class":"lineCov","hits":"275","order":"343","possible_hits":"0",},
{"lineNum":"   19","line":"    case \"$funcname\" in","class":"lineCov","hits":"275","order":"344","possible_hits":"0",},
{"lineNum":"   20","line":"    \"${BATS_TEST_NAME-}\" | setup | teardown | setup_file | teardown_file | setup_suite | teardown_suite)"},
{"lineNum":"   21","line":"      break","class":"lineCov","hits":"184","order":"433","possible_hits":"0",},
{"lineNum":"   22","line":"      ;;"},
{"lineNum":"   23","line":"    esac"},
{"lineNum":"   24","line":"    if [[ \"${BASH_SOURCE[$i + 1]:-}\" == *\"bats-exec-file\" ]] && [[ \"$funcname\" == \'source\' ]]; then","class":"lineCov","hits":"102","order":"345","possible_hits":"0",},
...
{"lineNum":"   31","line":"  local stack_trace_var","class":"lineCov","hits":"8","order":"480","possible_hits":"0",},
{"lineNum":"   32","line":"  # See bats_debug_trap for details."},
{"lineNum":"   33","line":"  if [[ -n \"${BATS_DEBUG_LAST_STACK_TRACE_IS_VALID:-}\" ]]; then","class":"lineCov","hits":"8","order":"481","possible_hits":"0",},
{"lineNum":"   34","line":"    stack_trace_var=BATS_DEBUG_LAST_STACK_TRACE","class":"lineCov","hits":"7","order":"482","possible_hits":"0",},
...
{"lineNum":"   47","line":"  local frame","class":"lineCov","hits":"8","order":"486","possible_hits":"0",},
{"lineNum":"   48","line":"  local index=1","class":"lineCov","hits":"8","order":"487","possible_hits":"0",},
{"lineNum":"   49","line":"  local count=\"${#@}\"","class":"lineCov","hits":"8","order":"488","possible_hits":"0",},
{"lineNum":"   50","line":"  local filename","class":"lineCov","hits":"8","order":"489","possible_hits":"0",},
{"lineNum":"   51","line":"  local lineno","class":"lineCov","hits":"8","order":"490","possible_hits":"0",},
{"lineNum":"   52","line":""},
{"lineNum":"   53","line":"  for frame in \"$@\"; do","class":"lineCov","hits":"11","order":"491","possible_hits":"0",},
{"lineNum":"   54","line":"    bats_frame_filename \"$frame\" \'filename\'","class":"lineCov","hits":"11","order":"492","possible_hits":"0",},
{"lineNum":"   55","line":"    bats_trim_filename \"$filename\" \'filename\'","class":"lineCov","hits":"11","order":"498","possible_hits":"0",},
{"lineNum":"   56","line":"    bats_frame_lineno \"$frame\" \'lineno\'","class":"lineCov","hits":"11","order":"500","possible_hits":"0",},
{"lineNum":"   57","line":""},
{"lineNum":"   58","line":"    printf \'%s\' \"${BATS_STACK_TRACE_PREFIX-# }\"","class":"lineCov","hits":"11","order":"502","possible_hits":"0",},
{"lineNum":"   59","line":"    if [[ $index -eq 1 ]]; then","class":"lineCov","hits":"11","order":"503","possible_hits":"0",},
{"lineNum":"   60","line":"      printf \'(\'","class":"lineCov","hits":"8","order":"504","possible_hits":"0",},
{"lineNum":"   61","line":"    else"},
{"lineNum":"   62","line":"      printf \' \'","class":"lineCov","hits":"3","order":"580","possible_hits":"0",},
{"lineNum":"   63","line":"    fi"},
{"lineNum":"   64","line":""},
{"lineNum":"   65","line":"    local fn","class":"lineCov","hits":"11","order":"505","possible_hits":"0",},
{"lineNum":"   66","line":"    bats_frame_function \"$frame\" \'fn\'","class":"lineCov","hits":"11","order":"506","possible_hits":"0",},
{"lineNum":"   67","line":"    if [[ \"$fn\" != \"${BATS_TEST_NAME-}\" ]] &&","class":"lineCov","hits":"11","order":"509","possible_hits":"0",},
...
{"lineNum":"   70","line":"      ! [[ \"$fn\" == \'source\' && $index -eq $count ]]; then","class":"lineCov","hits":"3","order":"575","possible_hits":"0",},
{"lineNum":"   71","line":"      local quoted_fn","class":"lineCov","hits":"3","order":"576","possible_hits":"0",},
{"lineNum":"   72","line":"      bats_quote_code quoted_fn \"$fn\"","class":"lineCov","hits":"3","order":"577","possible_hits":"0",},
{"lineNum":"   73","line":"      printf \"from function %s \" \"$quoted_fn\"","class":"lineCov","hits":"3","order":"578","possible_hits":"0",},
{"lineNum":"   74","line":"    fi"},
{"lineNum":"   75","line":""},
{"lineNum":"   76","line":"    local reference","class":"lineCov","hits":"11","order":"510","possible_hits":"0",},
{"lineNum":"   77","line":"    bats_format_file_line_reference reference \"$filename\" \"$lineno\"","class":"lineCov","hits":"11","order":"511","possible_hits":"0",},
{"lineNum":"   78","line":"    if [[ $index -eq $count ]]; then","class":"lineCov","hits":"11","order":"516","possible_hits":"0",},
{"lineNum":"   79","line":"      printf \'in test file %s)\\n\' \"$reference\"","class":"lineCov","hits":"8","order":"517","possible_hits":"0",},
{"lineNum":"   80","line":"    else"},
{"lineNum":"   81","line":"      printf \'in file %s,\\n\' \"$reference\"","class":"lineCov","hits":"3","order":"579","possible_hits":"0",},
{"lineNum":"   82","line":"    fi"},
{"lineNum":"   83","line":""},
...
{"lineNum":"   89","line":"  local stack_trace=(\"${@}\")","class":"lineCov","hits":"16","order":"519","possible_hits":"0",},
{"lineNum":"   90","line":"  if [[ ${#stack_trace[@]} -eq 0 ]]; then","class":"lineCov","hits":"8","order":"520","possible_hits":"0",},
{"lineNum":"   91","line":"    return 0","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"   92","line":"  fi"},
{"lineNum":"   93","line":"  local frame=\"${stack_trace[${#stack_trace[@]} - 1]}\"","class":"lineCov","hits":"8","order":"521","possible_hits":"0",},
{"lineNum":"   94","line":"  local filename","class":"lineCov","hits":"8","order":"522","possible_hits":"0",},
{"lineNum":"   95","line":"  local lineno","class":"lineCov","hits":"8","order":"523","possible_hits":"0",},
{"lineNum":"   96","line":"  local failed_line","class":"lineCov","hits":"8","order":"524","possible_hits":"0",},
{"lineNum":"   97","line":"  local failed_command","class":"lineCov","hits":"8","order":"525","possible_hits":"0",},
{"lineNum":"   98","line":""},
{"lineNum":"   99","line":"  bats_frame_filename \"$frame\" \'filename\'","class":"lineCov","hits":"8","order":"526","possible_hits":"0",},
{"lineNum":"  100","line":"  bats_frame_lineno \"$frame\" \'lineno\'","class":"lineCov","hits":"8","order":"527","possible_hits":"0",},
{"lineNum":"  101","line":"  bats_extract_line \"$filename\" \"$lineno\" \'failed_line\'","class":"lineCov","hits":"8","order":"528","possible_hits":"0",},
{"lineNum":"  102","line":"  bats_strip_string \"$failed_line\" \'failed_command\'","class":"lineCov","hits":"8","order":"535","possible_hits":"0",},
{"lineNum":"  103","line":"  local quoted_failed_command","class":"lineCov","hits":"8","order":"538","possible_hits":"0",},
{"lineNum":"  104","line":"  bats_quote_code quoted_failed_command \"$failed_command\"","class":"lineCov","hits":"8","order":"539","possible_hits":"0",},
{"lineNum":"  105","line":"  printf \'#   %s \' \"${quoted_failed_command}\"","class":"lineCov","hits":"8","order":"541","possible_hits":"0",},
{"lineNum":"  106","line":""},
{"lineNum":"  107","line":"  if [[ \"${BATS_TIMED_OUT-NOTSET}\" != NOTSET ]]; then","class":"lineCov","hits":"8","order":"542","possible_hits":"0",},
...
{"lineNum":"  111","line":"  fi"},
{"lineNum":"  112","line":""},
{"lineNum":"  113","line":"  if [[ \"$BATS_ERROR_STATUS\" -eq 1 ]]; then","class":"lineCov","hits":"8","order":"543","possible_hits":"0",},
{"lineNum":"  114","line":"    printf \'failed%s\\n\' \"$BATS_ERROR_SUFFIX\"","class":"lineCov","hits":"6","order":"544","possible_hits":"0",},
{"lineNum":"  115","line":"  else"},
{"lineNum":"  116","line":"    printf \'failed with status %d%s\\n\' \"$BATS_ERROR_STATUS\" \"$BATS_ERROR_SUFFIX\"","class":"lineCov","hits":"2","order":"581","possible_hits":"0",},
{"lineNum":"  117","line":"  fi"},
{"lineNum":"  118","line":"}"},
{"lineNum":"  119","line":""},
{"lineNum":"  120","line":"bats_frame_lineno() {"},
{"lineNum":"  121","line":"  printf -v \"$2\" \'%s\' \"${1%% *}\"","class":"lineCov","hits":"19","order":"501","possible_hits":"0",},
{"lineNum":"  122","line":"}"},
{"lineNum":"  123","line":""},
{"lineNum":"  124","line":"bats_frame_function() {"},
{"lineNum":"  125","line":"  local __bff_function=\"${1#* }\"","class":"lineCov","hits":"11","order":"507","possible_hits":"0",},
{"lineNum":"  126","line":"  printf -v \"$2\" \'%s\' \"${__bff_function%% *}\"","class":"lineCov","hits":"11","order":"508","possible_hits":"0",},
{"lineNum":"  127","line":"}"},
{"lineNum":"  128","line":""},
{"lineNum":"  129","line":"bats_frame_filename() {"},
{"lineNum":"  130","line":"  local __bff_filename=\"${1#* }\"","class":"lineCov","hits":"19","order":"493","possible_hits":"0",},
{"lineNum":"  131","line":"  __bff_filename=\"${__bff_filename#* }\"","class":"lineCov","hits":"19","order":"494","possible_hits":"0",},
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"  if [[ \"$__bff_filename\" == \"${BATS_TEST_SOURCE-}\" ]]; then","class":"lineCov","hits":"19","order":"495","possible_hits":"0",},
{"lineNum":"  134","line":"    __bff_filename=\"$BATS_TEST_FILENAME\"","class":"lineCov","hits":"19","order":"496","possible_hits":"0",},
{"lineNum":"  135","line":"  fi"},
{"lineNum":"  136","line":"  printf -v \"$2\" \'%s\' \"$__bff_filename\"","class":"lineCov","hits":"19","order":"497","possible_hits":"0",},
{"lineNum":"  137","line":"}"},
{"lineNum":"  138","line":""},
{"lineNum":"  139","line":"bats_extract_line() {"},
{"lineNum":"  140","line":"  local __bats_extract_line_line","class":"lineCov","hits":"8","order":"529","possible_hits":"0",},
{"lineNum":"  141","line":"  local __bats_extract_line_index=0","class":"lineCov","hits":"8","order":"530","possible_hits":"0",},
{"lineNum":"  142","line":""},
{"lineNum":"  143","line":"  while IFS= read -r __bats_extract_line_line; do","class":"lineCov","hits":"2308","order":"531","possible_hits":"0",},
{"lineNum":"  144","line":"    if [[ \"$((++__bats_extract_line_index))\" -eq \"$2\" ]]; then","class":"lineCov","hits":"1154","order":"532","possible_hits":"0",},
{"lineNum":"  145","line":"      printf -v \"$3\" \'%s\' \"${__bats_extract_line_line%$\'\\r\'}\"","class":"lineCov","hits":"8","order":"533","possible_hits":"0",},
{"lineNum":"  146","line":"      break","class":"lineCov","hits":"8","order":"534","possible_hits":"0",},
{"lineNum":"  147","line":"    fi"},
{"lineNum":"  148","line":"  done <\"$1\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  149","line":"}"},
{"lineNum":"  150","line":""},
{"lineNum":"  151","line":"bats_strip_string() {"},
{"lineNum":"  152","line":"  [[ \"$1\" =~ ^[[:space:]]*(.*)[[:space:]]*$ ]]","class":"lineCov","hits":"8","order":"536","possible_hits":"0",},
{"lineNum":"  153","line":"  printf -v \"$2\" \'%s\' \"${BASH_REMATCH[1]}\"","class":"lineCov","hits":"8","order":"537","possible_hits":"0",},
{"lineNum":"  154","line":"}"},
{"lineNum":"  155","line":""},
{"lineNum":"  156","line":"bats_trim_filename() {"},
{"lineNum":"  157","line":"  printf -v \"$2\" \'%s\' \"${1#\"$BATS_CWD\"/}\"","class":"lineCov","hits":"11","order":"499","possible_hits":"0",},
{"lineNum":"  158","line":"}"},
{"lineNum":"  159","line":""},
...
{"lineNum":"  163","line":"  local output_var=\"$1\" path=\"$2\"","class":"lineCov","hits":"782","order":"247","possible_hits":"0",},
{"lineNum":"  164","line":"  if [[ \"$output_var\" != NORMALIZED_INPUT ]]; then","class":"lineCov","hits":"782","order":"248","possible_hits":"0",},
{"lineNum":"  165","line":"    local NORMALIZED_INPUT","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  166","line":"  fi"},
{"lineNum":"  167","line":"  if [[ $path == ?:* ]]; then","class":"lineCov","hits":"782","order":"249","possible_hits":"0",},
...
{"lineNum":"  173","line":"    NORMALIZED_INPUT=\"$path\"","class":"lineCov","hits":"782","order":"250","possible_hits":"0",},
{"lineNum":"  174","line":"  fi"},
{"lineNum":"  175","line":"  printf -v \"$output_var\" \"%s\" \"$NORMALIZED_INPUT\"","class":"lineCov","hits":"782","order":"251","possible_hits":"0",},
{"lineNum":"  176","line":"}"},
{"lineNum":"  177","line":""},
{"lineNum":"  178","line":"bats_emit_trace() {"},
{"lineNum":"  179","line":"  if [[ $BATS_TRACE_LEVEL -gt 0 ]]; then","class":"lineCov","hits":"195","order":"348","possible_hits":"0",},
...
{"lineNum":"  255","line":"  local NORMALIZED_INPUT","class":"lineCov","hits":"782","order":"245","possible_hits":"0",},
{"lineNum":"  256","line":"  bats_normalize_windows_dir_path NORMALIZED_INPUT \"${1%/*}\"","class":"lineCov","hits":"782","order":"246","possible_hits":"0",},
{"lineNum":"  257","line":"  local file_excluded=\'\' path","class":"lineCov","hits":"782","order":"252","possible_hits":"0",},
{"lineNum":"  258","line":"  for path in \"${BATS_DEBUG_EXCLUDE_PATHS[@]}\"; do","class":"lineCov","hits":"1555","order":"253","possible_hits":"0",},
{"lineNum":"  259","line":"    if [[ \"$NORMALIZED_INPUT\" == \"$path\"* ]]; then","class":"lineCov","hits":"1555","order":"254","possible_hits":"0",},
...
{"lineNum":"  269","line":"    \"${BATS_TIMED_OUT-NOTSET}\" == NOTSET ]]; then","class":"lineCov","hits":"1172","order":"257","possible_hits":"0",},
...
{"lineNum":"  272","line":"    )"},
{"lineNum":"  273","line":""},
{"lineNum":"  274","line":"    BATS_DEBUG_LAST_LINENO=(${BASH_LINENO[@]+\"${BASH_LINENO[@]}\"})","class":"lineCov","hits":"195","order":"334","possible_hits":"0",},
{"lineNum":"  275","line":"    BATS_DEBUG_LAST_SOURCE=(${BASH_SOURCE[@]+\"${BASH_SOURCE[@]}\"})","class":"lineCov","hits":"195","order":"335","possible_hits":"0",},
{"lineNum":"  276","line":"    bats_capture_stack_trace","class":"lineCov","hits":"195","order":"336","possible_hits":"0",},
{"lineNum":"  277","line":"    bats_emit_trace","class":"lineCov","hits":"195","order":"347","possible_hits":"0",},
{"lineNum":"  278","line":"  fi"},
{"lineNum":"  279","line":"}"},
{"lineNum":"  280","line":""},
...
{"lineNum":"  292","line":"  local status=\"$?\"","class":"lineCov","hits":"25","order":"447","possible_hits":"0",},
{"lineNum":"  293","line":"  if [[ -z \"${BATS_TEST_COMPLETED:-}\" ]]; then","class":"lineCov","hits":"25","order":"448","possible_hits":"0",},
{"lineNum":"  294","line":"    BATS_ERROR_STATUS=\"${BATS_ERROR_STATUS:-$status}\"","class":"lineCov","hits":"23","order":"449","possible_hits":"0",},
{"lineNum":"  295","line":"    if [[ \"$BATS_ERROR_STATUS\" -eq 0 ]]; then","class":"lineCov","hits":"23","order":"450","possible_hits":"0",},
{"lineNum":"  296","line":"      BATS_ERROR_STATUS=1","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  297","line":"    fi"},
{"lineNum":"  298","line":"    trap - DEBUG","class":"lineCov","hits":"23","order":"451","possible_hits":"0",},
{"lineNum":"  299","line":"  fi"},
{"lineNum":"  300","line":"}"},
{"lineNum":"  301","line":""},
...
{"lineNum":"  370","line":"  bats_check_status_from_trap","class":"lineCov","hits":"14","order":"446","possible_hits":"0",},
{"lineNum":"  371","line":""},
...
{"lineNum":"  376","line":"    -z \"$BATS_DEBUG_LAST_STACK_TRACE_IS_VALID\" ]]; then","class":"lineCov","hits":"21","order":"452","possible_hits":"0",},
...
{"lineNum":"  379","line":"    )"},
{"lineNum":"  380","line":"  fi"},
{"lineNum":"  381","line":"  BATS_DEBUG_LAST_STACK_TRACE_IS_VALID=1","class":"lineCov","hits":"7","order":"453","possible_hits":"0",},
{"lineNum":"  382","line":"}"},
{"lineNum":"  383","line":""},
...
var header = { "command" : "bats", "date" : "2023-05-18 22:52:36", "instrumented" : 168, "covered" : 118,};
var merged_data = [];
