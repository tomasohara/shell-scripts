...
{"lineNum":"    4","line":"    while IFS= read -r line; do","class":"lineCov","hits":"44","order":"543","possible_hits":"0",},
{"lineNum":"    5","line":"      printf \'# %s\\n\' \"$line\" || break # avoid feedback loop when errors are redirected into BATS_OUT (see #353)","class":"lineCov","hits":"14","order":"544","possible_hits":"0",},
{"lineNum":"    6","line":"    done"},
{"lineNum":"    7","line":"    if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"8","order":"545","possible_hits":"0",},
{"lineNum":"    8","line":"      printf \'# %s\\n\' \"$line\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"    9","line":"    fi"},
{"lineNum":"   10","line":"}"},
{"lineNum":"   11","line":""},
{"lineNum":"   12","line":"function bats_replace_filename() {"},
{"lineNum":"   13","line":"  local line","class":"lineCov","hits":"8","order":"546","possible_hits":"0",},
{"lineNum":"   14","line":"  while read -r line; do","class":"lineCov","hits":"22","order":"547","possible_hits":"0",},
{"lineNum":"   15","line":"    printf \"%s\\n\" \"${line//$BATS_TEST_SOURCE/$BATS_TEST_FILENAME}\"","class":"lineCov","hits":"14","order":"548","possible_hits":"0",},
{"lineNum":"   16","line":"  done"},
{"lineNum":"   17","line":"  if [[ -n \"$line\" ]]; then","class":"lineCov","hits":"8","order":"549","possible_hits":"0",},
...
{"lineNum":"   23","line":"\tprintf -v \"$1\" -- \"%s%s%s\" \"$BATS_BEGIN_CODE_QUOTE\" \"$2\" \"$BATS_END_CODE_QUOTE\"","class":"lineCov","hits":"8","order":"533","possible_hits":"0",},
{"lineNum":"   24","line":"}"},
{"lineNum":"   25","line":""},
...
{"lineNum":"  103","line":"  local -r result_name=$1","class":"lineCov","hits":"32","order":"166","possible_hits":"0",},
{"lineNum":"  104","line":"  shift","class":"lineCov","hits":"32","order":"167","possible_hits":"0",},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"  if (( $# == 0 )); then","class":"lineCov","hits":"32","order":"168","possible_hits":"0",},
{"lineNum":"  107","line":"    eval \"$result_name=()\"","class":"lineCov","hits":"64","order":"169","possible_hits":"0",},
{"lineNum":"  108","line":"    return 0","class":"lineCov","hits":"32","order":"170","possible_hits":"0",},
{"lineNum":"  109","line":"  fi"},
{"lineNum":"  110","line":""},
...
{"lineNum":"  192","line":"  local -a trailing_args=()","class":"lineCov","hits":"64","order":"157","possible_hits":"0",},
{"lineNum":"  193","line":"  while (( $# > 0)) && [[ $1 != -- ]]; do","class":"lineCov","hits":"192","order":"158","possible_hits":"0",},
{"lineNum":"  194","line":"    local array=$1","class":"lineCov","hits":"64","order":"159","possible_hits":"0",},
{"lineNum":"  195","line":"    shift","class":"lineCov","hits":"64","order":"160","possible_hits":"0",},
{"lineNum":"  196","line":""},
{"lineNum":"  197","line":"    if eval \"(( \\${#${array}[@]} > 0 ))\"; then","class":"lineCov","hits":"128","order":"161","possible_hits":"0",},
{"lineNum":"  198","line":"      eval \"trailing_args+=(\\\"\\${${array}[@]}\\\")\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  199","line":"    fi"},
{"lineNum":"  200","line":"  done"},
{"lineNum":"  201","line":"  shift # remove -- separator","class":"lineCov","hits":"32","order":"162","possible_hits":"0",},
{"lineNum":"  202","line":""},
{"lineNum":"  203","line":"  if (( $# == 0 )); then","class":"lineCov","hits":"32","order":"163","possible_hits":"0",},
...
{"lineNum":"  206","line":"  fi"},
{"lineNum":"  207","line":""},
{"lineNum":"  208","line":"  if (( ${#trailing_args[@]} > 0 )); then","class":"lineCov","hits":"32","order":"164","possible_hits":"0",},
{"lineNum":"  209","line":"    \"$@\" \"${trailing_args[@]}\"","class":"lineNoCov","hits":"0","possible_hits":"0",},
{"lineNum":"  210","line":"  else"},
{"lineNum":"  211","line":"    \"$@\"","class":"lineCov","hits":"32","order":"165","possible_hits":"0",},
{"lineNum":"  212","line":"  fi"},
{"lineNum":"  213","line":"}"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "bats", "date" : "2022-10-01 22:23:49", "instrumented" : 106, "covered" : 22,};
var merged_data = [];
