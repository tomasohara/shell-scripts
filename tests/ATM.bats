...
@test "test5" {
	...
	hist
	linebr
	actual=$(test5-assert4-actual)
	expected=$(test5-assert4-expected)
	echo "========== actual =========="
	echo "$actual" | hexview.perl
	echo "========= expected ========="
	echo "$expected" | hexview.perl
...
@test "test10" {
	...
	actual=$(test10-assert4-actual)
	expected=$(test10-assert4-expected)
	echo "========== actual =========="
	echo "$actual" | hexview.perl
	echo "========= expected ========="
	echo "$expected" | hexview.perl
...
function test10-assert4-actual () {
	echo "8000000" | apply-usage-numeric-suffixes #M -> G
}
function test10-assert4-expected () {
	echo -e '7.45T7.63G'
}
