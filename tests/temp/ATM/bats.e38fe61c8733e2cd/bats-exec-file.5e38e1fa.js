...
{"lineNum":"  265","line":"  while read -r test_line; do","class":"lineCov","hits":"56","order":"275","possible_hits":"0",},
...
{"lineNum":"  269","line":"    if [[ \"$filename\" == \"${test_line::${#filename}}\" ]]; then","class":"lineCov","hits":"54","order":"276","possible_hits":"0",},
{"lineNum":"  270","line":"      # get the rest of the line without the separator \\t"},
{"lineNum":"  271","line":"      test_name=${test_line:$((1 + ${#filename} ))}","class":"lineCov","hits":"54","order":"277","possible_hits":"0",},
{"lineNum":"  272","line":"      tests_to_run+=(\"$test_name\")","class":"lineCov","hits":"54","order":"278","possible_hits":"0",},
...
{"lineNum":"  275","line":"      if [[ -z \"$test_number_in_suite\" ]]; then","class":"lineCov","hits":"54","order":"279","possible_hits":"0",},
...
var header = { "command" : "bats", "date" : "2022-09-27 22:43:11", "instrumented" : 176, "covered" : 82,};
var merged_data = [];
