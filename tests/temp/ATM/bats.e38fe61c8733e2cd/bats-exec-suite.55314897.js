...
{"lineNum":"  122","line":"    while read -r line; do","class":"lineCov","hits":"1052","order":"122","possible_hits":"0",},
{"lineNum":"  123","line":"      if [[ ! \"$line\" =~ ^bats_test_function\\  ]]; then","class":"lineCov","hits":"1051","order":"141","possible_hits":"0",},
{"lineNum":"  124","line":"        continue","class":"lineCov","hits":"996","order":"142","possible_hits":"0",},
{"lineNum":"  125","line":"      fi"},
{"lineNum":"  126","line":"      line=\"${line%$\'\\r\'}\"","class":"lineCov","hits":"54","order":"176","possible_hits":"0",},
{"lineNum":"  127","line":"      line=\"${line#* }\"","class":"lineCov","hits":"54","order":"177","possible_hits":"0",},
{"lineNum":"  128","line":"      TAG_REGEX=\"--tags \'(.*)\' (.*)\"","class":"lineCov","hits":"54","order":"178","possible_hits":"0",},
{"lineNum":"  129","line":"      if [[ \"$line\" =~ $TAG_REGEX ]]; then","class":"lineCov","hits":"54","order":"179","possible_hits":"0",},
{"lineNum":"  130","line":"        IFS=, read -ra tags <<<\"${BASH_REMATCH[1]}\" || true","class":"lineCov","hits":"108","order":"180","possible_hits":"0",},
{"lineNum":"  131","line":"        line=\"${BASH_REMATCH[2]}\"","class":"lineCov","hits":"54","order":"181","possible_hits":"0",},
{"lineNum":"  132","line":"      else"},
{"lineNum":"  133","line":"        tags=()"},
{"lineNum":"  134","line":"      fi"},
{"lineNum":"  135","line":"      if [[ ${#filter_tags_list[@]} -gt 0 ]]; then","class":"lineCov","hits":"54","order":"182","possible_hits":"0",},
...
{"lineNum":"  163","line":"        fi"},
{"lineNum":"  164","line":"      fi"},
{"lineNum":"  165","line":"      test_line=$(printf \"%s\\t%s\" \"$filename\" \"$line\")","class":"lineCov","hits":"108","order":"184","possible_hits":"0",},
{"lineNum":"  166","line":"      all_tests+=(\"$test_line\")","class":"lineCov","hits":"54","order":"185","possible_hits":"0",},
{"lineNum":"  167","line":"      printf \"%s\\n\" \"$test_line\" >>\"$TESTS_LIST_FILE\"","class":"lineCov","hits":"54","order":"186","possible_hits":"0",},
{"lineNum":"  168","line":"      # avoid unbound variable errors on empty array expansion with old bash versions"},
{"lineNum":"  169","line":"      if [[ ${#test_names[@]} -gt 0 && \" ${test_names[*]} \" == *\" $line \"* ]]; then","class":"lineCov","hits":"106","order":"187","possible_hits":"0",},
...
{"lineNum":"  172","line":"      fi"},
{"lineNum":"  173","line":"      test_names+=(\"$line\")","class":"lineCov","hits":"54","order":"188","possible_hits":"0",},
...
var header = { "command" : "bats", "date" : "2022-09-27 22:43:11", "instrumented" : 229, "covered" : 85,};
var merged_data = [];
