...
@test "test-1" {
	testfolder="/tmp/batspp-99412/test-1"
...
@test "test-3" {
	testfolder="/tmp/batspp-99412/test-3"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-4" {
	testfolder="/tmp/batspp-99412/test-4"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-5" {
	testfolder="/tmp/batspp-99412/test-5"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-6" {
	testfolder="/tmp/batspp-99412/test-6"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-7" {
	testfolder="/tmp/batspp-99412/test-7"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-8" {
	testfolder="/tmp/batspp-99412/test-8"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-9" {
	testfolder="/tmp/batspp-99412/test-9"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
