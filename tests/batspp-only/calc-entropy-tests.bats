...
function test-1-setup () {
	...
	testfolder="/tmp/batspp-95453/test-1"
...
@test "test-3" {
	testfolder="/tmp/batspp-95453/test-3"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-4" {
	testfolder="/tmp/batspp-95453/test-4"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-5" {
	testfolder="/tmp/batspp-95453/test-5"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-6" {
	testfolder="/tmp/batspp-95453/test-6"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-7" {
	testfolder="/tmp/batspp-95453/test-7"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-8" {
	testfolder="/tmp/batspp-95453/test-8"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-9" {
	testfolder="/tmp/batspp-95453/test-9"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
...
@test "test-10" {
	testfolder="/tmp/batspp-95453/test-10"
	mkdir --parents "$testfolder"
	command cp ./*.* "$testfolder"
	builtin cd "$testfolder" || echo Warning: Unable to "cd $testfolder"
	...
	# ???: '#\t\tclass\tfreq\tprob\t-p lg(p)\n#\t\tpp-tmp\t42\t0.350\t0.530\n#\t\tpp-loc\t35\t0.292\t0.518\n#\t\tpp-clr\t24\t0.200\t0.464\n#\t\tpp-prd\t7\t0.058\t0.239\n#\t\tpp-dir\t6\t0.050\t0.216\n#\t\tpp-ext\t4\t0.033\t0.164\n#\t\tpp-nom\t2\t0.017\t0.098\n#\t\ttotal\t120\t1.000\t2.230\n<NL>\n# word\tclasses\tfreq\tentropy\tmax_prob\n-\t7\t120\t2.230\t0.350'=$(test-10-expected)
