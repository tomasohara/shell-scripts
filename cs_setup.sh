...
alias gtar_tvfz 'zcat \!:1 | gtar tvf - \!:2*'
alias gtar_xvfz 'zcat \!:1 | gtar xvf - \!:2*'
...
alias websters 'perl_ websters_lookup.perl -pre_context=25 \!* | & less +26'
alias websters_ perl_ websters_lookup.perl
alias websters_pp 'perl_ websters_lookup.perl \!* | perl_ pp_websters.perl | less'
alias wpp websters_pp

# Bilingual dictionaries
alias german_lookup_ 'zgrep \!* ~/Multilingual/German/german_english.dict'
alias german_lookup 'zgrep -w -i ^\!* ~/Multilingual/German/german_english.dict'
alias german_ german_lookup_
alias german german_lookup

alias french_lookup_ 'zgrep \!* ~/Multilingual/French/french_english.dict'
alias french_lookup 'zgrep -w -i ^\!* ~/Multilingual/French/french_english.dict'
alias french_ french_lookup_
alias french french_lookup

alias italian_lookup_ 'zgrep \!* ~/Multilingual/Italian/italian_english.dict'
alias italian_lookup 'zgrep -w -i ^\!* ~/Multilingual/Italian/italian_english.dict'
alias italian_ italian_lookup_
alias italian italian_lookup

setenv SPANISH_DICT ~/Multilingual/Spanish/spanish_english.dict
alias spanish_lookup_ 'zgrep \!* $SPANISH_DICT'
alias spanish_lookup 'zgrep -w -i ^\!* $SPANISH_DICT'
alias spanish_ spanish_lookup_
alias spanish spanish_lookup

alias multi_lookup_ 'zgrep \!* ~/Multilingual/Multi/multilingual.dict'
alias multi_lookup 'zgrep -w -i ^\!* ~/Multilingual/Multi/multilingual.dict'
...
# Up the limits
limit datasize 150m
alias color_fvwm '~/bin/fvwm95-2 -f "FvwmM4 /home/tohara/xfer/.fvwm2rc95" >&\! fvwm.log'
...
set autologout=6000
alias add_floppy volrmmount -D -i 
alias add_floppy_ volcheck
alias 'remove_floppy volrmmount -D -e; eject'
